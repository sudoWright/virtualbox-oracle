/* $Id: VBoxCpuReport-x86.cpp 168536 2025-04-16 20:59:36Z knut.osmundsen@oracle.com $ */
/** @file
...
int probeMsrs(bool fHacking, const char *pszNameC, const char *pszCpuDesc, char *pszMsrMask, size_t cbMsrMask)
{
    /* Initialize the mask. */
...
int produceCpuReport(void)
{
    ...
    {
        ASMCpuIdExSlow(1, 0, 0, 0, &uEax, &uEbx, &uEcx, &uEdx);
        RTStrPrintf(szNameC, sizeof(szNameC), "%s_%u_%u_%u", vbCpuVendorToString(enmVendor), RTX86GetCpuFamily(uEax),
    ...
    vbCpuRepPrintf("\n"
                   ...
                   " */\n"
                   "static CPUMDBENTRYX86 const g_Entry_%s = \n"
                   "{\n"
                   "    {\n"
                   "        /*.pszName          = */ \"%s\",\n"
                   "        /*.pszFullName      = */ \"%s\",\n"
