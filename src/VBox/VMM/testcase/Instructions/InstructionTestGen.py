#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 86913 2013-07-02 17:44:45Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 86913 2013-07-02 17:44:45Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
