#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 86901 2013-07-02 13:13:10Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 86901 2013-07-02 13:13:10Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
