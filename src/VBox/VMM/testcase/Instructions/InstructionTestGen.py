#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 87082 2013-07-08 17:54:36Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 87082 2013-07-08 17:54:36Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
