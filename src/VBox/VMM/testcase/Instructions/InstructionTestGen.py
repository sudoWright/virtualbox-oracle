#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 86806 2013-06-27 17:53:01Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 86806 2013-06-27 17:53:01Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
