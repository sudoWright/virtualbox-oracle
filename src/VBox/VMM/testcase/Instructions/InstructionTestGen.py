#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 164827 2024-09-16 14:03:52Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 164827 2024-09-16 14:03:52Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
