#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 87048 2013-07-05 17:49:53Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 87048 2013-07-05 17:49:53Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
