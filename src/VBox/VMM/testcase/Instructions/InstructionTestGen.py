#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 86404 2013-06-13 18:22:11Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 86404 2013-06-13 18:22:11Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
