#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 135976 2020-02-04 10:35:17Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 135976 2020-02-04 10:35:17Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
