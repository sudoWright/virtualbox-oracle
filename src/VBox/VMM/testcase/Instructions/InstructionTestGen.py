#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 87006 2013-07-05 07:59:47Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 87006 2013-07-05 07:59:47Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
