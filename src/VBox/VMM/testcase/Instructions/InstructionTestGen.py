#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 86656 2013-06-22 19:35:34Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object):
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 86656 2013-06-22 19:35:34Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
