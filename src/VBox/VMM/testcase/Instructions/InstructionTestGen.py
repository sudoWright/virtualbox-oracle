#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 155244 2023-01-17 14:15:46Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 155244 2023-01-17 14:15:46Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
