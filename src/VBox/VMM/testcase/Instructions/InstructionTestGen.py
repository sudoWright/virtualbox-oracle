#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 100868 2015-06-09 11:15:22Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 100868 2015-06-09 11:15:22Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
