#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: InstructionTestGen.py 113500 2017-02-13 17:06:27Z knut.osmundsen@oracle.com $
...
class InstructionTestGen(object): # pylint: disable=R0902
    ...
    def _generateFileHeader(self, ):
        ...
        """
        self.write('; $Id: InstructionTestGen.py 113500 2017-02-13 17:06:27Z knut.osmundsen@oracle.com $\n'
                   ';; @file %s\n'
