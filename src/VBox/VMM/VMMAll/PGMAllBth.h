/* $Id: PGMAllBth.h 32261 2008-06-23 12:53:24Z noreply@oracle.com $ */
/** @file
...
# endif
                            ...
                            iPT++, off += PAGE_SIZE, GCPhysGst += PAGE_SIZE)
                        {
                            ...
                            fIgnoreFlags = X86_PTE_PAE_PG_MASK | X86_PTE_AVL_MASK | X86_PTE_PWT | X86_PTE_PCD | X86_PTE_PAT | X86_PTE_D | X86_PTE_A;
