#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: IEMAllThreadedPython.py 157933 2023-06-20 02:53:04Z knut.osmundsen@oracle.com $
...
class IEMThreadedGenerator(object):
    ...
    def generateLicenseHeader(self):
        ...
        return [
            '/*',
            ' * Autogenerated by $Id: IEMAllThreadedPython.py 157933 2023-06-20 02:53:04Z knut.osmundsen@oracle.com $ ',
            ' * Do not edit!',
            ' */',
            '',
            '/*',
