/* $Id: IOMAllMMIO.cpp 47278 2009-05-14 08:11:38Z noreply@oracle.com $ */
/** @file
    ...
    else if (iomGetRegImmData(pCpu, &pCpu->param2, pRegFrame, &uData2, &cb))
    {
        ...
        if (rc == VINF_SUCCESS)
        {
            ...
            if (rc == VINF_SUCCESS)
            {
                ...
                AssertMsg(rc == VINF_IOM_HC_MMIO_WRITE || rc == VINF_PATM_HC_MMIO_PATCH_WRITE, ("rc=%Vrc\n", rc));
        }
        else
            AssertMsg(rc == VINF_IOM_HC_MMIO_READ || rc == VINF_PATM_HC_MMIO_PATCH_READ, ("rc=%Vrc\n", rc));
    }
    else
    {
