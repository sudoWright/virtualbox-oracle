/* $Id: PGMAllGstSlatEpt.cpp.h 151396 2022-05-11 09:17:50Z ramshankar.venkataraman@oracle.com $ */
/** @file
                                            ...
                                            PPGMPTWALK pWalk, PGSTPTWALK pGstWalk)
{
    ...
    }
    {
        ...
        uint64_t const fEffectiveEpt = (fEptAttrs << PGM_PTATTRS_EPT_SHIFT) & fCumulativeEpt;
