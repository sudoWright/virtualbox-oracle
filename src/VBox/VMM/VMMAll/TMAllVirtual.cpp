/* $Id: TMAllVirtual.cpp 38730 2008-11-03 15:49:06Z noreply@oracle.com $ */
/** @file
...
#ifdef IN_RING3
    PVMREQ pReq;
    int rc = VMR3ReqCall(pVM, VMREQDEST_ALL, &pReq, RT_INDEFINITE_WAIT, (PFNRT)tmVirtualSetWarpDrive, 2, pVM, u32Percent);
    if (VBOX_SUCCESS(rc))
        rc = pReq->iStatus;
    VMR3ReqFree(pReq);
    return rc;
