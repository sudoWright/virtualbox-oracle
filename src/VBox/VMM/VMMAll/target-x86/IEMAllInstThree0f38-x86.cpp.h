/* $Id: IEMAllInstThree0f38-x86.cpp.h 167631 2025-02-19 12:02:33Z knut.osmundsen@oracle.com $ */
/** @file
 * IEM - Instruction Decoding and Emulation, x86 target, 0x0f 0x38 map.
 *
...
FNIEMOP_DEF(iemOp_ptest_Vx_Wx)
{
    ...
    else
    {
        ...
        IEMOP_HLP_DONE_DECODING_NO_LOCK_PREFIX_EX(fSse41);
        IEM_MC_MAYBE_RAISE_SSE_RELATED_XCPT();
        IEM_MC_FETCH_MEM_SEG_U128_ALIGN_SSE(uSrc2, pVCpu->iem.s.iEffSeg, GCPtrEffSrc);
