/* $Id: IEMMc.h 154368 2022-11-02 00:53:30Z knut.osmundsen@oracle.com $ */
/** @file
...
/** Sets RIP (may trigger \#GP), finishes the instruction and returns. */
#define IEM_MC_SET_RIP_U32_AND_FINISH(a_u32NewIP)       return iemRegRipJump((pVCpu), (a_u32NewIP))
/** Sets RIP (may trigger \#GP), finishes the instruction and returns. */
#define IEM_MC_SET_RIP_U64_AND_FINISH(a_u64NewIP)       return iemRegRipJump((pVCpu), (a_u64NewIP))
