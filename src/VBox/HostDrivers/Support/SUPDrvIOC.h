/* $Id: SUPDrvIOC.h 166041 2024-11-21 12:23:48Z vadim.galitsyn@oracle.com $ */
/** @file
...
#define SUP_IOCTL_QUERY_FUNCS_SIZE(cFuncs)              ((uint32_t)(RT_UOFFSETOF_DYN(SUPQUERYFUNCS, u.Out.aFunctions) \
...
#define SUP_IOCTL_LDR_LOAD_SIZE_IN(cbImage)             ((uint32_t)(RT_UOFFSETOF_DYN(SUPLDRLOAD, u.In.abImage) \
...
#define SUP_IOCTL_PAGE_ALLOC_EX_SIZE(cPages)            ((uint32_t)(RT_UOFFSETOF_DYN(SUPPAGEALLOCEX, u.Out.aPages) \
