#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: virtual_test_sheriff.py 107575 2016-05-29 21:06:04Z knut.osmundsen@oracle.com $
...
class VirtualTestSheriff(object): # pylint: disable=R0903
    ...
    def __init__(self):
        ...
        if self.oConfig.sBuildLogPath is not None and len(self.oConfig.sBuildLogPath) > 0:
            ...
            self.oLogFile.write('VirtualTestSheriff: $Revision: 107575 $ \n');
