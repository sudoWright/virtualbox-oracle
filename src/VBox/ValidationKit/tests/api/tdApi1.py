#!/usr/bin/env python
# -*- coding: utf-8 -*-
# $Id: tdApi1.py 120613 2018-01-30 18:20:29Z klaus.espenlaub@oracle.com $
...
if __name__ == '__main__':
    ...
    sys.exit(tdApi1([SubTstDrvPython1, SubTstDrvAppliance1, SubTstDrvMoveMedium1, SubTstDrvTreeDepth1]).main(sys.argv))
