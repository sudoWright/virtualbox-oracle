/* $Id: VBoxManageModifyVM.cpp 133984 2019-10-15 16:48:53Z andreas.loeffler@oracle.com $ */
/** @file
 ...
 *        around VirtualBox - typedefs more than covers that demand! */
    ...
    { "--biosnvram",                MODIFYVM_BIOSNVRAM,                 RTGETOPT_REQ_BOOL_ONOFF },
...
RTEXITCODE handleModifyVM(HandlerArg *a)
{
           ...
           && (c = RTGetOpt(&GetOptState, &ValueUnion)))
    {
        switch (c)
        {
            ...
            case MODIFYVM_BIOSNVRAM:
            {
                CHECK_ERROR(biosSettings, COMSETTER(NonVolatileStorageEnabled)(ValueUnion.f));
                break;
            }
