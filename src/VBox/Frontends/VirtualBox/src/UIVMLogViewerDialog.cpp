/* $Id: UIVMLogViewerDialog.cpp 119396 2017-12-04 11:25:44Z serkan.bayraktar@oracle.com $ */
/** @file
...
void UIVMLogViewerDialog::prepare()
{
    ...
    UIVMLogViewerWidget *viewerWidget = new UIVMLogViewerWidget(this, m_machine);
    ...
    m_viewers[m_machine.GetHardwareUUID()] = this;
...
void UIVMLogViewerDialog::cleanup()
{
    /* Remove log-viewer: */
    if (!m_machine.isNull())
        m_viewers.remove(m_machine.GetHardwareUUID());
