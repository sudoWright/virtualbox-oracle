/* $Id: UIToolsModel.cpp 168822 2025-05-13 10:31:53Z serkan.bayraktar@oracle.com $ */
/** @file
...
void UIToolsModel::sltRetranslateUI()
{
    foreach (UIToolsItem *pItem, m_items)
    {
        switch (pItem->itemType())
        {
            ...
            case UIToolType_ResourceUtilization:  pItem->setName(tr("Resource Utilization")); break;
