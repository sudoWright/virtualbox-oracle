/* $Id: UIVisoCreator.cpp 165258 2024-10-17 11:50:35Z serkan.bayraktar@oracle.com $ */
/** @file
...
bool UIVisoCreatorDialog::saveVISOFile()
{
    ...
    if (file.open(QFile::WriteOnly | QFile::Truncate))
    {
        ...
        /* Note: Quote the volume ID, as we might use the VM name as a default, which in turn can contain spaces. */
