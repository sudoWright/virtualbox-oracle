/* $Id: UIMachine.h 164827 2024-09-16 14:03:52Z knut.osmundsen@oracle.com $ */
/** @file
...
public:
     ...
     ** @{ */
        ...
        void acquireDisplayStatusInfo(QString &strInfo, uint &uVRAMSize, uint &cMonitorCount, bool &fAcceleration3D);
