/* $Id: UIConverterBackendCOM.cpp 135597 2020-01-09 04:31:04Z noreply@oracle.com $ */
/** @file
...
template<> QString toString(const KNetworkAdapterType &type)
{
    switch (type)
    {
        ...
        case KNetworkAdapterType_Virtio_1_0: return QApplication::translate("UICommon", "Paravirtualized Network (virtio-net-1-dot-0)", "NetworkAdapterType");
