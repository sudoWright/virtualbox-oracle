/* $Id: UIGChooserItemMachine.cpp 125956 2018-10-19 12:51:20Z noreply@oracle.com $ */
/** @file
...
void UIGChooserItemMachine::updateAll(const QUuid &uId)
{
    /* Skip other ids: */
    if (id() != uId)
        return;
...
void UIGChooserItemMachine::removeAll(const QUuid &uId)
{
    /* Skip wrong id: */
    if (id() != uId)
        return;
