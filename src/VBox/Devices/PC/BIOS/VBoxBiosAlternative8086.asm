; $Id: VBoxBiosAlternative8086.asm 118201 2017-09-29 13:50:51Z noreply@oracle.com $ 
;; @file
...
_bios_cvs_version_string:                    ; 0xf0d8e LB 0x16
    db  'VirtualBox 5.2.0_RC1', 000h, 000h
_bios_prefix_string:                         ; 0xf0da4 LB 0x8
    db  'BIOS: ', 000h, 000h
_isotag:                                     ; 0xf0dac LB 0x6
    db  'CD001', 000h
_eltorito:                                   ; 0xf0db2 LB 0x18
    db  'EL TORITO SPECIFICATION', 000h
_drivetypes:                                 ; 0xf0dca LB 0x28
...
_scan_to_scanascii:                          ; 0xf0df2 LB 0x37a
...
_panic_msg_keyb_buffer_full:                 ; 0xf116c LB 0x20
    db  '%s: keyboard input buffer full', 00ah, 000h

  ; Padding 0x474 bytes at 0xf118c
  times 1140 db 0

section _TEXT progbits vstart=0x1600 align=1 ; size=0x8eb8 class=CODE group=AUTO
...
floppy_drive_exists_:                        ; 0xf31b1 LB 0x4e
    ...
    add dh, dl                                ; 00 d6
    cmp di, word [di]                         ; 3b 3d
    xor bh, byte [bx-026ceh]                  ; 32 bf 32 d9
    db  032h, 0d9h
    ; xor bl, cl                                ; 32 d9
    db  032h, 0d9h
    ; xor bl, cl                                ; 32 d9
    xor cl, byte [bp+si+06e36h]               ; 32 8a 36 6e
    cmp byte [bx+di+039h], ch                 ; 38 69 39
    lodsb                                     ; ac
    cmp ax, sp                                ; 39 e0
    cmp word [si+03ah], dx                    ; 39 54 3a
_int13_diskette_function:                    ; 0xf31ff LB 0x9fd
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    jmp near 03ac1h                           ; e9 62 08
    mov ax, strict word 00010h                ; b8 10 00
    call 016aeh                               ; e8 49 e4
    test bl, bl                               ; 84 db
    jne short 03274h                          ; 75 0b
    mov CL, strict byte 004h                  ; b1 04
    mov dl, al                                ; 88 c2
    shr dl, CL                                ; d2 ea
    jmp short 03279h                          ; eb 08
    jmp near 03bd6h                           ; e9 62 09
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    test dl, dl                               ; 84 d2
    jne short 03297h                          ; 75 1a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    test dl, dl                               ; 84 d2
    je short 032bbh                           ; 74 e5
    jmp near 03ac1h                           ; e9 e8 07
    ...
    mov bl, byte [bp+00eh]                    ; 8a 5e 0e
    cmp bl, 001h                              ; 80 fb 01
    jnbe short 03305h                         ; 77 0d
    cmp AL, strict byte 001h                  ; 3c 01
    jnbe short 03305h                         ; 77 09
    test bh, bh                               ; 84 ff
    je short 03305h                           ; 74 05
    cmp bh, 048h                              ; 80 ff 48
    jbe short 0333ch                          ; 76 37
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 23 e6
    ...
    mov es, ax                                ; 8e c0
    mov byte [es:bx], 001h                    ; 26 c6 07 01
    jmp near 033e6h                           ; e9 aa 00
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 031b1h                               ; e8 6e fe
    test ax, ax                               ; 85 c0
    jne short 03361h                          ; 75 1a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov es, ax                                ; 8e c0
    mov byte [es:bx], 080h                    ; 26 c6 07 80
    jmp near 033e6h                           ; e9 85 00
    mov cl, bl                                ; 88 d9
    xor ch, ch                                ; 30 ed
    mov ax, cx                                ; 89 c8
    call 02febh                               ; e8 81 fc
    test ax, ax                               ; 85 c0
    jne short 03394h                          ; 75 26
    mov ax, cx                                ; 89 c8
    call 030cah                               ; e8 57 fd
    test ax, ax                               ; 85 c0
    jne short 03394h                          ; 75 1d
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    jmp near 03ac1h                           ; e9 2d 07
    mov al, byte [bp+017h]                    ; 8a 46 17
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00002h                ; 3d 02 00
    jne short 033edh                          ; 75 4f
    ...
    jmp near 03ac1h                           ; e9 d4 06
    jmp near 0353ah                           ; e9 4a 01
    ...
    mov AL, strict byte 0ffh                  ; b0 ff
    out DX, AL                                ; ee
    call 02effh                               ; e8 8b fa
    test al, al                               ; 84 c0
    jne short 03497h                          ; 75 1f
    mov ax, cx                                ; 89 c8
    call 02f37h                               ; e8 ba fa
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 c4 e4
    add sp, strict byte 00006h                ; 83 c4 06
    xor cx, cx                                ; 31 c9
    jmp short 034beh                          ; eb 05
    cmp cx, strict byte 00007h                ; 83 f9 07
    jnl short 034d4h                          ; 7d 16
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [es:si], al                      ; 26 88 04
    inc cx                                    ; 41
    jmp short 034b9h                          ; eb e5
    mov si, strict word 00042h                ; be 42 00
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov al, byte [es:si]                      ; 26 8a 04
    test AL, strict byte 0c0h                 ; a8 c0
    je short 03504h                           ; 74 21
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 02f37h                               ; e8 4d fa
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 020h                               ; 80 cc 20
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 02eb0h                               ; e8 81 f9
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp near 032bbh                           ; e9 81 fd
    mov al, byte [bp+017h]                    ; 8a 46 17
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 03547h                           ; 74 03
    jmp near 03673h                           ; e9 2c 01
    mov CL, strict byte 00ch                  ; b1 0c
    mov dx, word [bp+006h]                    ; 8b 56 06
    shr dx, CL                                ; d3 ea
    mov ch, dl                                ; 88 d5
    ...
    add ax, word [bp-00eh]                    ; 03 46 f2
    cmp ax, word [bp-00ch]                    ; 3b 46 f4
    jnc short 0357fh                          ; 73 03
    jmp near 033d3h                           ; e9 54 fe
    mov AL, strict byte 006h                  ; b0 06
    mov dx, strict word 0000ah                ; ba 0a 00
    out DX, AL                                ; ee
    xor al, al                                ; 30 c0
    ...
    mov AL, strict byte 0ffh                  ; b0 ff
    out DX, AL                                ; ee
    call 02effh                               ; e8 fc f8
    test al, al                               ; 84 c0
    jne short 0360ah                          ; 75 03
    jmp near 03478h                           ; e9 6e fe
    mov dx, 003f4h                            ; ba f4 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 51 e3
    add sp, strict byte 00006h                ; 83 c4 06
    xor cx, cx                                ; 31 c9
    jmp short 03631h                          ; eb 05
    cmp cx, strict byte 00007h                ; 83 f9 07
    jnl short 03647h                          ; 7d 16
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov bl, byte [bp+00eh]                    ; 8a 5e 0e
    cmp bl, 001h                              ; 80 fb 01
    jnbe short 036b7h                         ; 77 12
    cmp AL, strict byte 001h                  ; 3c 01
    jnbe short 036b7h                         ; 77 0e
    cmp dl, 04fh                              ; 80 fa 4f
    jnbe short 036b7h                         ; 77 09
    test bh, bh                               ; 84 ff
    je short 036b7h                           ; 74 05
    cmp bh, 012h                              ; 80 ff 12
    jbe short 036d2h                          ; 76 1b
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 031b1h                               ; e8 d8 fa
    test ax, ax                               ; 85 c0
    jne short 036f7h                          ; 75 1a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov es, ax                                ; 8e c0
    mov byte [es:bx], 080h                    ; 26 c6 07 80
    jmp near 03ac1h                           ; e9 ca 03
    mov cl, bl                                ; 88 d9
    xor ch, ch                                ; 30 ed
    mov ax, cx                                ; 89 c8
    call 02febh                               ; e8 eb f8
    test ax, ax                               ; 85 c0
    jne short 03710h                          ; 75 0c
    mov ax, cx                                ; 89 c8
    call 030cah                               ; e8 c1 f9
    test ax, ax                               ; 85 c0
    jne short 03710h                          ; 75 03
    jmp near 03377h                           ; e9 67 fc
    mov CL, strict byte 00ch                  ; b1 0c
    mov ax, word [bp+006h]                    ; 8b 46 06
    shr ax, CL                                ; d3 e8
    mov ch, al                                ; 88 c5
    ...
    out DX, AL                                ; ee
    call 02effh                               ; e8 24 f7
    test al, al                               ; 84 c0
    jne short 037e7h                          ; 75 08
    mov ax, cx                                ; 89 c8
    call 02f37h                               ; e8 53 f7
    jmp near 036ddh                           ; e9 f6 fe
    mov dx, 003f4h                            ; ba f4 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 74 e1
    add sp, strict byte 00006h                ; 83 c4 06
    xor cx, cx                                ; 31 c9
    jmp short 0380eh                          ; eb 05
    cmp cx, strict byte 00007h                ; 83 f9 07
    jnl short 03824h                          ; 7d 16
    mov dx, 003f5h                            ; ba f5 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov byte [es:si], al                      ; 26 88 04
    inc cx                                    ; 41
    jmp short 03809h                          ; eb e5
    mov si, strict word 00042h                ; be 42 00
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov al, byte [es:si]                      ; 26 8a 04
    test AL, strict byte 0c0h                 ; a8 c0
    je short 03852h                           ; 74 1f
    mov si, strict word 00043h                ; be 43 00
    mov al, byte [es:si]                      ; 26 8a 04
    test AL, strict byte 002h                 ; a8 02
    je short 03840h                           ; 74 03
    jmp near 03663h                           ; e9 23 fe
    mov ax, 00275h                            ; b8 75 02
    push ax                                   ; 50
    ...
    xor ah, ah                                ; 30 e4
    xor dx, dx                                ; 31 d2
    call 02eb0h                               ; e8 45 f6
    jmp near 03533h                           ; e9 c5 fc
    mov bl, dl                                ; 88 d3
    cmp dl, 001h                              ; 80 fa 01
    jbe short 0389bh                          ; 76 26
    ...
    jmp near 039c0h                           ; e9 25 01
    mov ax, strict word 00010h                ; b8 10 00
    call 016aeh                               ; e8 0d de
    mov dl, al                                ; 88 c2
    xor bh, bh                                ; 30 ff
    test AL, strict byte 0f0h                 ; a8 f0
    je short 038abh                           ; 74 02
    mov BH, strict byte 001h                  ; b7 01
    test dl, 00fh                             ; f6 c2 0f
    je short 038b2h                           ; 74 02
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    test bl, bl                               ; 84 db
    jne short 038bch                          ; 75 06
    mov CL, strict byte 004h                  ; b1 04
    shr dl, CL                                ; d2 ea
    jmp short 038bfh                          ; eb 03
    and dl, 00fh                              ; 80 e2 0f
    ...
    cmp dl, 003h                              ; 80 fa 03
    jc short 038fbh                           ; 72 15
    jbe short 03922h                          ; 76 3a
    cmp dl, 005h                              ; 80 fa 05
    jc short 03929h                           ; 72 3c
    jbe short 03930h                          ; 76 41
    cmp dl, 00fh                              ; 80 fa 0f
    je short 0393eh                           ; 74 4a
    cmp dl, 00eh                              ; 80 fa 0e
    je short 03937h                           ; 74 3e
    jmp short 03945h                          ; eb 4a
    cmp dl, 002h                              ; 80 fa 02
    je short 0391bh                           ; 74 1b
    cmp dl, 001h                              ; 80 fa 01
    je short 03914h                           ; 74 0f
    test dl, dl                               ; 84 d2
    jne short 03945h                          ; 75 3c
    mov word [bp+014h], strict word 00000h    ; c7 46 14 00 00
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 03957h                          ; eb 43
    mov word [bp+014h], 02709h                ; c7 46 14 09 27
    jmp short 03957h                          ; eb 3c
    mov word [bp+014h], 04f0fh                ; c7 46 14 0f 4f
    jmp short 03957h                          ; eb 35
    mov word [bp+014h], 04f09h                ; c7 46 14 09 4f
    jmp short 03957h                          ; eb 2e
    mov word [bp+014h], 04f12h                ; c7 46 14 12 4f
    jmp short 03957h                          ; eb 27
    mov word [bp+014h], 04f24h                ; c7 46 14 24 4f
    jmp short 03957h                          ; eb 20
    mov word [bp+014h], 0fe3fh                ; c7 46 14 3f fe
    jmp short 03957h                          ; eb 19
    mov word [bp+014h], 0feffh                ; c7 46 14 ff fe
    jmp short 03957h                          ; eb 12
    mov ax, 00275h                            ; b8 75 02
    push ax                                   ; 50
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 22 e0
    add sp, strict byte 00006h                ; 83 c4 06
    mov word [bp+006h], 0f000h                ; c7 46 06 00 f0
    mov al, dl                                ; 88 d0
    xor ah, ah                                ; 30 e4
    call 03bfch                               ; e8 99 02
    mov word [bp+008h], ax                    ; 89 46 08
    jmp near 03533h                           ; e9 ca fb
    mov bl, dl                                ; 88 d3
    cmp dl, 001h                              ; 80 fa 01
    jbe short 03975h                          ; 76 05
    mov word [bp+016h], cx                    ; 89 4e 16
    jmp short 039c0h                          ; eb 4b
    mov ax, strict word 00010h                ; b8 10 00
    call 016aeh                               ; e8 33 dd
    test bl, bl                               ; 84 db
    jne short 03987h                          ; 75 08
    mov CL, strict byte 004h                  ; b1 04
    mov dl, al                                ; 88 c2
    shr dl, CL                                ; d2 ea
    jmp short 0398ch                          ; eb 05
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    test dl, dl                               ; 84 d2
    je short 039a6h                           ; 74 0d
    cmp dl, 001h                              ; 80 fa 01
    jbe short 039a3h                          ; 76 05
    or ah, 002h                               ; 80 cc 02
    jmp short 039a6h                          ; eb 03
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    jmp near 032bbh                           ; e9 0f f9
    cmp dl, 001h                              ; 80 fa 01
    jbe short 039c6h                          ; 76 15
    ...
    jmp near 03ac1h                           ; e9 e1 00
    mov bl, dl                                ; 88 d3
    mov cl, byte [bp+016h]                    ; 8a 4e 16
    cmp dl, 001h                              ; 80 fa 01
    jnbe short 039b1h                         ; 77 c7
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 031b1h                               ; e8 c0 f7
    test ax, ax                               ; 85 c0
    jne short 039f8h                          ; 75 03
    jmp near 036ddh                           ; e9 e5 fc
    test bl, bl                               ; 84 db
    je short 03a01h                           ; 74 05
    mov bx, 00091h                            ; bb 91 00
    jmp short 03a04h                          ; eb 03
    mov bx, 00090h                            ; bb 90 00
    ...
    jc short 03a26h                           ; 72 0f
    jbe short 03a33h                          ; 76 1a
    cmp cl, 004h                              ; 80 f9 04
    je short 03a2eh                           ; 74 10
    cmp cl, 003h                              ; 80 f9 03
    je short 03a38h                           ; 74 15
    jmp near 03245h                           ; e9 1f f8
    cmp cl, 001h                              ; 80 f9 01
    je short 03a2eh                           ; 74 03
    jmp near 03245h                           ; e9 17 f8
    or bl, 090h                               ; 80 cb 90
    jmp short 03a3bh                          ; eb 08
    or bl, 070h                               ; 80 cb 70
    jmp short 03a3bh                          ; eb 03
    or bl, 010h                               ; 80 cb 10
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    ...
    cmp dl, 001h                              ; 80 fa 01
    jbe short 03a86h                          ; 76 03
    jmp near 039b1h                           ; e9 2b ff
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 031b1h                               ; e8 24 f7
    test ax, ax                               ; 85 c0
    jne short 03a94h                          ; 75 03
    jmp near 036ddh                           ; e9 49 fc
    mov cl, bl                                ; 88 d9
    xor ch, ch                                ; 30 ed
    mov ax, cx                                ; 89 c8
    call 02febh                               ; e8 4e f5
    test ax, ax                               ; 85 c0
    jne short 03ac8h                          ; 75 27
    mov ax, cx                                ; 89 c8
    call 030cah                               ; e8 24 f6
    test ax, ax                               ; 85 c0
    jne short 03ac8h                          ; 75 1e
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov byte [es:bx], 00ch                    ; 26 c6 07 0c
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 032bbh                           ; e9 f3 f7
    mov ax, strict word 00010h                ; b8 10 00
    call 016aeh                               ; e8 e0 db
    test bl, bl                               ; 84 db
    jne short 03adah                          ; 75 08
    mov CL, strict byte 004h                  ; b1 04
    mov dl, al                                ; 88 c2
    shr dl, CL                                ; d2 ea
    jmp short 03adfh                          ; eb 05
    mov dl, al                                ; 88 c2
    and dl, 00fh                              ; 80 e2 0f
    test bl, bl                               ; 84 db
    je short 03ae8h                           ; 74 05
    mov si, 00091h                            ; be 91 00
    jmp short 03aebh                          ; eb 03
    mov si, 00090h                            ; be 90 00
    mov word [bp-00ch], si                    ; 89 76 f4
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    ...
    and bl, 00fh                              ; 80 e3 0f
    cmp dl, 003h                              ; 80 fa 03
    jc short 03b19h                           ; 72 1b
    mov al, bl                                ; 88 d8
    or AL, strict byte 090h                   ; 0c 90
    cmp dl, 003h                              ; 80 fa 03
    jbe short 03b55h                          ; 76 4e
    mov ah, bl                                ; 88 dc
    or ah, 010h                               ; 80 cc 10
    cmp dl, 005h                              ; 80 fa 05
    je short 03b53h                           ; 74 42
    cmp dl, 004h                              ; 80 fa 04
    je short 03b62h                           ; 74 4c
    jmp near 03b9ah                           ; e9 81 00
    cmp dl, 002h                              ; 80 fa 02
    je short 03b33h                           ; 74 15
    cmp dl, 001h                              ; 80 fa 01
    jne short 03b66h                          ; 75 43
    cmp byte [bp-004h], 027h                  ; 80 7e fc 27
    jne short 03b66h                          ; 75 3d
    cmp bh, 009h                              ; 80 ff 09
    jne short 03b7ch                          ; 75 4e
    or bl, 090h                               ; 80 cb 90
    jmp short 03b7ch                          ; eb 49
    cmp byte [bp-004h], 027h                  ; 80 7e fc 27
    jne short 03b43h                          ; 75 0a
    cmp bh, 009h                              ; 80 ff 09
    jne short 03b43h                          ; 75 05
    or bl, 070h                               ; 80 cb 70
    jmp short 03b7ch                          ; eb 39
    cmp byte [bp-004h], 04fh                  ; 80 7e fc 4f
    jne short 03b9ah                          ; 75 51
    cmp bh, 00fh                              ; 80 ff 0f
    jne short 03b9ah                          ; 75 4c
    or bl, 010h                               ; 80 cb 10
    jmp short 03b9ah                          ; eb 47
    jmp short 03b7eh                          ; eb 29
    cmp byte [bp-004h], 04fh                  ; 80 7e fc 4f
    jne short 03b9ah                          ; 75 3f
    cmp bh, 009h                              ; 80 ff 09
    je short 03b64h                           ; 74 04
    jmp short 03b9ah                          ; eb 38
    jmp short 03b68h                          ; eb 04
    mov bl, al                                ; 88 c3
    jmp short 03b9ah                          ; eb 32
    cmp byte [bp-004h], 04fh                  ; 80 7e fc 4f
    jne short 03b9ah                          ; 75 2c
    cmp bh, 009h                              ; 80 ff 09
    jne short 03b75h                          ; 75 02
    jmp short 03b64h                          ; eb ef
    cmp bh, 012h                              ; 80 ff 12
    jne short 03b9ah                          ; 75 20
    mov bl, ah                                ; 88 e3
    jmp short 03b9ah                          ; eb 1c
    cmp byte [bp-004h], 04fh                  ; 80 7e fc 4f
    jne short 03b9ah                          ; 75 16
    cmp bh, 009h                              ; 80 ff 09
    jne short 03b8bh                          ; 75 02
    jmp short 03b64h                          ; eb d9
    cmp bh, 012h                              ; 80 ff 12
    jne short 03b92h                          ; 75 02
    jmp short 03b7ah                          ; eb e8
    cmp bh, 024h                              ; 80 ff 24
    jne short 03b9ah                          ; 75 03
    or bl, 0d0h                               ; 80 cb d0
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    mov CL, strict byte 004h                  ; b1 04
    sar ax, CL                                ; d3 f8
    test AL, strict byte 001h                 ; a8 01
    jne short 03ba9h                          ; 75 03
    jmp near 03aaah                           ; e9 01 ff
    mov ax, strict word 00040h                ; b8 40 00
    mov es, ax                                ; 8e c0
    mov si, word [bp-00ch]                    ; 8b 76 f4
    mov byte [es:si], bl                      ; 26 88 1c
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 80 dd
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 03245h                           ; e9 49 f6
get_floppy_dpt_:                             ; 0xf3bfc LB 0x32
    push bx                                   ; 53
    push dx                                   ; 52
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dl, al                                ; 88 c2
    xor ax, ax                                ; 31 c0
    jmp short 03c0dh                          ; eb 06
    inc ax                                    ; 40
    cmp ax, strict word 00007h                ; 3d 07 00
    jnc short 03c27h                          ; 73 1a
    mov bx, ax                                ; 89 c3
    sal bx, 1                                 ; d1 e3
    cmp dl, byte [word bx+0005bh]             ; 3a 97 5b 00
    jne short 03c07h                          ; 75 f0
    mov al, byte [word bx+0005ch]             ; 8a 87 5c 00
    xor ah, ah                                ; 30 e4
    mov bx, strict word 0000dh                ; bb 0d 00
    imul bx                                   ; f7 eb
    add ax, strict word 00000h                ; 05 00 00
    jmp short 03c2ah                          ; eb 03
    mov ax, strict word 00041h                ; b8 41 00
    pop bp                                    ; 5d
    pop dx                                    ; 5a
    pop bx                                    ; 5b
    retn                                      ; c3
dummy_soft_reset_:                           ; 0xf3c2e LB 0x7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    xor ax, ax                                ; 31 c0
    pop bp                                    ; 5d
    retn                                      ; c3
_cdemu_init:                                 ; 0xf3c35 LB 0x18
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 2d da
    xor bx, bx                                ; 31 db
    mov dx, 00366h                            ; ba 66 03
    call 01660h                               ; e8 17 da
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_cdemu_isactive:                             ; 0xf3c4d LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 15 da
    mov dx, 00366h                            ; ba 66 03
    call 01652h                               ; e8 f3 d9
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_cdemu_emulated_drive:                       ; 0xf3c63 LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 ff d9
    mov dx, 00368h                            ; ba 68 03
    call 01652h                               ; e8 dd d9
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_int13_eltorito:                             ; 0xf3c79 LB 0x191
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 b4 dc
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 03debh                           ; e9 23 01
    jmp near 03dd0h                           ; e9 05 01
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    mov ax, word [bp+004h]                    ; 8b 46 04
    mov bx, strict word 00013h                ; bb 13 00
    call 01660h                               ; e8 89 d9
    mov es, di                                ; 8e c7
    ...
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01660h                               ; e8 b6 d8
    test byte [bp+016h], 0ffh                 ; f6 46 16 ff
    jne short 03db6h                          ; 75 06
    mov es, di                                ; 8e c7
    mov byte [es:si], 000h                    ; 26 c6 04 00
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    xor bx, bx                                ; 31 db
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 5c d8
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 03dc9h                          ; eb bf
device_is_cdrom_:                            ; 0xf3e0a LB 0x3f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 53 d8
    mov cx, ax                                ; 89 c1
    cmp bl, 010h                              ; 80 fb 10
    jc short 03e26h                           ; 72 04
    xor ax, ax                                ; 31 c0
    jmp short 03e41h                          ; eb 1b
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    mov bx, strict word 0001ch                ; bb 1c 00
    imul bx                                   ; f7 eb
...
cdrom_boot_:                                 ; 0xf3e49 LB 0x43e
    ...
    jmp short 03e7eh                          ; eb 09
    inc byte [bp-00eh]                        ; fe 46 f2
    cmp byte [bp-00eh], 010h                  ; 80 7e f2 10
    jnc short 03e8ah                          ; 73 0c
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    xor ah, ah                                ; 30 e4
    call 03e0ah                               ; e8 84 ff
    test ax, ax                               ; 85 c0
    je short 03e75h                           ; 74 eb
    cmp byte [bp-00eh], 010h                  ; 80 7e f2 10
    jc short 03e96h                           ; 72 06
    mov ax, strict word 00002h                ; b8 02 00
    jmp near 04224h                           ; e9 8e 03
    mov cx, strict word 0000ch                ; b9 0c 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-026h]                         ; 8d 46 da
    call 0a1a0h                               ; e8 fd 62
    ...
    jmp short 03edeh                          ; eb 09
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 004h                  ; 80 7e f4 04
    jnbe short 03f20h                         ; 77 42
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    xor ah, ah                                ; 30 e4
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    ...
    call word [word di+0006ah]                ; ff 95 6a 00
    test ax, ax                               ; 85 c0
    je short 03fd3h                           ; 74 06
    mov ax, strict word 00007h                ; b8 07 00
    jmp near 04224h                           ; e9 51 02
    cmp byte [bp-00826h], 001h                ; 80 be da f7 01
    je short 03fe0h                           ; 74 06
    mov ax, strict word 00008h                ; b8 08 00
    jmp near 04224h                           ; e9 44 02
    cmp byte [bp-00825h], 000h                ; 80 be db f7 00
    je short 03fedh                           ; 74 06
    mov ax, strict word 00009h                ; b8 09 00
    jmp near 04224h                           ; e9 37 02
    cmp byte [bp-00808h], 055h                ; 80 be f8 f7 55
    je short 03ffah                           ; 74 06
    mov ax, strict word 0000ah                ; b8 0a 00
    jmp near 04224h                           ; e9 2a 02
    cmp byte [bp-00807h], 0aah                ; 80 be f9 f7 aa
    jne short 03ff4h                          ; 75 f3
    cmp byte [bp-00806h], 088h                ; 80 be fa f7 88
    je short 0400eh                           ; 74 06
    mov ax, strict word 0000bh                ; b8 0b 00
    jmp near 04224h                           ; e9 16 02
    ...
    test bx, bx                               ; 85 db
    je short 0408bh                           ; 74 06
    cmp bx, 00400h                            ; 81 fb 00 04
    jbe short 04091h                          ; 76 06
    mov ax, strict word 0000ch                ; b8 0c 00
    jmp near 04224h                           ; e9 93 01
    ...
    test ax, ax                               ; 85 c0
    je short 0413bh                           ; 74 06
    mov ax, strict word 0000dh                ; b8 0d 00
    jmp near 04224h                           ; e9 e9 00
    mov es, [bp-016h]                         ; 8e 46 ea
    mov al, byte [es:si+001h]                 ; 26 8a 44 01
    cmp AL, strict byte 002h                  ; 3c 02
    jc short 04153h                           ; 72 0d
    jbe short 0416eh                          ; 76 26
    cmp AL, strict byte 004h                  ; 3c 04
    je short 0417eh                           ; 74 32
    cmp AL, strict byte 003h                  ; 3c 03
    je short 04176h                           ; 74 26
    jmp near 041cch                           ; e9 79 00
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 041cch                          ; 75 75
    mov es, [bp-016h]                         ; 8e 46 ea
    ...
    je short 0420dh                           ; 74 37
    cmp byte [es:si+002h], 000h               ; 26 80 7c 02 00
    jne short 041f5h                          ; 75 18
    mov dx, strict word 00010h                ; ba 10 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 6c d4
    mov bl, al                                ; 88 c3
    or bl, 041h                               ; 80 cb 41
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00010h                ; ba 10 00
    mov ax, strict word 00040h                ; b8 40 00
    jmp short 0420ah                          ; eb 15
    mov dx, 00304h                            ; ba 04 03
    mov ax, word [bp-018h]                    ; 8b 46 e8
    call 01652h                               ; e8 54 d4
    mov bl, al                                ; 88 c3
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    xor bh, bh                                ; 30 ff
    mov dx, 00304h                            ; ba 04 03
    mov ax, word [bp-018h]                    ; 8b 46 e8
    call 01660h                               ; e8 53 d4
    mov es, [bp-016h]                         ; 8e 46 ea
    cmp byte [es:si+001h], 000h               ; 26 80 7c 01 00
    je short 0421bh                           ; 74 04
    mov byte [es:si], 001h                    ; 26 c6 04 01
    mov es, [bp-016h]                         ; 8e 46 ea
    ...
    db  010h, 00dh, 00ch, 00bh, 00ah, 009h, 008h, 005h, 004h, 003h, 002h, 001h, 000h, 03eh, 046h, 02eh
    db  043h, 063h, 043h, 088h, 043h, 058h, 043h, 088h, 043h, 058h, 043h, 087h, 045h, 06dh, 045h, 03eh
    db  046h, 03eh, 046h, 06dh, 045h, 06dh, 045h, 06dh, 045h, 06dh, 045h, 06dh, 045h, 035h, 046h, 06dh
    db  045h, 03eh, 046h, 03eh, 046h, 03eh, 046h, 03eh, 046h, 03eh, 046h, 03eh, 046h, 03eh, 046h, 03eh
    db  046h, 03eh, 046h, 03eh, 046h, 03eh, 046h, 03eh, 046h
_int13_cdemu:                                ; 0xf4287 LB 0x453
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 99 d3
    mov es, cx                                ; 8e c1
    cmp byte [es:di], 000h                    ; 26 80 3d 00
    je short 042deh                           ; 74 0f
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 74 d6
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 04661h                           ; e9 59 03
    mov al, byte [bp+017h]                    ; 8a 46 17
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 00050h                ; 3d 50 00
    jnbe short 04385h                         ; 77 71
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0001eh                ; b9 1e 00
    mov di, 0422eh                            ; bf 2e 42
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+0424bh]               ; 2e 8b 85 4b 42
    ...
    je short 04355h                           ; 74 09
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    call word [word bx+00076h]                ; ff 97 76 00
    jmp near 0456dh                           ; e9 15 02
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 003h                               ; 80 cc 03
    jmp near 04669h                           ; e9 06 03
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 e6 d2
    mov cl, al                                ; 88 c1
    mov bh, al                                ; 88 c7
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 e2 d2
    test cl, cl                               ; 84 c9
    je short 043e7h                           ; 74 65
    jmp near 0467ah                           ; e9 f5 02
    jmp near 0463eh                           ; e9 b6 02
    mov es, [bp-012h]                         ; 8e 46 ee
    ...
    test cx, cx                               ; 85 c9
    je short 043f4h                           ; 74 1d
    cmp di, word [bp-00ah]                    ; 3b 7e f6
    jc short 043e4h                           ; 72 08
    cmp ax, dx                                ; 39 d0
    jnc short 043e4h                          ; 73 04
    cmp bx, si                                ; 39 f3
    jnbe short 043eah                         ; 77 06
    jmp near 04661h                           ; e9 7a 02
    jmp near 04571h                           ; e9 87 01
    mov dl, byte [bp+017h]                    ; 8a 56 17
    xor dh, dh                                ; 30 f6
    cmp dx, strict byte 00004h                ; 83 fa 04
    jne short 043f7h                          ; 75 03
    jmp near 0456dh                           ; e9 76 01
    mov CL, strict byte 004h                  ; b1 04
    ...
    xor dl, dl                                ; 30 d2
    xor cx, cx                                ; 31 c9
    call 0a130h                               ; e8 18 5d
    xor bx, bx                                ; 31 db
    add ax, si                                ; 01 f0
    adc dx, bx                                ; 11 da
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 0a130h                               ; e8 0b 5d
    mov bx, ax                                ; 89 c3
    mov ax, word [bp-00ah]                    ; 8b 46 f6
    dec ax                                    ; 48
    xor cx, cx                                ; 31 c9
    ...
    mov word [bp+016h], ax                    ; 89 46 16
    mov byte [bp+016h], 000h                  ; c6 46 16 00
    jmp near 0466ch                           ; e9 ff 00
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    xor bx, bx                                ; 31 db
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 e4 d0
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    cmp AL, strict byte 003h                  ; 3c 03
    je short 04617h                           ; 74 1c
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0460fh                           ; 74 10
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 0461ch                          ; 75 19
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor al, al                                ; 30 c0
    or AL, strict byte 002h                   ; 0c 02
    mov word [bp+010h], ax                    ; 89 46 10
    jmp short 0461ch                          ; eb 0d
    or cl, 004h                               ; 80 c9 04
    mov word [bp+010h], cx                    ; 89 4e 10
    jmp short 0461ch                          ; eb 05
    or cl, 005h                               ; 80 c9 05
    jmp short 04612h                          ; eb f6
    mov es, [bp-012h]                         ; 8e 46 ee
    cmp byte [es:si+001h], 004h               ; 26 80 7c 01 04
    jc short 04629h                           ; 72 03
    jmp near 0456dh                           ; e9 44 ff
    mov word [bp+008h], 0efc7h                ; c7 46 08 c7 ef
    mov word [bp+006h], 0f000h                ; c7 46 06 00 f0
    jmp short 04626h                          ; eb f1
    or bh, 003h                               ; 80 cf 03
    mov word [bp+016h], bx                    ; 89 5e 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 e6 cf
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 04580h                           ; e9 ff fe
    db  050h, 04eh, 049h, 048h, 047h, 046h, 045h, 044h, 043h, 042h, 041h, 018h, 016h, 015h, 014h, 011h
    db  010h, 00dh, 00ch, 00bh, 00ah, 009h, 008h, 005h, 004h, 003h, 002h, 001h, 000h, 0c3h, 047h, 008h
    db  04ch, 085h, 047h, 0c3h, 047h, 07ah, 047h, 0c3h, 047h, 07ah, 047h, 0c3h, 047h, 008h, 04ch, 0c3h
    db  047h, 0c3h, 047h, 008h, 04ch, 008h, 04ch, 008h, 04ch, 008h, 04ch, 008h, 04ch, 0a7h, 047h, 008h
    db  04ch, 0c3h, 047h, 0b0h, 047h, 0e1h, 047h, 07ah, 047h, 0e1h, 047h, 02ah, 049h, 0cah, 049h, 0e1h
    db  047h, 0f4h, 049h, 022h, 04ch, 02ah, 04ch, 0c3h, 047h
_int13_cdrom:                                ; 0xf46da LB 0x585
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 5f cf
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor ah, ah                                ; 30 e4
    cmp ax, 000e0h                            ; 3d e0 00
    jc short 04710h                           ; 72 05
    cmp ax, 000f0h                            ; 3d f0 00
    jc short 0472fh                           ; 72 1f
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 4d d2
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 04c40h                           ; e9 11 05
    mov ax, word [bp+010h]                    ; 8b 46 10
    xor ah, ah                                ; 30 e4
    ...
    jmp short 04721h                          ; eb cd
    mov al, byte [bp+019h]                    ; 8a 46 19
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 00050h                ; 3d 50 00
    jnbe short 047c3h                         ; 77 63
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0001eh                ; b9 1e 00
    mov di, 04681h                            ; bf 81 46
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+0469eh]               ; 2e 8b 85 9e 46
    ...
    xor ah, ah                                ; 30 e4
    or ah, 003h                               ; 80 cc 03
    jmp near 04c48h                           ; e9 c3 04
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 c4 ce
    mov cl, al                                ; 88 c1
    mov bh, al                                ; 88 c7
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 c0 ce
    test cl, cl                               ; 84 c9
    je short 047c0h                           ; 74 1c
    jmp near 04c59h                           ; e9 b2 04
    or bh, 002h                               ; 80 cf 02
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp near 04c4bh                           ; e9 9b 04
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 50 d1
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 04c40h                           ; e9 14 04
    ...
    je short 04854h                           ; 74 05
    cmp ax, strict word 00047h                ; 3d 47 00
    jne short 04857h                          ; 75 03
    jmp near 04c08h                           ; e9 b1 03
    mov cx, strict word 0000ch                ; b9 0c 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-02eh]                         ; 8d 46 d2
    call 0a1a0h                               ; e8 3c 59
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 5a d0
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 04c48h                           ; e9 1e 03
    cmp bx, strict byte 00002h                ; 83 fb 02
    jnbe short 0499bh                         ; 77 6c
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    ...
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 049b3h                           ; 74 6c
    cmp bx, strict byte 00001h                ; 83 fb 01
    je short 0498bh                           ; 74 3f
    test bx, bx                               ; 85 db
    je short 04953h                           ; 74 03
    jmp near 04c08h                           ; e9 b5 02
    ...
    or AL, strict byte 001h                   ; 0c 01
    mov word [bp+018h], ax                    ; 89 46 18
    jmp short 04950h                          ; eb c5
    test cl, cl                               ; 84 c9
    jne short 0499eh                          ; 75 0f
    or bh, 0b0h                               ; 80 cf b0
    mov word [bp+018h], bx                    ; 89 5e 18
    mov byte [bp+018h], cl                    ; 88 4e 18
    jmp near 04c4bh                           ; e9 b0 02
    jmp near 04c40h                           ; e9 a2 02
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    ...
    mov byte [es:bx+025h], cl                 ; 26 88 4f 25
    test cl, cl                               ; 84 c9
    jne short 049c5h                          ; 75 0e
    xor ax, ax                                ; 31 c0
    mov dx, word [bp+018h]                    ; 8b 56 18
    xor dl, dl                                ; 30 d2
    or dx, ax                                 ; 09 c2
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 04950h                          ; eb 8b
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 049b9h                          ; eb ef
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    ...
    mov cl, byte [es:si+025h]                 ; 26 8a 4c 25
    test cl, cl                               ; 84 c9
    je short 049e7h                           ; 74 06
    or bh, 0b1h                               ; 80 cf b1
    jmp near 047aah                           ; e9 c3 fd
    je short 04a0eh                           ; 74 25
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 0b1h                               ; 80 cc b1
    jmp near 04c48h                           ; e9 54 02
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    ...
    jnc short 04a11h                          ; 73 05
    jmp short 0499bh                          ; eb 8d
    jmp near 04c08h                           ; e9 f7 01
    jc short 04a73h                           ; 72 60
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    ...
    jnc short 04a7ch                          ; 73 03
    jmp near 04b3ch                           ; e9 c0 00
    mov es, [bp-00ah]                         ; 8e 46 f6
    ...
    xor bl, bl                                ; 30 db
    xor bh, bh                                ; 30 ff
    jmp short 04b1ch                          ; eb 05
    cmp bh, 00fh                              ; 80 ff 0f
    jnc short 04b32h                          ; 73 16
    mov al, bh                                ; 88 f8
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    add dx, 00356h                            ; 81 c2 56 03
    mov ax, word [bp-018h]                    ; 8b 46 e8
    call 01652h                               ; e8 26 cb
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 04b17h                          ; eb e5
    neg bl                                    ; f6 db
    les di, [bp-00eh]                         ; c4 7e f2
    mov byte [es:di+00243h], bl               ; 26 88 9d 43 02
    cmp word [bp-01eh], strict byte 00042h    ; 83 7e e2 42
    jnc short 04b45h                          ; 73 03
    jmp near 04c08h                           ; e9 c3 00
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    cwd                                       ; 99
    db  02bh, 0c2h
    ...
    jmp short 04befh                          ; eb 05
    cmp ah, 040h                              ; 80 fc 40
    jnc short 04bffh                          ; 73 10
    mov bl, ah                                ; 88 e3
    xor bh, bh                                ; 30 ff
    mov es, [bp-00ah]                         ; 8e 46 f6
    add bx, si                                ; 01 f3
    ...
    or bh, 006h                               ; 80 cf 06
    mov word [bp+018h], bx                    ; 89 5e 18
    jmp short 04c59h                          ; eb 2f
    cmp bx, strict byte 00006h                ; 83 fb 06
    je short 04c08h                           ; 74 d9
    cmp bx, strict byte 00001h                ; 83 fb 01
    jc short 04c40h                           ; 72 0c
    jbe short 04c08h                          ; 76 d2
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 04c40h                           ; 72 05
    cmp bx, strict byte 00004h                ; 83 fb 04
    jbe short 04c08h                          ; 76 c8
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+018h], ax                    ; 89 46 18
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 07 ca
    or byte [bp+01eh], 001h                   ; 80 4e 1e 01
    jmp short 04c1bh                          ; eb bc
print_boot_device_:                          ; 0xf4c5f LB 0x51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    test al, al                               ; 84 c0
    je short 04c6ch                           ; 74 05
    mov dx, strict word 00002h                ; ba 02 00
    jmp short 04c86h                          ; eb 1a
    test dl, dl                               ; 84 d2
    je short 04c75h                           ; 74 05
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 04c86h                          ; eb 11
    test bl, 080h                             ; f6 c3 80
    jne short 04c7eh                          ; 75 04
    xor dh, dh                                ; 30 f6
    jmp short 04c86h                          ; eb 08
    test bl, 080h                             ; f6 c3 80
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 a2 cc
    mov ax, dx                                ; 89 d0
    mov dx, strict word 0000ah                ; ba 0a 00
    imul dx                                   ; f7 ea
    add ax, 00dcah                            ; 05 ca 0d
    push ax                                   ; 50
    mov ax, 00494h                            ; b8 94 04
    push ax                                   ; 50
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 cf cc
    add sp, strict byte 00006h                ; 83 c4 06
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop cx                                    ; 59
    pop bp                                    ; 5d
    retn                                      ; c3
print_boot_failure_:                         ; 0xf4cb0 LB 0x9f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    mov dh, cl                                ; 88 ce
    ...
    mov cx, 00ddeh                            ; b9 de 0d
    push cx                                   ; 51
    mov cx, 004a8h                            ; b9 a8 04
    push cx                                   ; 51
    mov cx, strict word 00004h                ; b9 04 00
    push cx                                   ; 51
    call 01976h                               ; e8 99 cc
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 04d2ah                          ; eb 48
    test dl, dl                               ; 84 d2
    ...
    push si                                   ; 56
    mov cx, 00dcah                            ; b9 ca 0d
    push cx                                   ; 51
    mov cx, 004bdh                            ; b9 bd 04
    push cx                                   ; 51
    mov cx, strict word 00004h                ; b9 04 00
    push cx                                   ; 51
    call 01976h                               ; e8 4f cc
    add sp, strict byte 00008h                ; 83 c4 08
    cmp byte [bp+004h], 001h                  ; 80 7e 04 01
    jne short 04d47h                          ; 75 17
    test dh, dh                               ; 84 f6
    jne short 04d39h                          ; 75 05
    mov dx, 004d5h                            ; ba d5 04
    jmp short 04d3ch                          ; eb 03
    mov dx, 004ffh                            ; ba ff 04
    push dx                                   ; 52
    mov dx, strict word 00007h                ; ba 07 00
    push dx                                   ; 52
    call 01976h                               ; e8 32 cc
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn 00002h                               ; c2 02 00
print_cdromboot_failure_:                    ; 0xf4d4f LB 0x2a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 d1 cb
    push dx                                   ; 52
    mov dx, 00534h                            ; ba 34 05
    push dx                                   ; 52
    mov dx, strict word 00004h                ; ba 04 00
    push dx                                   ; 52
    call 01976h                               ; e8 08 cc
    add sp, strict byte 00006h                ; 83 c4 06
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop dx                                    ; 5a
    pop cx                                    ; 59
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int19_function:                             ; 0xf4d79 LB 0x28d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 24 cb
    add sp, strict byte 00008h                ; 83 c4 08
    mov ax, word [bp-00eh]                    ; 8b 46 f2
    and ax, strict word 0000fh                ; 25 0f 00
    cmp ax, strict word 00002h                ; 3d 02 00
    jc short 04e6eh                           ; 72 0e
    jbe short 04e7dh                          ; 76 1b
    cmp ax, strict word 00004h                ; 3d 04 00
    je short 04e9ah                           ; 74 33
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 04e90h                           ; 74 24
    jmp short 04ec9h                          ; eb 5b
    cmp ax, strict word 00001h                ; 3d 01 00
    jne short 04ec9h                          ; 75 56
    xor al, al                                ; 30 c0
    mov byte [bp-006h], al                    ; 88 46 fa
    mov byte [bp-008h], al                    ; 88 46 f8
    jmp short 04eddh                          ; eb 60
    mov dx, 0037ch                            ; ba 7c 03
    mov ax, di                                ; 89 f8
    call 01652h                               ; e8 cd c7
    add AL, strict byte 080h                  ; 04 80
    mov byte [bp-006h], al                    ; 88 46 fa
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    jmp short 04eddh                          ; eb 4d
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov byte [bp-008h], 001h                  ; c6 46 f8 01
    jmp short 04ea4h                          ; eb 0a
    mov byte [bp-00ah], 001h                  ; c6 46 f6 01
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    je short 04eddh                           ; 74 39
    call 03e49h                               ; e8 a2 ef
    mov bx, ax                                ; 89 c3
    test AL, strict byte 0ffh                 ; a8 ff
    je short 04ed0h                           ; 74 23
    call 04d4fh                               ; e8 9f fe
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    jmp near 04eb0h                           ; e9 51 ff
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    jne short 04f8ch                          ; 75 27
    cmp byte [bp-00ah], 000h                  ; 80 7e f6 00
    jne short 04f8ch                          ; 75 21
    ...
    test ax, ax                               ; 85 c0
    je short 04f8ch                           ; 74 03
    jmp near 04eb0h                           ; e9 24 ff
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 04f96h                           ; 74 04
    xor bl, bl                                ; 30 db
    jmp short 04f98h                          ; eb 02
    mov BL, strict byte 001h                  ; b3 01
    cmp byte [bp-008h], 000h                  ; 80 7e f8 00
    je short 04fa0h                           ; 74 02
    mov BL, strict byte 001h                  ; b3 01
    xor dx, dx                                ; 31 d2
    mov ax, si                                ; 89 f0
    call 0166eh                               ; e8 c7 c6
    mov di, ax                                ; 89 c7
    mov dx, strict word 00002h                ; ba 02 00
    mov ax, si                                ; 89 f0
    call 0166eh                               ; e8 bd c6
    cmp di, ax                                ; 39 c7
    je short 04fc6h                           ; 74 11
    test bl, bl                               ; 84 db
    jne short 04fdeh                          ; 75 25
    mov dx, 001feh                            ; ba fe 01
    mov ax, si                                ; 89 f0
    call 0166eh                               ; e8 ad c6
    cmp ax, 0aa55h                            ; 3d 55 aa
    je short 04fdeh                           ; 74 18
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov bl, byte [bp-006h]                    ; 8a 5e fa
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
keyboard_panic_:                             ; 0xf5006 LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push ax                                   ; 50
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 61 c9
    add sp, strict byte 00006h                ; 83 c4 06
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
_keyboard_init:                              ; 0xf501c LB 0x26a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov AL, strict byte 0aah                  ; b0 aa
    ...
    test bx, bx                               ; 85 db
    jne short 05048h                          ; 75 05
    xor ax, ax                                ; 31 c0
    call 05006h                               ; e8 be ff
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 05062h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 05062h                          ; 76 08
    mov AL, strict byte 001h                  ; b0 01
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 0504bh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 0506ch                          ; 75 06
    mov ax, strict word 00001h                ; b8 01 00
    call 05006h                               ; e8 9a ff
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, strict word 00055h                ; 3d 55 00
    je short 0507dh                           ; 74 06
    mov ax, 003dfh                            ; b8 df 03
    call 05006h                               ; e8 89 ff
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 050c1h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 050c1h                          ; 76 08
    mov AL, strict byte 011h                  ; b0 11
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 050aah                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 050cbh                          ; 75 06
    mov ax, strict word 0000bh                ; b8 0b 00
    call 05006h                               ; e8 3b ff
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test ax, ax                               ; 85 c0
    je short 050dbh                           ; 74 06
    mov ax, 003e0h                            ; b8 e0 03
    call 05006h                               ; e8 2b ff
    mov AL, strict byte 0ffh                  ; b0 ff
    mov dx, strict word 00060h                ; ba 60 00
    out DX, AL                                ; ee
    mov bx, strict word 0ffffh                ; bb ff ff
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0511fh                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 0511fh                          ; 76 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05108h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 05129h                          ; 75 06
    mov ax, strict word 00015h                ; b8 15 00
    call 05006h                               ; e8 dd fe
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    call 05006h                               ; e8 cc fe
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0514ch                          ; 75 08
    mov AL, strict byte 031h                  ; b0 31
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 0513ah                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000aah                            ; 3d aa 00
    je short 05165h                           ; 74 0e
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000aah                            ; 3d aa 00
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 051a9h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 051a9h                          ; 76 08
    mov AL, strict byte 041h                  ; b0 41
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05192h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 051b3h                          ; 75 06
    mov ax, strict word 00029h                ; b8 29 00
    call 05006h                               ; e8 53 fe
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    je short 051c4h                           ; 74 06
    mov ax, 003e3h                            ; b8 e3 03
    call 05006h                               ; e8 42 fe
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 051e4h                           ; 74 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 051e4h                          ; 76 08
    mov AL, strict byte 050h                  ; b0 50
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 051cdh                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 051eeh                          ; 75 06
    mov ax, strict word 00032h                ; b8 32 00
    call 05006h                               ; e8 18 fe
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 0525ch                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 0525ch                          ; 76 08
    mov AL, strict byte 071h                  ; b0 71
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05245h                          ; eb e9
    test bx, bx                               ; 85 db
    jne short 05266h                          ; 75 06
    mov ax, strict word 00046h                ; b8 46 00
    call 05006h                               ; e8 a0 fd
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    je short 05277h                           ; 74 06
    mov ax, 003e4h                            ; b8 e4 03
    call 05006h                               ; e8 8f fd
    mov AL, strict byte 0a8h                  ; b0 a8
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    xor ax, ax                                ; 31 c0
    call 0677eh                               ; e8 fc 14
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
enqueue_key_:                                ; 0xf5286 LB 0x9e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 d2 c3
    mov di, ax                                ; 89 c7
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 c7 c3
    mov si, ax                                ; 89 c6
    lea cx, [si+002h]                         ; 8d 4c 02
    cmp cx, strict byte 0003eh                ; 83 f9 3e
    jc short 052b4h                           ; 72 03
    mov cx, strict word 0001eh                ; b9 1e 00
    cmp cx, di                                ; 39 f9
    jne short 052bch                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 052e6h                          ; eb 2a
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, si                                ; 89 f2
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 96 c3
    mov bl, byte [bp-00ah]                    ; 8a 5e f6
    xor bh, bh                                ; 30 ff
    lea dx, [si+001h]                         ; 8d 54 01
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 88 c3
    mov bx, cx                                ; 89 cb
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ch                               ; e8 99 c3
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-008h]                         ; 8d 66 f8
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    db  01dh, 06ah, 056h, 025h, 054h, 0c5h, 053h, 0c5h, 053h, 0b4h, 054h, 096h, 053h, 038h, 055h, 0a9h
    db  055h, 050h, 056h, 02eh, 056h, 06ch, 054h, 0c5h, 053h, 0c5h, 053h, 0f6h, 054h, 0b6h, 053h, 089h
    db  055h, 00eh, 056h, 049h, 056h
_int09_function:                             ; 0xf5324 LB 0x4cd
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    sub sp, strict byte 00010h                ; 83 ec 10
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 f3 c5
    mov ax, 00587h                            ; b8 87 05
    push ax                                   ; 50
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 2b c6
    add sp, strict byte 00004h                ; 83 c4 04
    jmp near 0541fh                           ; e9 ce 00
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 f8 c2
    mov byte [bp-006h], al                    ; 88 46 fa
    mov byte [bp-008h], al                    ; 88 46 f8
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 e9 c2
    mov byte [bp-00ah], al                    ; 88 46 f6
    mov byte [bp-010h], al                    ; 88 46 f0
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 da c2
    mov byte [bp-00ch], al                    ; 88 46 f4
    ...
    mov di, 052efh                            ; bf ef 52
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+05300h]               ; 2e 8b 85 00 53
    jmp ax                                    ; ff e0
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 62 c2
    mov al, byte [bp-004h]                    ; 8a 46 fc
    and AL, strict byte 07fh                  ; 24 7f
    cmp AL, strict byte 01dh                  ; 3c 1d
    je short 0540bh                           ; 74 04
    ...
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 41 c2
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop di                                    ; 5f
    pop bp                                    ; 5d
    retn                                      ; c3
    test byte [bp-00ah], 001h                 ; f6 46 f6 01
    jne short 053feh                          ; 75 d3
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    or AL, strict byte 004h                   ; 0c 04
    mov byte [bp-00eh], al                    ; 88 46 f2
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 20 c2
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    test AL, strict byte 002h                 ; a8 02
    je short 05455h                           ; 74 0e
    or AL, strict byte 004h                   ; 0c 04
    mov byte [bp-010h], al                    ; 88 46 f0
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00096h                            ; ba 96 00
    jmp short 05464h                          ; eb 0f
    mov al, byte [bp-006h]                    ; 8a 46 fa
    or AL, strict byte 001h                   ; 0c 01
    mov byte [bp-008h], al                    ; 88 46 f8
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 f6 c1
    jmp short 053feh                          ; eb 92
    test byte [bp-00ah], 001h                 ; f6 46 f6 01
    jne short 053feh                          ; 75 8c
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    and AL, strict byte 0fbh                  ; 24 fb
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov bl, al                                ; 88 c3
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 d9 c1
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    test AL, strict byte 002h                 ; a8 02
    je short 0549ch                           ; 74 0e
    and AL, strict byte 0fbh                  ; 24 fb
    mov byte [bp-010h], al                    ; 88 46 f0
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00096h                            ; ba 96 00
    jmp short 054abh                          ; eb 0f
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 af c1
    jmp near 053feh                           ; e9 4a ff
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 97 c1
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    test AL, strict byte 002h                 ; a8 02
    je short 054deh                           ; 74 0e
    or AL, strict byte 008h                   ; 0c 08
    mov byte [bp-010h], al                    ; 88 46 f0
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00096h                            ; ba 96 00
    jmp short 054edh                          ; eb 0f
    mov al, byte [bp-006h]                    ; 8a 46 fa
    or AL, strict byte 002h                   ; 0c 02
    mov byte [bp-008h], al                    ; 88 46 f8
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 6d c1
    jmp near 053feh                           ; e9 08 ff
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 55 c1
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    test AL, strict byte 002h                 ; a8 02
    je short 05520h                           ; 74 0e
    and AL, strict byte 0f7h                  ; 24 f7
    mov byte [bp-010h], al                    ; 88 46 f0
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00096h                            ; ba 96 00
    jmp short 0552fh                          ; eb 0f
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    jmp near 053feh                           ; e9 c6 fe
    test byte [bp-00ah], 003h                 ; f6 46 f6 03
    jne short 0555bh                          ; 75 1d
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 0d c1
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor AL, strict byte 020h                  ; 34 20
    jmp near 055fch                           ; e9 a1 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    or AL, strict byte 008h                   ; 0c 08
    mov byte [bp-008h], al                    ; 88 46 f8
    xor ah, ah                                ; 30 e4
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 f0 c0
    mov AL, strict byte 0aeh                  ; b0 ae
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    call 0e034h                               ; e8 bb 8a
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 d0 c0
    test AL, strict byte 008h                 ; a8 08
    jne short 05579h                          ; 75 f3
    jmp near 053feh                           ; e9 75 fe
    test byte [bp-00ah], 003h                 ; f6 46 f6 03
    je short 05592h                           ; 74 03
    jmp near 053feh                           ; e9 6c fe
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 b9 c0
    jmp short 0558fh                          ; eb e6
    test byte [bp-00ah], 002h                 ; f6 46 f6 02
    je short 055e2h                           ; 74 33
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 b6 c0
    mov bx, ax                                ; 89 c3
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ch                               ; e8 b9 c0
    mov bx, 00080h                            ; bb 80 00
    mov dx, strict word 00071h                ; ba 71 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 91 c0
    mov AL, strict byte 0aeh                  ; b0 ae
    mov dx, strict word 00064h                ; ba 64 00
    out DX, AL                                ; ee
    push bp                                   ; 55
    ...
    xor dx, dx                                ; 31 d2
    xor ax, ax                                ; 31 c0
    call 05286h                               ; e8 a6 fc
    jmp short 0558fh                          ; eb ad
    mov al, byte [bp-006h]                    ; 8a 46 fa
    ...
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 54 c0
    jmp short 0558fh                          ; eb 81
    test byte [bp-00ah], 002h                 ; f6 46 f6 02
    je short 05617h                           ; 74 03
    jmp near 053feh                           ; e9 e7 fd
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 0efh                  ; 24 ef
    mov byte [bp-008h], al                    ; 88 46 f8
    xor ah, ah                                ; 30 e4
    ...
    jmp short 05614h                          ; eb e6
    mov al, byte [bp-006h]                    ; 8a 46 fa
    test AL, strict byte 004h                 ; a8 04
    jne short 05614h                          ; 75 df
    or AL, strict byte 004h                   ; 0c 04
    mov byte [bp-008h], al                    ; 88 46 f8
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 19 c0
    jmp short 05614h                          ; eb cb
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 0fbh                  ; 24 fb
    jmp short 05637h                          ; eb e7
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    ...
    mov dx, strict word 00072h                ; ba 72 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ch                               ; e8 17 c0
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    test byte [bp-008h], 008h                 ; f6 46 f8 08
    je short 05681h                           ; 74 11
    and byte [bp-008h], 0f7h                  ; 80 66 f8 f7
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, strict word 00018h                ; ba 18 00
    jmp near 05419h                           ; e9 98 fd
    mov al, byte [bp-004h]                    ; 8a 46 fc
    test AL, strict byte 080h                 ; a8 80
    je short 056bfh                           ; 74 37
    cmp AL, strict byte 0fah                  ; 3c fa
    jne short 0569eh                          ; 75 12
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 bd bf
    mov bl, al                                ; 88 c3
    or bl, 010h                               ; 80 cb 10
    xor bh, bh                                ; 30 ff
    jmp short 056b4h                          ; eb 16
    cmp AL, strict byte 0feh                  ; 3c fe
    je short 056a5h                           ; 74 03
    jmp near 053feh                           ; e9 59 fd
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 a4 bf
    or AL, strict byte 020h                   ; 0c 20
    xor ah, ah                                ; 30 e4
    mov bx, ax                                ; 89 c3
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 a3 bf
    jmp short 056a2h                          ; eb e3
    cmp byte [bp-004h], 058h                  ; 80 7e fc 58
    jbe short 056e7h                          ; 76 22
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 63 c2
    mov al, byte [bp-004h]                    ; 8a 46 fc
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 95 c2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 0541fh                           ; e9 38 fd
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    test AL, strict byte 008h                 ; a8 08
    je short 05708h                           ; 74 1a
    mov al, byte [bp-004h]                    ; 8a 46 fc
    xor ah, ah                                ; 30 e4
    mov bx, strict word 0000ah                ; bb 0a 00
    imul bx                                   ; f7 eb
    ...
    xor ah, ah                                ; 30 e4
    mov dx, bx                                ; 89 da
    jmp near 055ddh                           ; e9 ec fd
dequeue_key_:                                ; 0xf57f1 LB 0x94
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 63 be
    mov bx, ax                                ; 89 c3
    mov dx, strict word 0001ch                ; ba 1c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 58 be
    cmp bx, ax                                ; 39 c3
    je short 05857h                           ; 74 3d
    mov dx, bx                                ; 89 da
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 30 be
    mov cl, al                                ; 88 c1
    lea dx, [bx+001h]                         ; 8d 57 01
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 25 be
    mov es, [bp-008h]                         ; 8e 46 f8
    mov byte [es:si], cl                      ; 26 88 0c
    mov es, [bp-006h]                         ; 8e 46 fa
    mov byte [es:di], al                      ; 26 88 05
    cmp word [bp+004h], strict byte 00000h    ; 83 7e 04 00
    je short 05852h                           ; 74 13
    inc bx                                    ; 43
    inc bx                                    ; 43
    cmp bx, strict byte 0003eh                ; 83 fb 3e
    jc short 05849h                           ; 72 03
    mov bx, strict word 0001eh                ; bb 1e 00
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0167ch                               ; e8 2a be
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 05859h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    add byte [di+04859h], cl                  ; 00 8d 59 48
    pop cx                                    ; 59
    fstp qword [bx+di+022h]                   ; dd 59 22
    pop dx                                    ; 5a
    xor ax, 05c5ah                            ; 35 5a 5c
    pop dx                                    ; 5a
    pop edx                                   ; 66 5a
    aad 05ah                                  ; d5 5a
    or AL, strict byte 05bh                   ; 0c 5b
    cmp ax, 0745bh                            ; 3d 5b 74
    pop bx                                    ; 5b
    xlatb                                     ; d7
    pop cx                                    ; 59
_int16_function:                             ; 0xf5885 LB 0x2fa
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    sub sp, strict byte 00006h                ; 83 ec 06
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 bd bd
    mov cl, al                                ; 88 c1
    mov bl, al                                ; 88 c3
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 b0 bd
    mov bh, al                                ; 88 c7
    mov dl, cl                                ; 88 ca
    xor dh, dh                                ; 30 f6
    mov CL, strict byte 004h                  ; b1 04
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 058d2h                          ; 75 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 058c0h                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    jne short 05926h                          ; 75 49
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 05913h                          ; 75 08
    mov AL, strict byte 021h                  ; b0 21
    mov dx, 00080h                            ; ba 80 00
    out DX, AL                                ; ee
    jmp short 05901h                          ; eb ee
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    mov dx, 00097h                            ; ba 97 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 3a bd
    sti                                       ; fb
    mov CL, strict byte 008h                  ; b1 08
    mov ax, word [bp+012h]                    ; 8b 46 12
    shr ax, CL                                ; d3 e8
    cmp ax, 000a2h                            ; 3d a2 00
    jnbe short 0598dh                         ; 77 5a
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 0000ch                ; b9 0c 00
    mov di, 05862h                            ; bf 62 58
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di+0586dh]               ; 2e 8b 85 6d 58
    jmp ax                                    ; ff e0
    mov ax, strict word 00001h                ; b8 01 00
    push ax                                   ; 50
    mov cx, ss                                ; 8c d1
    ...
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 057f1h                               ; e8 fe fd
    test ax, ax                               ; 85 c0
    jne short 059fdh                          ; 75 06
    or word [bp+01eh], strict byte 00040h     ; 83 4e 1e 40
    jmp short 059d7h                          ; eb da
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    je short 05a09h                           ; 74 06
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    je short 05a0fh                           ; 74 06
    cmp byte [bp-008h], 0e0h                  ; 80 7e f8 e0
    jne short 05a13h                          ; 75 04
    mov byte [bp-008h], 000h                  ; c6 46 f8 00
    mov dh, byte [bp-006h]                    ; 8a 76 fa
    mov dl, byte [bp-008h]                    ; 8a 56 f8
    mov word [bp+012h], dx                    ; 89 56 12
    and word [bp+01eh], strict byte 0ffbfh    ; 83 66 1e bf
    jmp short 059d7h                          ; eb b5
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 27 bc
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dl, al                                ; 88 c2
    mov word [bp+012h], dx                    ; 89 56 12
    jmp short 059d7h                          ; eb a2
    ...
    shr ax, CL                                ; d3 e8
    xor ah, ah                                ; 30 e4
    call 05286h                               ; e8 40 f8
    test ax, ax                               ; 85 c0
    jne short 05a54h                          ; 75 0a
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor al, al                                ; 30 c0
    or AL, strict byte 001h                   ; 0c 01
    jmp near 05987h                           ; e9 33 ff
    and word [bp+012h], 0ff00h                ; 81 66 12 00 ff
    jmp near 059d7h                           ; e9 7b ff
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor al, al                                ; 30 c0
    or AL, strict byte 030h                   ; 0c 30
    jmp near 05987h                           ; e9 21 ff
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 05a8dh                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 05a8dh                          ; 76 08
    mov dx, 00080h                            ; ba 80 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 05a76h                          ; eb e9
    test bx, bx                               ; 85 db
    jbe short 05acfh                          ; 76 3e
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp ax, 000fah                            ; 3d fa 00
    jne short 05acfh                          ; 75 33
    mov bx, strict word 0ffffh                ; bb ff ff
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 05ab6h                          ; 75 0d
    dec bx                                    ; 4b
    test bx, bx                               ; 85 db
    jbe short 05ab6h                          ; 76 08
    mov dx, 00080h                            ; ba 80 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 05a9fh                          ; eb e9
    test bx, bx                               ; 85 db
    jbe short 05ac6h                          ; 76 0c
    mov bl, ch                                ; 88 eb
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jnbe short 05a9ch                         ; 77 cd
    mov word [bp+00ch], cx                    ; 89 4e 0c
    jmp near 059d7h                           ; e9 02 ff
    mov ax, strict word 00001h                ; b8 01 00
    push ax                                   ; 50
    mov cx, ss                                ; 8c d1
    lea bx, [bp-008h]                         ; 8d 5e f8
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 057f1h                               ; e8 0b fd
    test ax, ax                               ; 85 c0
    jne short 05af8h                          ; 75 0e
    mov ax, 0060fh                            ; b8 0f 06
    push ax                                   ; 50
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 81 be
    add sp, strict byte 00004h                ; 83 c4 04
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    jne short 05b01h                          ; 75 03
    jmp near 05981h                           ; e9 80 fe
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    jne short 05b0ah                          ; 75 03
    jmp near 0597dh                           ; e9 73 fe
    jmp short 05afeh                          ; eb f2
    mov ax, word [bp+018h]                    ; 8b 46 18
    mov word [bp+01eh], ax                    ; 89 46 1e
    xor ax, ax                                ; 31 c0
    push ax                                   ; 50
    ...
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 057f1h                               ; e8 cf fc
    test ax, ax                               ; 85 c0
    jne short 05b29h                          ; 75 03
    jmp near 059f7h                           ; e9 ce fe
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    jne short 05b32h                          ; 75 03
    jmp near 05a13h                           ; e9 e1 fe
    cmp byte [bp-008h], 0f0h                  ; 80 7e f8 f0
    jne short 05b3bh                          ; 75 03
    jmp near 05a0fh                           ; e9 d4 fe
    jmp short 05b2fh                          ; eb f2
    mov dx, strict word 00017h                ; ba 17 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 0c bb
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dl, al                                ; 88 c2
    mov word [bp+012h], dx                    ; 89 56 12
    mov dx, strict word 00018h                ; ba 18 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 fb ba
    mov bl, al                                ; 88 c3
    and bl, 073h                              ; 80 e3 73
    mov dx, 00096h                            ; ba 96 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 ed ba
    mov ah, al                                ; 88 c4
    and ah, 00ch                              ; 80 e4 0c
    or ah, bl                                 ; 08 dc
    mov dx, word [bp+012h]                    ; 8b 56 12
    mov dh, ah                                ; 88 e6
    jmp near 05a30h                           ; e9 bc fe
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 080h                               ; 80 cc 80
    jmp near 05987h                           ; e9 08 fe
set_geom_lba_:                               ; 0xf5b7f LB 0xeb
    push bx                                   ; 53
    push cx                                   ; 51
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov si, strict word 00020h                ; be 20 00
    call 0a180h                               ; e8 d2 45
    test ax, ax                               ; 85 c0
    jne short 05bbeh                          ; 75 0c
    test bx, bx                               ; 85 db
    jne short 05bbeh                          ; 75 08
    test cx, cx                               ; 85 c9
    jne short 05bbeh                          ; 75 04
    test dx, dx                               ; 85 d2
    je short 05bc5h                           ; 74 07
    mov bx, strict word 0ffffh                ; bb ff ff
    mov si, bx                                ; 89 de
    jmp short 05bcbh                          ; eb 06
    mov bx, word [bp+00ch]                    ; 8b 5e 0c
    mov si, word [bp+00eh]                    ; 8b 76 0e
    mov word [bp-004h], bx                    ; 89 5e fc
    xor bx, bx                                ; 31 db
    jmp short 05bd7h                          ; eb 05
    cmp bx, strict byte 00004h                ; 83 fb 04
    jnl short 05bfah                          ; 7d 23
    mov ax, word [bp-006h]                    ; 8b 46 fa
    cmp si, ax                                ; 39 c6
    jc short 05be8h                           ; 72 0a
    jne short 05bf1h                          ; 75 11
    mov ax, word [bp-004h]                    ; 8b 46 fc
    cmp ax, word [bp-008h]                    ; 3b 46 f8
    jnbe short 05bf1h                         ; 77 09
    ...
    inc bx                                    ; 43
    jmp short 05bd2h                          ; eb d8
    mov ax, word [bp-002h]                    ; 8b 46 fe
    xor dx, dx                                ; 31 d2
    mov bx, strict word 0003fh                ; bb 3f 00
    xor cx, cx                                ; 31 c9
    call 0a130h                               ; e8 29 45
    mov bx, ax                                ; 89 c3
    mov cx, dx                                ; 89 d1
    mov ax, word [bp-004h]                    ; 8b 46 fc
    mov dx, si                                ; 89 f2
    call 0a150h                               ; e8 3d 45
    mov word [es:di+002h], ax                 ; 26 89 45 02
    cmp ax, 00400h                            ; 3d 00 04
    jbe short 05c22h                          ; 76 06
    ...
    das                                       ; 2f
    pop bp                                    ; 5d
    sbb ax, 0595fh                            ; 1d 5f 59
    pushaw                                    ; 60
    pop cx                                    ; 59
    pushaw                                    ; 60
    dec bp                                    ; 4d
    pop di                                    ; 5f
    xor sp, word [bx+si+059h]                 ; 33 60 59
    pushaw                                    ; 60
    pop cx                                    ; 59
    pushaw                                    ; 60
    xor sp, word [bx+si+033h]                 ; 33 60 33
    pushaw                                    ; 60
    pop cx                                    ; 59
    pushaw                                    ; 60
    pop cx                                    ; 59
    pushaw                                    ; 60
    mov BL, strict byte 05fh                  ; b3 5f
    xor sp, word [bx+si+059h]                 ; 33 60 59
    pushaw                                    ; 60
    pop cx                                    ; 59
    pushaw                                    ; 60
    xor sp, word [bx+si-01ch]                 ; 33 60 e4
    pop di                                    ; 5f
    pop cx                                    ; 59
    pushaw                                    ; 60
    pop cx                                    ; 59
    ...
    pop cx                                    ; 59
    pushaw                                    ; 60
_int13_harddisk:                             ; 0xf5c6a LB 0x44a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00010h                ; 83 ec 10
    or byte [bp+01dh], 002h                   ; 80 4e 1d 02
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 c0 bc
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 06074h                           ; e9 b8 03
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    mov es, [bp-006h]                         ; 8e 46 fa
    mov bx, si                                ; 89 f3
    ...
    jmp short 05caeh                          ; eb cb
    mov al, byte [bp+017h]                    ; 8a 46 17
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00018h                ; 3d 18 00
    jnbe short 05d2ch                         ; 77 3f
    mov bx, ax                                ; 89 c3
    sal bx, 1                                 ; d1 e3
    jmp word [cs:bx+05c38h]                   ; 2e ff a7 38 5c
    cmp byte [bp-002h], 008h                  ; 80 7e fe 08
    jnc short 05d04h                          ; 73 08
    mov al, byte [bp-002h]                    ; 8a 46 fe
    xor ah, ah                                ; 30 e4
    call 01db8h                               ; e8 b4 c0
    jmp near 05f36h                           ; e9 2f 02
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 42 b9
    mov cl, al                                ; 88 c1
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 3b b9
    test cl, cl                               ; 84 c9
    je short 05d8bh                           ; 74 62
    jmp near 0608dh                           ; e9 61 03
    jmp near 06059h                           ; e9 2a 03
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    mov word [bp-00ah], ax                    ; 89 46 f6
    mov al, byte [bp+015h]                    ; 8a 46 15
    ...
    mov ax, word [bp-00ah]                    ; 8b 46 f6
    cmp ax, 00080h                            ; 3d 80 00
    jnbe short 05d65h                         ; 77 04
    test ax, ax                               ; 85 c0
    jne short 05d8eh                          ; 75 29
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 c3 bb
    mov al, byte [bp+017h]                    ; 8a 46 17
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, 0067eh                            ; b8 7e 06
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 f1 bb
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 06074h                           ; e9 e9 02
    jmp near 05f3ah                           ; e9 ac 01
    mov al, byte [bp-002h]                    ; 8a 46 fe
    xor ah, ah                                ; 30 e4
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    ...
    mov word [bp-00eh], dx                    ; 89 56 f2
    cmp ax, word [bp-00ch]                    ; 3b 46 f4
    jbe short 05dbch                          ; 76 09
    cmp cx, word [bp-008h]                    ; 3b 4e f8
    jbe short 05dbch                          ; 76 04
    cmp di, dx                                ; 39 d7
    jbe short 05dedh                          ; 76 31
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 6c bb
    push di                                   ; 57
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 8f bb
    add sp, strict byte 00010h                ; 83 c4 10
    jmp near 06074h                           ; e9 87 02
    mov al, byte [bp+017h]                    ; 8a 46 17
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00004h                ; 3d 04 00
    je short 05e17h                           ; 74 20
    mov al, byte [bp-002h]                    ; 8a 46 fe
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    mov es, [bp-006h]                         ; 8e 46 fa
    ...
    jne short 05e20h                          ; 75 14
    mov ax, word [es:bx+034h]                 ; 26 8b 47 34
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    je short 05e1ah                           ; 74 05
    jmp short 05e20h                          ; eb 09
    jmp near 05f36h                           ; e9 1c 01
    cmp byte [bp-002h], 008h                  ; 80 7e fe 08
    jc short 05e4fh                           ; 72 2f
    mov ax, word [bp-00ch]                    ; 8b 46 f4
    xor dx, dx                                ; 31 d2
    mov bx, cx                                ; 89 cb
    xor cx, cx                                ; 31 c9
    call 0a130h                               ; e8 04 43
    xor bx, bx                                ; 31 db
    add ax, word [bp-008h]                    ; 03 46 f8
    adc dx, bx                                ; 11 da
    mov bx, word [bp-00eh]                    ; 8b 5e f2
    xor cx, cx                                ; 31 c9
    call 0a130h                               ; e8 f5 42
    xor bx, bx                                ; 31 db
    add ax, di                                ; 01 f8
    adc dx, bx                                ; 11 da
    add ax, strict word 0ffffh                ; 05 ff ff
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 0b ba
    mov ax, 0077ah                            ; b8 7a 07
    push ax                                   ; 50
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 43 ba
    add sp, strict byte 00004h                ; 83 c4 04
    mov byte [bp+017h], 000h                  ; c6 46 17 00
    xor bx, bx                                ; 31 db
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 1b b7
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    ...
    and AL, strict byte 0c0h                  ; 24 c0
    cmp AL, strict byte 040h                  ; 3c 40
    jne short 05fd9h                          ; 75 03
    jmp near 05f36h                           ; e9 5d ff
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 0aah                               ; 80 cc aa
    jmp near 0607ch                           ; e9 98 00
    mov al, byte [bp-002h]                    ; 8a 46 fe
    xor ah, ah                                ; 30 e4
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    ...
    xor cx, cx                                ; 31 c9
    call 0a130h                               ; e8 1e 41
    mov bx, di                                ; 89 fb
    xor cx, cx                                ; 31 c9
    call 0a130h                               ; e8 17 41
    mov word [bp-010h], ax                    ; 89 46 f0
    mov word [bp-004h], dx                    ; 89 56 fc
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 23 b9
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 05f36h                           ; e9 dd fe
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 cf b8
    mov al, byte [bp+017h]                    ; 8a 46 17
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, 0067eh                            ; b8 7e 06
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 d3 b5
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp near 05f49h                           ; e9 b5 fe
    dec si                                    ; 4e
    popaw                                     ; 61
    and word [bx+di-07fh], 08161h             ; 81 61 81 61 81
    popaw                                     ; 61
    xchg bx, ax                               ; 93
    mul byte [gs:bp+si-07fh]                  ; 65 f6 62 81
    popaw                                     ; 61
    cld                                       ; fc
    bound dx, [bp+di+06665h]                  ; 62 93 65 66
    popaw                                     ; 61
    popad                                     ; 66 61
    popad                                     ; 66 61
    popad                                     ; 66 61
    ...
    ; gs popad                                  ; 65 66 61
    popad                                     ; 66 61
_int13_harddisk_ext:                         ; 0xf60b4 LB 0x52b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 9f b5
    mov word [bp-008h], 00122h                ; c7 46 f8 22 01
    mov word [bp-006h], ax                    ; 89 46 fa
    xor bx, bx                                ; 31 db
    mov dx, 0008eh                            ; ba 8e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 7e b5
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    cmp ax, 00080h                            ; 3d 80 00
    jc short 060f1h                           ; 72 05
    cmp ax, 00090h                            ; 3d 90 00
    jc short 06110h                           ; 72 1f
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov al, byte [bp+017h]                    ; 8a 46 17
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 6c b8
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 065c0h                           ; e9 b0 04
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    xor ah, ah                                ; 30 e4
    ...
    push ax                                   ; 50
    mov ax, 006b8h                            ; b8 b8 06
    jmp short 06102h                          ; eb cd
    mov bl, byte [bp+017h]                    ; 8a 5e 17
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00041h                ; 83 eb 41
    cmp bx, strict byte 0000fh                ; 83 fb 0f
    jnbe short 06166h                         ; 77 24
    sal bx, 1                                 ; d1 e3
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    jmp word [cs:bx+06094h]                   ; 2e ff a7 94 60
    ...
    jnbe short 06206h                         ; 77 22
    jne short 0622ch                          ; 75 46
    mov dx, word [bp-010h]                    ; 8b 56 f0
    cmp dx, word [es:bx+03ah]                 ; 26 3b 57 3a
    jnbe short 06206h                         ; 77 17
    mov dx, word [bp-010h]                    ; 8b 56 f0
    cmp dx, word [es:bx+03ah]                 ; 26 3b 57 3a
    jne short 0622ch                          ; 75 34
    cmp cx, word [es:bx+038h]                 ; 26 3b 4f 38
    jnbe short 06206h                         ; 77 08
    jne short 0622ch                          ; 75 2c
    cmp si, word [es:bx+036h]                 ; 26 3b 77 36
    jc short 0622ch                           ; 72 26
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 22 b7
    mov al, byte [bp+017h]                    ; 8a 46 17
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, 007f5h                            ; b8 f5 07
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 50 b7
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 065c0h                           ; e9 94 03
    ...
    je short 06242h                           ; 74 06
    cmp word [bp-012h], strict byte 00047h    ; 83 7e ee 47
    jne short 06245h                          ; 75 03
    jmp near 06593h                           ; e9 4e 03
    les bx, [bp-008h]                         ; c4 5e f8
    mov word [es:bx+018h], strict word 00000h ; 26 c7 47 18 00 00
    mov word [es:bx+01ah], strict word 00000h ; 26 c7 47 1a 00 00
    mov word [es:bx+01ch], strict word 00000h ; 26 c7 47 1c 00 00
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 8e b6
    add sp, strict byte 0000ah                ; 83 c4 0a
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 00ch                               ; 80 cc 0c
    jmp near 065c8h                           ; e9 d2 02
    or ah, 0b2h                               ; 80 cc b2
    jmp near 065c8h                           ; e9 cc 02
    ...
    mov word [bp-014h], ax                    ; 89 46 ec
    cmp ax, strict word 0001ah                ; 3d 1a 00
    jnc short 0631dh                          ; 73 06
    jmp near 065c0h                           ; e9 a6 02
    jmp near 06593h                           ; e9 76 02
    jnc short 06322h                          ; 73 03
    jmp near 063b5h                           ; e9 93 00
    mov al, byte [bp-004h]                    ; 8a 46 fc
    xor ah, ah                                ; 30 e4
    mov dx, strict word 0001ch                ; ba 1c 00
    imul dx                                   ; f7 ea
    ...
    test al, al                               ; 84 c0
    jne short 06418h                          ; 75 04
    xor si, si                                ; 31 f6
    jmp short 0641bh                          ; eb 03
    mov si, strict word 00008h                ; be 08 00
    or si, strict byte 00010h                 ; 83 ce 10
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 0642ah                          ; 75 08
    mov dx, strict word 00001h                ; ba 01 00
    jmp short 0642ch                          ; eb 05
    jmp near 064c2h                           ; e9 98 00
    xor dx, dx                                ; 31 d2
    or si, dx                                 ; 09 d6
    cmp AL, strict byte 003h                  ; 3c 03
    jne short 06437h                          ; 75 05
    mov ax, strict word 00003h                ; b8 03 00
    jmp short 06439h                          ; eb 02
    xor ax, ax                                ; 31 c0
    or si, ax                                 ; 09 c6
    mov ax, word [bp-022h]                    ; 8b 46 de
    les bx, [bp-008h]                         ; c4 5e f8
    ...
    xor bl, bl                                ; 30 db
    xor bh, bh                                ; 30 ff
    jmp short 064a2h                          ; eb 05
    cmp bh, 00fh                              ; 80 ff 0f
    jnc short 064b8h                          ; 73 16
    mov al, bh                                ; 88 f8
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    add dx, 00356h                            ; 81 c2 56 03
    mov ax, word [bp-018h]                    ; 8b 46 e8
    call 01652h                               ; e8 a0 b1
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 0649dh                          ; eb e5
    neg bl                                    ; f6 db
    les si, [bp-008h]                         ; c4 76 f8
    mov byte [es:si+00243h], bl               ; 26 88 9c 43 02
    cmp word [bp-014h], strict byte 00042h    ; 83 7e ec 42
    jnc short 064cbh                          ; 73 03
    jmp near 06593h                           ; e9 c8 00
    mov al, byte [bp-004h]                    ; 8a 46 fc
    xor ah, ah                                ; 30 e4
    cwd                                       ; 99
    db  02bh, 0c2h
    ...
    jmp short 06575h                          ; eb 05
    cmp bh, 040h                              ; 80 ff 40
    jnc short 0658ah                          ; 73 15
    mov al, bh                                ; 88 f8
    xor ah, ah                                ; 30 e4
    mov dx, word [bp+00ah]                    ; 8b 56 0a
    add dx, ax                                ; 01 c2
    mov ax, word [bp+004h]                    ; 8b 46 04
    call 01652h                               ; e8 ce b0
    add bl, al                                ; 00 c3
    db  0feh, 0c7h
    ; inc bh                                    ; fe c7
    jmp short 06570h                          ; eb e6
    neg bl                                    ; f6 db
    mov es, [bp-00ah]                         ; 8e 46 f6
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 be b0
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    cmp ax, strict word 00006h                ; 3d 06 00
    je short 06593h                           ; 74 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 065c0h                           ; 72 0c
    jbe short 06593h                          ; 76 dd
    cmp ax, strict word 00003h                ; 3d 03 00
    jc short 065c0h                           ; 72 05
    cmp ax, strict word 00004h                ; 3d 04 00
    jbe short 06593h                          ; 76 d3
    mov ax, word [bp+016h]                    ; 8b 46 16
    xor ah, ah                                ; 30 e4
    or ah, 001h                               ; 80 cc 01
    mov word [bp+016h], ax                    ; 89 46 16
    ...
    mov dx, strict word 00074h                ; ba 74 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 87 b0
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 065a6h                          ; eb c7
_int14_function:                             ; 0xf65df LB 0x15c
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sti                                       ; fb
    ...
    sal dx, 1                                 ; d1 e2
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 7f b0
    mov si, ax                                ; 89 c6
    mov bx, ax                                ; 89 c3
    mov dx, word [bp+00eh]                    ; 8b 56 0e
    add dx, strict byte 0007ch                ; 83 c2 7c
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 53 b0
    mov cl, al                                ; 88 c1
    cmp word [bp+00eh], strict byte 00004h    ; 83 7e 0e 04
    jnc short 0660bh                          ; 73 04
    test si, si                               ; 85 f6
    jnbe short 0660eh                         ; 77 03
    jmp near 06731h                           ; e9 23 01
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 06622h                           ; 72 0d
    jbe short 06682h                          ; 76 6b
    cmp AL, strict byte 003h                  ; 3c 03
    je short 0667ah                           ; 74 5f
    cmp AL, strict byte 002h                  ; 3c 02
    je short 0667dh                           ; 74 5e
    jmp near 0672bh                           ; e9 09 01
    test al, al                               ; 84 c0
    jne short 0667fh                          ; 75 59
    lea dx, [bx+003h]                         ; 8d 57 03
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jmp near 0670ch                           ; e9 92 00
    jmp near 0671ah                           ; e9 9d 00
    jmp short 066d0h                          ; eb 51
    jmp near 0672bh                           ; e9 a9 00
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 e3 af
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    je short 066b2h                           ; 74 17
    test cl, cl                               ; 84 c9
    je short 066b2h                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 c6 af
    cmp ax, si                                ; 39 f0
    je short 0668dh                           ; 74 e1
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 0668dh                          ; eb db
    test cl, cl                               ; 84 c9
    je short 066bch                           ; 74 06
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    lea dx, [bx+005h]                         ; 8d 57 05
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cl, cl                               ; 84 c9
    jne short 0670ch                          ; 75 43
    or AL, strict byte 080h                   ; 0c 80
    mov byte [bp+013h], al                    ; 88 46 13
    jmp short 0670ch                          ; eb 3c
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 95 af
    mov si, ax                                ; 89 c6
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 066fch                          ; 75 17
    test cl, cl                               ; 84 c9
    je short 066fch                           ; 74 13
    mov dx, strict word 0006ch                ; ba 6c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 7c af
    cmp ax, si                                ; 39 f0
    je short 066dbh                           ; 74 e5
    mov si, ax                                ; 89 c6
    db  0feh, 0c9h
    ; dec cl                                    ; fe c9
    jmp short 066dbh                          ; eb df
    test cl, cl                               ; 84 c9
    je short 06712h                           ; 74 12
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ...
    mov byte [bp+012h], al                    ; 88 46 12
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 06735h                          ; eb 23
    lea dx, [bx+005h]                         ; 8d 57 05
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 066cbh                          ; eb b1
    ...
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    jmp short 06709h                          ; eb de
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    jmp short 06735h                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
timer_wait_:                                 ; 0xf673b LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    jne short 06768h                          ; 75 05
    cmp cx, strict byte 0ffffh                ; 83 f9 ff
    je short 06777h                           ; 74 0f
    mov dx, strict word 00061h                ; ba 61 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    jne short 06768h                          ; 75 f3
    jmp short 06758h                          ; eb e1
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop cx                                    ; 59
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
set_enable_a20_:                             ; 0xf677e LB 0x30
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov cl, al                                ; 88 c1
    test bx, bx                               ; 85 db
    je short 06797h                           ; 74 05
    or AL, strict byte 002h                   ; 0c 02
    out DX, AL                                ; ee
    jmp short 0679ah                          ; eb 03
    and AL, strict byte 0fdh                  ; 24 fd
    out DX, AL                                ; ee
    test cl, 002h                             ; f6 c1 02
    je short 067a4h                           ; 74 05
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 067a6h                          ; eb 02
    xor ax, ax                                ; 31 c0
    lea sp, [bp-006h]                         ; 8d 66 fa
    pop dx                                    ; 5a
    pop cx                                    ; 59
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_e820_range_:                             ; 0xf67ae LB 0x88
    push si                                   ; 56
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov si, dx                                ; 89 d6
    ...
    db  043h, 06bh, 072h, 068h, 086h, 068h, 022h, 069h, 028h, 069h, 02dh, 069h, 032h, 069h, 0dah, 069h
    db  0feh, 069h, 01bh, 069h, 01bh, 069h, 0c8h, 06ah, 0f3h, 06ah, 006h, 06bh, 015h, 06bh, 022h, 069h
    db  01eh, 06bh
_int15_function:                             ; 0xf6836 LB 0x343
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jnbe short 0687ch                         ; 77 35
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 00011h                ; b9 11 00
    mov di, 06804h                            ; bf 04 68
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov si, word [cs:di+06814h]               ; 2e 8b b5 14 68
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    ...
    je short 0687fh                           ; 74 03
    jmp near 06b43h                           ; e9 c4 02
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 06aeah                           ; e9 64 02
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 0689bh                           ; 72 0e
    jbe short 068afh                          ; 76 20
    cmp ax, strict word 00003h                ; 3d 03 00
    je short 068e0h                           ; 74 4c
    cmp ax, strict word 00002h                ; 3d 02 00
    je short 068bfh                           ; 74 26
    jmp short 068edh                          ; eb 52
    test ax, ax                               ; 85 c0
    jne short 068edh                          ; 75 4e
    xor ax, ax                                ; 31 c0
    call 0677eh                               ; e8 da fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp near 0691bh                           ; e9 6c 00
    mov ax, strict word 00001h                ; b8 01 00
    call 0677eh                               ; e8 c9 fe
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov byte [bp+013h], dh                    ; 88 76 13
    jmp near 0691bh                           ; e9 5c 00
    mov dx, 00092h                            ; ba 92 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    retn                                      ; c3
    mov word [bp+018h], dx                    ; 89 56 18
    jmp near 069d4h                           ; e9 ac 00
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 0691bh                          ; eb ee
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp short 06918h                          ; eb e6
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 069a7h                          ; 75 6f
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 11 ad
    test AL, strict byte 001h                 ; a8 01
    jne short 069a4h                          ; 75 5f
    mov bx, strict word 00001h                ; bb 01 00
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 0f ad
    mov bx, word [bp+014h]                    ; 8b 5e 14
    ...
    out DX, AL                                ; ee
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016aeh                               ; e8 1a ad
    mov dl, al                                ; 88 c2
    or dl, 040h                               ; 80 ca 40
    xor dh, dh                                ; 30 f6
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c9h                               ; e8 28 ad
    jmp near 0691bh                           ; e9 77 ff
    jmp near 06ae1h                           ; e9 3a 01
    cmp ax, strict word 00001h                ; 3d 01 00
    jne short 069c8h                          ; 75 1c
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    ...
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016aeh                               ; e8 ed ac
    mov dl, al                                ; 88 c2
    and dl, 0bfh                              ; 80 e2 bf
    jmp short 06999h                          ; eb d1
    mov word [bp+018h], dx                    ; 89 56 18
    mov ax, bx                                ; 89 d8
    xor ah, bh                                ; 30 fc
    xor bl, bl                                ; 30 db
    ...
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 60 ae
    mov ax, 0086eh                            ; b8 6e 08
    push ax                                   ; 50
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 98 ae
    add sp, strict byte 00004h                ; 83 c4 04
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    mov ax, word [bp+012h]                    ; 8b 46 12
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    mov word [bp+012h], ax                    ; 89 46 12
    jmp near 0691bh                           ; e9 28 fe
    mov word [bp+018h], cx                    ; 89 4e 18
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+00ch], 0e6f5h                ; c7 46 0c f5 e6
    mov word [bp+014h], 0f000h                ; c7 46 14 00 f0
    jmp near 0691bh                           ; e9 15 fe
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 5f ab
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 069f7h                           ; e9 e2 fe
    mov ax, 0089dh                            ; b8 9d 08
    push ax                                   ; 50
    mov ax, strict word 00008h                ; b8 08 00
    jmp short 06adah                          ; eb bc
    test byte [bp+012h], 0ffh                 ; f6 46 12 ff
    jne short 06b43h                          ; 75 1f
    mov word [bp+012h], ax                    ; 89 46 12
    mov ax, word [bp+00ch]                    ; 8b 46 0c
    xor ah, ah                                ; 30 e4
    cmp ax, strict word 00001h                ; 3d 01 00
    jc short 06b3ch                           ; 72 0b
    cmp ax, strict word 00003h                ; 3d 03 00
    jnbe short 06b3ch                         ; 77 06
    mov word [bp+018h], cx                    ; 89 4e 18
    jmp near 0691bh                           ; e9 df fd
    or byte [bp+018h], 001h                   ; 80 4e 18 01
    jmp near 0691bh                           ; e9 d8 fd
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 e5 ad
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 17 ae
    add sp, strict byte 00008h                ; 83 c4 08
    jmp near 06ae1h                           ; e9 7c ff
    loop 06bd3h                               ; e2 6c
    or AL, strict byte 06dh                   ; 0c 6d
    db  064h, 06dh
    ; fs insw                                   ; 64 6d
    mov word [di-057h], bp                    ; 89 6d a9
    insw                                      ; 6d
    enter 0ee6dh, 06dh                        ; c8 6d ee 6d
    adc AL, strict byte 06eh                  ; 14 6e
    push cx                                   ; 51
    outsb                                     ; 6e
    db  085h
    outsb                                     ; 6e
_int15_function32:                           ; 0xf6b79 LB 0x39e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00008h                ; 83 ec 08
    ...
    jmp near 06d5eh                           ; e9 55 01
    cmp dx, strict byte 00020h                ; 83 fa 20
    je short 06c19h                           ; 74 0b
    cmp dx, strict byte 00001h                ; 83 fa 01
    je short 06c16h                           ; 74 03
    jmp near 06d31h                           ; e9 1b 01
    jmp near 06ed7h                           ; e9 be 02
    cmp word [bp+01ah], 0534dh                ; 81 7e 1a 4d 53
    jne short 06c13h                          ; 75 f3
    cmp word [bp+018h], 04150h                ; 81 7e 18 50 41
    jne short 06c13h                          ; 75 ec
    mov ax, strict word 00035h                ; b8 35 00
    call 016aeh                               ; e8 81 aa
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    xor dx, dx                                ; 31 d2
    ...
    jc short 06c5ch                           ; 72 06
    jne short 06c8ah                          ; 75 32
    test bx, bx                               ; 85 db
    jnbe short 06c8ah                         ; 77 2e
    mov ax, strict word 00031h                ; b8 31 00
    ...
    call 016aeh                               ; e8 ed a9
    mov byte [bp-004h], al                    ; 88 46 fc
    mov byte [bp-006h], al                    ; 88 46 fa
    mov ax, word [bp+014h]                    ; 8b 46 14
    cmp ax, strict word 00009h                ; 3d 09 00
    jnbe short 06d31h                         ; 77 62
    mov si, ax                                ; 89 c6
    sal si, 1                                 ; d1 e6
    mov ax, bx                                ; 89 d8
    add ax, strict word 00000h                ; 05 00 00
    ...
    jmp word [cs:si+06b65h]                   ; 2e ff a4 65 6b
    mov ax, strict word 00001h                ; b8 01 00
    push ax                                   ; 50
    xor ax, ax                                ; 31 c0
    push ax                                   ; 50
    ...
    call 067aeh                               ; e8 a2 f9
    mov word [bp+014h], strict word 00007h    ; c7 46 14 07 00
    jmp near 06d04h                           ; e9 f0 fe
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    xor ax, ax                                ; 31 c0
    push ax                                   ; 50
    ...
    call 067aeh                               ; e8 82 f9
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06e39h                          ; 75 07
    mov ax, word [bp-008h]                    ; 8b 46 f8
    test ax, ax                               ; 85 c0
    je short 06e49h                           ; 74 10
    mov word [bp+014h], strict word 00009h    ; c7 46 14 09 00
    jmp near 06d04h                           ; e9 c3 fe
    mov word [bp+014h], strict word 00008h    ; c7 46 14 08 00
    jmp near 06d04h                           ; e9 bb fe
    mov word [bp+014h], ax                    ; 89 46 14
    mov word [bp+016h], ax                    ; 89 46 16
    jmp short 06ebch                          ; eb 6b
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    xor ax, ax                                ; 31 c0
    push ax                                   ; 50
    ...
    xor bx, bx                                ; 31 db
    xor cx, cx                                ; 31 c9
    call 067aeh                               ; e8 46 f9
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06e75h                          ; 75 07
    mov ax, word [bp-008h]                    ; 8b 46 f8
    test ax, ax                               ; 85 c0
    je short 06e7dh                           ; 74 08
    mov word [bp+014h], strict word 00009h    ; c7 46 14 09 00
    jmp near 06d04h                           ; e9 87 fe
    mov word [bp+014h], ax                    ; 89 46 14
    mov word [bp+016h], ax                    ; 89 46 16
    jmp short 06ebch                          ; eb 37
    cmp byte [bp-004h], 000h                  ; 80 7e fc 00
    jne short 06e91h                          ; 75 06
    cmp word [bp-008h], strict byte 00000h    ; 83 7e f8 00
    je short 06ebch                           ; 74 2b
    mov ax, strict word 00001h                ; b8 01 00
    push ax                                   ; 50
    mov al, byte [bp-006h]                    ; 8a 46 fa
    db  0feh, 0c0h
    ...
    jmp near 06d5eh                           ; e9 87 fe
    mov word [bp+028h], bx                    ; 89 5e 28
    mov ax, strict word 00031h                ; b8 31 00
    call 016aeh                               ; e8 ce a7
    mov dh, al                                ; 88 c6
    mov ax, strict word 00030h                ; b8 30 00
    call 016aeh                               ; e8 c6 a7
    mov dl, al                                ; 88 c2
    mov word [bp+01ch], dx                    ; 89 56 1c
    cmp dx, 03c00h                            ; 81 fa 00 3c
    jbe short 06ef8h                          ; 76 05
    mov word [bp+01ch], 03c00h                ; c7 46 1c 00 3c
    mov ax, strict word 00035h                ; b8 35 00
    call 016aeh                               ; e8 b0 a7
    mov dh, al                                ; 88 c6
    mov ax, strict word 00034h                ; b8 34 00
    call 016aeh                               ; e8 a8 a7
    mov dl, al                                ; 88 c2
    mov word [bp+018h], dx                    ; 89 56 18
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov word [bp+020h], ax                    ; 89 46 20
    mov word [bp+014h], dx                    ; 89 56 14
    jmp near 06d5eh                           ; e9 47 fe
_inv_op_handler:                             ; 0xf6f17 LB 0x18f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 06f2dh                          ; 75 06
    inc word [bp+018h]                        ; ff 46 18
    jmp near 0709fh                           ; e9 72 01
    cmp word [es:bx], 0050fh                  ; 26 81 3f 0f 05
    je short 06f37h                           ; 74 03
    jmp near 0709bh                           ; e9 64 01
    ...
    loop 06f88h                               ; e2 fa
    cmp bx, dx                                ; 39 d3
    jne short 06f96h                          ; 75 04
    cmp di, ax                                ; 39 c7
    je short 06f9bh                           ; 74 05
    ...
    loop 06fb1h                               ; e2 fa
    cmp bx, dx                                ; 39 d3
    jne short 06fbfh                          ; 75 04
    cmp di, ax                                ; 39 c7
    je short 06fc3h                           ; 74 04
    ...
    je near 07058h                            ; 0f 84 02 00
    mov es, ax                                ; 8e c0
    test cx, strict word 00002h               ; f7 c1 02 00
    je near 07080h                            ; 0f 84 20 00
    ...
    iret                                      ; cf
    jmp short 0709fh                          ; eb 04
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 0709ch                          ; eb fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
init_rtc_:                                   ; 0xf70a6 LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, strict word 0000ah                ; b8 0a 00
    call 016c9h                               ; e8 16 a6
    mov dx, strict word 00002h                ; ba 02 00
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c9h                               ; e8 0d a6
    mov ax, strict word 0000ch                ; b8 0c 00
    call 016aeh                               ; e8 ec a5
    mov ax, strict word 0000dh                ; b8 0d 00
    call 016aeh                               ; e8 e6 a5
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
rtc_updating_:                               ; 0xf70ce LB 0x21
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    mov dx, 061a8h                            ; ba a8 61
    dec dx                                    ; 4a
    je short 070e6h                           ; 74 0e
    mov ax, strict word 0000ah                ; b8 0a 00
    call 016aeh                               ; e8 d0 a5
    test AL, strict byte 080h                 ; a8 80
    jne short 070d5h                          ; 75 f3
    xor ax, ax                                ; 31 c0
    jmp short 070e9h                          ; eb 03
    mov ax, strict word 00001h                ; b8 01 00
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop dx                                    ; 5a
    pop bp                                    ; 5d
    retn                                      ; c3
_int70_function:                             ; 0xf70ef LB 0xbf
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016aeh                               ; e8 b4 a5
    mov bl, al                                ; 88 c3
    mov byte [bp-004h], al                    ; 88 46 fc
    mov ax, strict word 0000ch                ; b8 0c 00
    call 016aeh                               ; e8 a9 a5
    mov dl, al                                ; 88 c2
    test bl, 060h                             ; f6 c3 60
    jne short 0710fh                          ; 75 03
    jmp near 07195h                           ; e9 86 00
    test AL, strict byte 020h                 ; a8 20
    je short 07117h                           ; 74 04
    sti                                       ; fb
    int 04ah                                  ; cd 4a
    cli                                       ; fa
    test dl, 040h                             ; f6 c2 40
    je short 0717fh                           ; 74 63
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 2d a5
    test al, al                               ; 84 c0
    je short 07195h                           ; 74 6c
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0168ah                               ; e8 58 a5
    test dx, dx                               ; 85 d2
    jne short 07181h                          ; 75 4b
    cmp ax, 003d1h                            ; 3d d1 03
    jnc short 07181h                          ; 73 46
    mov dx, 00098h                            ; ba 98 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 2a a5
    mov si, ax                                ; 89 c6
    mov dx, 0009ah                            ; ba 9a 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 1f a5
    mov cx, ax                                ; 89 c1
    xor bx, bx                                ; 31 db
    mov dx, 000a0h                            ; ba a0 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 04 a5
    mov dl, byte [bp-004h]                    ; 8a 56 fc
    and dl, 037h                              ; 80 e2 37
    xor dh, dh                                ; 30 f6
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c9h                               ; e8 5f a5
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 01652h                               ; e8 e1 a4
    mov bl, al                                ; 88 c3
    or bl, 080h                               ; 80 cb 80
    xor bh, bh                                ; 30 ff
    mov dx, cx                                ; 89 ca
    mov ax, si                                ; 89 f0
    call 01660h                               ; e8 e1 a4
    jmp short 07195h                          ; eb 14
    mov bx, ax                                ; 89 c3
    ...
    mov dx, 0009ch                            ; ba 9c 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0169ch                               ; e8 07 a5
    call 0e030h                               ; e8 98 6e
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    les si, [bx+di-015h]                      ; c4 71 eb
    jno short 071b3h                          ; 71 10
    jc short 071f1h                           ; 72 4c
    jc short 07145h                           ; 72 9e
    jc short 0717eh                           ; 72 d5
    jc short 071c7h                           ; 72 1c
    jnc short 07224h                          ; 73 77
    db  073h
_int1a_function:                             ; 0xf71ae LB 0x1d9
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sti                                       ; fb
    mov al, byte [bp+013h]                    ; 8a 46 13
    cmp AL, strict byte 007h                  ; 3c 07
    jnbe short 07217h                         ; 77 5e
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    sal bx, 1                                 ; d1 e3
    jmp word [cs:bx+0719eh]                   ; 2e ff a7 9e 71
    cli                                       ; fa
    ...
    sti                                       ; fb
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    jmp short 07217h                          ; eb 07
    call 070ceh                               ; e8 bb fe
    test ax, ax                               ; 85 c0
    je short 0721ah                           ; 74 03
    jmp near 07248h                           ; e9 2e 00
    xor ax, ax                                ; 31 c0
    call 016aeh                               ; e8 8f a4
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00002h                ; b8 02 00
    call 016aeh                               ; e8 86 a4
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00004h                ; b8 04 00
    call 016aeh                               ; e8 7d a4
    mov dl, al                                ; 88 c2
    mov byte [bp+011h], al                    ; 88 46 11
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016aeh                               ; e8 72 a4
    and AL, strict byte 001h                  ; 24 01
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    call 070ceh                               ; e8 7f fe
    test ax, ax                               ; 85 c0
    je short 07256h                           ; 74 03
    call 070a6h                               ; e8 50 fe
    mov dl, byte [bp+00fh]                    ; 8a 56 0f
    xor dh, dh                                ; 30 f6
    xor ax, ax                                ; 31 c0
    call 016c9h                               ; e8 69 a4
    mov dl, byte [bp+010h]                    ; 8a 56 10
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00002h                ; b8 02 00
    call 016c9h                               ; e8 5e a4
    mov dl, byte [bp+011h]                    ; 8a 56 11
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00004h                ; b8 04 00
    call 016c9h                               ; e8 53 a4
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016aeh                               ; e8 32 a4
    mov bl, al                                ; 88 c3
    ...
    xor dh, dh                                ; 30 f6
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c9h                               ; e8 34 a4
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov byte [bp+012h], bl                    ; 88 5e 12
    jmp short 07248h                          ; eb aa
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    call 070ceh                               ; e8 29 fe
    test ax, ax                               ; 85 c0
    je short 072abh                           ; 74 02
    jmp short 07248h                          ; eb 9d
    mov ax, strict word 00009h                ; b8 09 00
    call 016aeh                               ; e8 fd a3
    mov byte [bp+010h], al                    ; 88 46 10
    mov ax, strict word 00008h                ; b8 08 00
    call 016aeh                               ; e8 f4 a3
    mov byte [bp+00fh], al                    ; 88 46 0f
    mov ax, strict word 00007h                ; b8 07 00
    call 016aeh                               ; e8 eb a3
    mov byte [bp+00eh], al                    ; 88 46 0e
    mov ax, strict word 00032h                ; b8 32 00
    call 016aeh                               ; e8 e2 a3
    mov byte [bp+011h], al                    ; 88 46 11
    mov byte [bp+012h], al                    ; 88 46 12
    jmp near 07248h                           ; e9 73 ff
    call 070ceh                               ; e8 f6 fd
    test ax, ax                               ; 85 c0
    je short 072e2h                           ; 74 06
    call 070a6h                               ; e8 c7 fd
    jmp near 07248h                           ; e9 66 ff
    mov dl, byte [bp+010h]                    ; 8a 56 10
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00009h                ; b8 09 00
    call 016c9h                               ; e8 dc a3
    mov dl, byte [bp+00fh]                    ; 8a 56 0f
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00008h                ; b8 08 00
    call 016c9h                               ; e8 d1 a3
    mov dl, byte [bp+00eh]                    ; 8a 56 0e
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00007h                ; b8 07 00
    call 016c9h                               ; e8 c6 a3
    mov dl, byte [bp+011h]                    ; 8a 56 11
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00032h                ; b8 32 00
    call 016c9h                               ; e8 bb a3
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016aeh                               ; e8 9a a3
    mov bl, al                                ; 88 c3
    and bl, 07fh                              ; 80 e3 7f
    jmp near 0728bh                           ; e9 6f ff
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016aeh                               ; e8 8c a3
    mov bl, al                                ; 88 c3
    mov word [bp+012h], strict word 00000h    ; c7 46 12 00 00
    test AL, strict byte 020h                 ; a8 20
    je short 07330h                           ; 74 03
    jmp near 07248h                           ; e9 18 ff
    call 070ceh                               ; e8 9b fd
    test ax, ax                               ; 85 c0
    je short 0733ah                           ; 74 03
    call 070a6h                               ; e8 6c fd
    mov dl, byte [bp+00fh]                    ; 8a 56 0f
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00001h                ; b8 01 00
    call 016c9h                               ; e8 84 a3
    mov dl, byte [bp+010h]                    ; 8a 56 10
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00003h                ; b8 03 00
    call 016c9h                               ; e8 79 a3
    mov dl, byte [bp+011h]                    ; 8a 56 11
    xor dh, dh                                ; 30 f6
    mov ax, strict word 00005h                ; b8 05 00
    call 016c9h                               ; e8 6e a3
    mov dx, 000a1h                            ; ba a1 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    xor dh, dh                                ; 30 f6
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016c9h                               ; e8 55 a3
    jmp near 07248h                           ; e9 d1 fe
    mov ax, strict word 0000bh                ; b8 0b 00
    call 016aeh                               ; e8 31 a3
    mov bl, al                                ; 88 c3
    mov dl, al                                ; 88 c2
    and dl, 057h                              ; 80 e2 57
    jmp near 0728dh                           ; e9 06 ff
send_to_mouse_ctrl_:                         ; 0xf7387 LB 0x38
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 002h                 ; a8 02
    je short 073aah                           ; 74 12
    mov ax, 008eeh                            ; b8 ee 08
    push ax                                   ; 50
    mov ax, 0116ch                            ; b8 6c 11
    push ax                                   ; 50
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 cf a5
    add sp, strict byte 00006h                ; 83 c4 06
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_mouse_data_:                             ; 0xf73bf LB 0x5d
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    je short 07402h                           ; 74 28
    test cx, cx                               ; 85 c9
    je short 07402h                           ; 74 24
    mov dx, strict word 00061h                ; ba 61 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    xor ah, ah                                ; 30 e4
    cmp dx, ax                                ; 39 c2
    je short 073e9h                           ; 74 ea
    dec cx                                    ; 49
    jmp short 073cch                          ; eb ca
    test cx, cx                               ; 85 c9
    jne short 0740ah                          ; 75 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 07415h                          ; eb 0b
    mov dx, strict word 00060h                ; ba 60 00
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
set_kbd_command_byte_:                       ; 0xf741c LB 0x36
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
_int74_function:                             ; 0xf7452 LB 0xd2
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    sub sp, strict byte 00008h                ; 83 ec 08
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 0d a2
    mov cx, ax                                ; 89 c1
    mov word [bp+004h], strict word 00000h    ; c7 46 04 00 00
    mov dx, strict word 00064h                ; ba 64 00
    in AL, DX                                 ; ec
    ...
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01652h                               ; e8 ce a1
    mov byte [bp-002h], al                    ; 88 46 fe
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01652h                               ; e8 c3 a1
    mov byte [bp-006h], al                    ; 88 46 fa
    test AL, strict byte 080h                 ; a8 80
    jne short 07499h                          ; 75 03
    jmp near 07510h                           ; e9 77 00
    mov al, byte [bp-006h]                    ; 8a 46 fa
    and AL, strict byte 007h                  ; 24 07
    mov byte [bp-004h], al                    ; 88 46 fc
    mov al, byte [bp-002h]                    ; 8a 46 fe
    ...
    je short 07503h                           ; 74 0a
    mov word [bp+004h], strict word 00001h    ; c7 46 04 01 00
    jmp short 07503h                          ; eb 03
    inc byte [bp-002h]                        ; fe 46 fe
    mov bl, byte [bp-002h]                    ; 8a 5e fe
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01660h                               ; e8 50 a1
    mov sp, bp                                ; 89 ec
    pop bp                                    ; 5d
    retn                                      ; c3
    db  066h, 075h, 0e2h
    ; jne short 074f9h                          ; 66 75 e2
    jne short 0757bh                          ; 75 62
    jbe short 07512h                          ; 76 f7
    jbe short 07586h                          ; 76 69
    jnbe short 074cch                         ; 77 ad
    jne short 074b2h                          ; 75 91
    jnbe short 07581h                         ; 77 5e
    db  078h
_int15_function_mouse:                       ; 0xf7524 LB 0x3a0
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    sub sp, strict byte 00006h                ; 83 ec 06
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 3a a1
    mov cx, ax                                ; 89 c1
    cmp byte [bp+012h], 007h                  ; 80 7e 12 07
    jbe short 07547h                          ; 76 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp near 078beh                           ; e9 77 03
    mov ax, strict word 00065h                ; b8 65 00
    call 0741ch                               ; e8 cf fe
    and word [bp+018h], strict byte 0fffeh    ; 83 66 18 fe
    mov byte [bp+013h], 000h                  ; c6 46 13 00
    mov bl, byte [bp+012h]                    ; 8a 5e 12
    cmp bl, 007h                              ; 80 fb 07
    jnbe short 075bbh                         ; 77 5e
    xor bh, bh                                ; 30 ff
    sal bx, 1                                 ; d1 e3
    jmp word [cs:bx+07514h]                   ; 2e ff a7 14 75
    cmp byte [bp+00dh], 001h                  ; 80 7e 0d 01
    jnbe short 075beh                         ; 77 52
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01652h                               ; e8 de a0
    test AL, strict byte 080h                 ; a8 80
    jne short 07583h                          ; 75 0b
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 005h                  ; c6 46 13 05
    jmp near 078b8h                           ; e9 35 03
    cmp byte [bp+00dh], 000h                  ; 80 7e 0d 00
    jne short 0758dh                          ; 75 04
    mov AL, strict byte 0f5h                  ; b0 f5
    jmp short 0758fh                          ; eb 02
    mov AL, strict byte 0f4h                  ; b0 f4
    xor ah, ah                                ; 30 e4
    call 07387h                               ; e8 f3 fd
    test al, al                               ; 84 c0
    jne short 075c1h                          ; 75 29
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073bfh                               ; e8 1f fe
    test al, al                               ; 84 c0
    je short 075aah                           ; 74 06
    cmp byte [bp-006h], 0fah                  ; 80 7e fa fa
    jne short 075c1h                          ; 75 17
    jmp near 078b8h                           ; e9 0b 03
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 075b8h                           ; 72 04
    cmp AL, strict byte 008h                  ; 3c 08
    jbe short 075c4h                          ; 76 0c
    jmp near 0775fh                           ; e9 a4 01
    jmp near 078a2h                           ; e9 e4 02
    jmp near 078b0h                           ; e9 ef 02
    jmp near 07836h                           ; e9 72 02
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01652h                               ; e8 86 a0
    ...
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01660h                               ; e8 7e a0
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01652h                               ; e8 68 a0
    mov bl, al                                ; 88 c3
    and bl, 0f8h                              ; 80 e3 f8
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00026h                ; ba 26 00
    mov ax, cx                                ; 89 c8
    call 01660h                               ; e8 67 a0
    mov ax, 000ffh                            ; b8 ff 00
    call 07387h                               ; e8 88 fd
    test al, al                               ; 84 c0
    jne short 075c1h                          ; 75 be
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073bfh                               ; e8 b4 fd
    mov cl, al                                ; 88 c1
    cmp byte [bp-008h], 0feh                  ; 80 7e f8 fe
    jne short 0761dh                          ; 75 0a
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 004h                  ; c6 46 13 04
    jmp short 075aah                          ; eb 8d
    cmp byte [bp-008h], 0fah                  ; 80 7e f8 fa
    je short 07637h                           ; 74 14
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 42 a3
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne short 075c1h                          ; 75 86
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073bfh                               ; e8 7c fd
    test al, al                               ; 84 c0
    jne short 0769dh                          ; 75 56
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 073bfh                               ; e8 70 fd
    test al, al                               ; 84 c0
    jne short 0769dh                          ; 75 4a
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-004h]                    ; 8a 46 fc
    mov byte [bp+00dh], al                    ; 88 46 0d
    jmp near 078b8h                           ; e9 56 02
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    cmp AL, strict byte 003h                  ; 3c 03
    jc short 07679h                           ; 72 10
    jbe short 07697h                          ; 76 2c
    cmp AL, strict byte 006h                  ; 3c 06
    je short 076ach                           ; 74 3d
    cmp AL, strict byte 005h                  ; 3c 05
    je short 076a6h                           ; 74 33
    cmp AL, strict byte 004h                  ; 3c 04
    je short 076a0h                           ; 74 29
    jmp short 076b2h                          ; eb 39
    cmp AL, strict byte 002h                  ; 3c 02
    je short 07691h                           ; 74 14
    cmp AL, strict byte 001h                  ; 3c 01
    je short 0768bh                           ; 74 0a
    test al, al                               ; 84 c0
    jne short 076b2h                          ; 75 2d
    mov byte [bp-006h], 00ah                  ; c6 46 fa 0a
    jmp short 076b6h                          ; eb 2b
    mov byte [bp-006h], 014h                  ; c6 46 fa 14
    jmp short 076b6h                          ; eb 25
    mov byte [bp-006h], 028h                  ; c6 46 fa 28
    jmp short 076b6h                          ; eb 1f
    mov byte [bp-006h], 03ch                  ; c6 46 fa 3c
    jmp short 076b6h                          ; eb 19
    jmp near 07836h                           ; e9 96 01
    mov byte [bp-006h], 050h                  ; c6 46 fa 50
    jmp short 076b6h                          ; eb 10
    mov byte [bp-006h], 064h                  ; c6 46 fa 64
    jmp short 076b6h                          ; eb 0a
    mov byte [bp-006h], 0c8h                  ; c6 46 fa c8
    jmp short 076b6h                          ; eb 04
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    cmp byte [bp-006h], 000h                  ; 80 7e fa 00
    jbe short 076ech                          ; 76 30
    mov ax, 000f3h                            ; b8 f3 00
    call 07387h                               ; e8 c5 fc
    test al, al                               ; 84 c0
    jne short 076e1h                          ; 75 1b
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 073bfh                               ; e8 f1 fc
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    call 07387h                               ; e8 b1 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 073bfh                               ; e8 e1 fc
    jmp near 078b8h                           ; e9 d7 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 078b8h                           ; e9 cc 01
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp near 078b8h                           ; e9 c1 01
    cmp byte [bp+00dh], 004h                  ; 80 7e 0d 04
    jnc short 0775fh                          ; 73 62
    mov ax, 000e8h                            ; b8 e8 00
    call 07387h                               ; e8 84 fc
    test al, al                               ; 84 c0
    jne short 07755h                          ; 75 4e
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073bfh                               ; e8 b0 fc
    cmp byte [bp-006h], 0fah                  ; 80 7e fa fa
    je short 07729h                           ; 74 14
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 50 a2
    add sp, strict byte 00006h                ; 83 c4 06
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    xor ah, ah                                ; 30 e4
    call 07387h                               ; e8 56 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073bfh                               ; e8 86 fc
    cmp byte [bp-006h], 0fah                  ; 80 7e fa fa
    je short 0778eh                           ; 74 4f
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, 0092eh                            ; b8 2e 09
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 26 a2
    add sp, strict byte 00006h                ; 83 c4 06
    jmp short 0778eh                          ; eb 39
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp short 0778eh                          ; eb 2f
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 002h                  ; c6 46 13 02
    jmp short 0778eh                          ; eb 25
    mov ax, 000f2h                            ; b8 f2 00
    call 07387h                               ; e8 18 fc
    test al, al                               ; 84 c0
    jne short 07786h                          ; 75 13
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073bfh                               ; e8 44 fc
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 073bfh                               ; e8 3c fc
    jmp near 07659h                           ; e9 d3 fe
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp near 078b8h                           ; e9 27 01
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    test al, al                               ; 84 c0
    jbe short 077a1h                          ; 76 09
    cmp AL, strict byte 002h                  ; 3c 02
    jbe short 0779fh                          ; 76 03
    jmp near 07840h                           ; e9 a1 00
    jmp short 0780bh                          ; eb 6a
    mov ax, 000e9h                            ; b8 e9 00
    call 07387h                               ; e8 e0 fb
    test al, al                               ; 84 c0
    jne short 07814h                          ; 75 69
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073bfh                               ; e8 0c fc
    mov cl, al                                ; 88 c1
    cmp byte [bp-006h], 0fah                  ; 80 7e fa fa
    je short 077cfh                           ; 74 14
    mov al, byte [bp-006h]                    ; 8a 46 fa
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    mov ax, 0092eh                            ; b8 2e 09
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 aa a1
    add sp, strict byte 00006h                ; 83 c4 06
    test cl, cl                               ; 84 c9
    jne short 07836h                          ; 75 63
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073bfh                               ; e8 e4 fb
    test al, al                               ; 84 c0
    jne short 07836h                          ; 75 57
    mov dx, ss                                ; 8c d2
    lea ax, [bp-004h]                         ; 8d 46 fc
    call 073bfh                               ; e8 d8 fb
    test al, al                               ; 84 c0
    jne short 07836h                          ; 75 4b
    mov dx, ss                                ; 8c d2
    lea ax, [bp-008h]                         ; 8d 46 f8
    call 073bfh                               ; e8 cc fb
    test al, al                               ; 84 c0
    jne short 07836h                          ; 75 3f
    mov al, byte [bp-006h]                    ; 8a 46 fa
    mov byte [bp+00ch], al                    ; 88 46 0c
    mov al, byte [bp-004h]                    ; 8a 46 fc
    mov byte [bp+010h], al                    ; 88 46 10
    mov al, byte [bp-008h]                    ; 8a 46 f8
    mov byte [bp+00eh], al                    ; 88 46 0e
    jmp short 0778eh                          ; eb 83
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 07816h                          ; 75 07
    mov ax, 000e6h                            ; b8 e6 00
    jmp short 07819h                          ; eb 05
    jmp short 07836h                          ; eb 20
    mov ax, 000e7h                            ; b8 e7 00
    call 07387h                               ; e8 6b fb
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    jne short 07832h                          ; 75 10
    mov dx, ss                                ; 8c d2
    lea ax, [bp-006h]                         ; 8d 46 fa
    call 073bfh                               ; e8 95 fb
    cmp byte [bp-006h], 0fah                  ; 80 7e fa fa
    je short 07832h                           ; 74 02
    mov CL, strict byte 001h                  ; b1 01
    test cl, cl                               ; 84 c9
    je short 078a0h                           ; 74 6a
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 003h                  ; c6 46 13 03
    jmp short 078a0h                          ; eb 60
    mov al, byte [bp+00dh]                    ; 8a 46 0d
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 25 a1
    add sp, strict byte 00006h                ; 83 c4 06
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    jmp short 078b8h                          ; eb 5a
    mov si, word [bp+00ch]                    ; 8b 76 0c
    mov bx, si                                ; 89 f3
    mov dx, strict word 00022h                ; ba 22 00
    mov ax, cx                                ; 89 c8
    call 0167ch                               ; e8 11 9e
    mov bx, word [bp+014h]                    ; 8b 5e 14
    mov dx, strict word 00024h                ; ba 24 00
    mov ax, cx                                ; 89 c8
    call 0167ch                               ; e8 06 9e
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01652h                               ; e8 d4 9d
    mov ah, al                                ; 88 c4
    test si, si                               ; 85 f6
    jne short 07892h                          ; 75 0e
    cmp word [bp+014h], strict byte 00000h    ; 83 7e 14 00
    jne short 07892h                          ; 75 08
    test AL, strict byte 080h                 ; a8 80
    je short 07894h                           ; 74 06
    and AL, strict byte 07fh                  ; 24 7f
    jmp short 07894h                          ; eb 02
    or AL, strict byte 080h                   ; 0c 80
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    mov dx, strict word 00027h                ; ba 27 00
    mov ax, cx                                ; 89 c8
    call 01660h                               ; e8 c0 9d
    jmp short 078b8h                          ; eb 16
    mov ax, 00974h                            ; b8 74 09
    push ax                                   ; 50
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 c9 a0
    add sp, strict byte 00004h                ; 83 c4 04
    or word [bp+018h], strict byte 00001h     ; 83 4e 18 01
    mov byte [bp+013h], 001h                  ; c6 46 13 01
    mov ax, strict word 00047h                ; b8 47 00
    call 0741ch                               ; e8 5e fb
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
_int17_function:                             ; 0xf78c4 LB 0xac
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push ax                                   ; 50
    ...
    add dx, strict byte 00008h                ; 83 c2 08
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 96 9d
    mov bx, ax                                ; 89 c3
    mov si, ax                                ; 89 c6
    cmp byte [bp+013h], 003h                  ; 80 7e 13 03
    jnc short 078eeh                          ; 73 0c
    mov ax, word [bp+00eh]                    ; 8b 46 0e
    cmp ax, strict word 00003h                ; 3d 03 00
    jnc short 078eeh                          ; 73 04
    test bx, bx                               ; 85 db
    jnbe short 078f1h                         ; 77 03
    jmp near 07966h                           ; e9 75 00
    mov dx, ax                                ; 89 c2
    add dx, strict byte 00078h                ; 83 c2 78
    mov ax, strict word 00040h                ; b8 40 00
    call 01652h                               ; e8 56 9d
    mov ch, al                                ; 88 c5
    xor cl, cl                                ; 30 c9
    cmp byte [bp+013h], 000h                  ; 80 7e 13 00
    jne short 07932h                          ; 75 2c
    mov al, byte [bp+012h]                    ; 8a 46 12
    mov dx, bx                                ; 89 da
    out DX, AL                                ; ee
    lea dx, [bx+002h]                         ; 8d 57 02
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 040h                 ; a8 40
    je short 07932h                           ; 74 07
    test cx, cx                               ; 85 c9
    je short 07932h                           ; 74 03
    dec cx                                    ; 49
    jmp short 07921h                          ; eb ef
    cmp byte [bp+013h], 001h                  ; 80 7e 13 01
    jne short 0794dh                          ; 75 15
    ...
    mov byte [bp+013h], al                    ; 88 46 13
    test cx, cx                               ; 85 c9
    jne short 07960h                          ; 75 04
    or byte [bp+013h], 001h                   ; 80 4e 13 01
    and byte [bp+01ch], 0feh                  ; 80 66 1c fe
    jmp short 0796ah                          ; eb 04
    or byte [bp+01ch], 001h                   ; 80 4e 1c 01
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
wait_:                                       ; 0xf7970 LB 0xb2
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0168ah                               ; e8 f7 9c
    mov word [bp-00eh], ax                    ; 89 46 f2
    mov bx, dx                                ; 89 d3
    hlt                                       ; f4
    mov dx, 0046ch                            ; ba 6c 04
    xor ax, ax                                ; 31 c0
    call 0168ah                               ; e8 e9 9c
    mov word [bp-012h], ax                    ; 89 46 ee
    mov di, dx                                ; 89 d7
    cmp dx, bx                                ; 39 da
    jnbe short 079b1h                         ; 77 07
    jne short 079b8h                          ; 75 0c
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jbe short 079b8h                          ; 76 07
    sub ax, word [bp-00eh]                    ; 2b 46 f2
    sbb dx, bx                                ; 19 da
    jmp short 079c3h                          ; eb 0b
    cmp dx, bx                                ; 39 da
    jc short 079c3h                           ; 72 07
    jne short 079c7h                          ; 75 09
    cmp ax, word [bp-00eh]                    ; 3b 46 f2
    jnc short 079c7h                          ; 73 04
    sub si, ax                                ; 29 c6
    sbb cx, dx                                ; 19 d1
    mov ax, word [bp-012h]                    ; 8b 46 ee
    mov word [bp-00eh], ax                    ; 89 46 f2
    ...
    int 016h                                  ; cd 16
    je short 079dbh                           ; 74 05
    mov AL, strict byte 001h                  ; b0 01
    jmp near 079ddh                           ; e9 02 00
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    test al, al                               ; 84 c0
    je short 07a07h                           ; 74 26
    db  033h, 0c0h
    ; xor ax, ax                                ; 33 c0
    int 016h                                  ; cd 16
    xchg ah, al                               ; 86 c4
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 7c 9f
    add sp, strict byte 00006h                ; 83 c4 06
    cmp byte [bp-00ah], 000h                  ; 80 7e f6 00
    je short 07a07h                           ; 74 04
    mov al, dl                                ; 88 d0
    jmp short 07a19h                          ; eb 12
    test cx, cx                               ; 85 c9
    jnle short 07998h                         ; 7f 8d
    jne short 07a11h                          ; 75 04
    test si, si                               ; 85 f6
    jnbe short 07998h                         ; 77 87
    mov ax, word [bp-010h]                    ; 8b 46 f0
    push ax                                   ; 50
    popfw                                     ; 9d
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_byte_:                             ; 0xf7a22 LB 0x16
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
read_logo_word_:                             ; 0xf7a38 LB 0x14
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push dx                                   ; 52
    xor ah, ah                                ; 30 e4
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
print_detected_harddisks_:                   ; 0xf7a4c LB 0x15a
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 0f 9c
    mov si, ax                                ; 89 c6
    mov byte [bp-00eh], 000h                  ; c6 46 f2 00
    xor ch, ch                                ; 30 ed
    mov byte [bp-00ch], ch                    ; 88 6e f4
    mov dx, 00304h                            ; ba 04 03
    call 01652h                               ; e8 e2 9b
    mov byte [bp-00ah], al                    ; 88 46 f6
    xor cl, cl                                ; 30 c9
    cmp cl, byte [bp-00ah]                    ; 3a 4e f6
    jnc short 07ad8h                          ; 73 5e
    mov al, cl                                ; 88 c8
    xor ah, ah                                ; 30 e4
    mov dx, ax                                ; 89 c2
    add dx, 00305h                            ; 81 c2 05 03
    mov ax, si                                ; 89 f0
    call 01652h                               ; e8 c9 9b
    mov bl, al                                ; 88 c3
    cmp AL, strict byte 00ch                  ; 3c 0c
    jc short 07abah                           ; 72 2b
    test ch, ch                               ; 84 ed
    jne short 07aa3h                          ; 75 10
    mov ax, 009a7h                            ; b8 a7 09
    push ax                                   ; 50
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 d8 9e
    add sp, strict byte 00004h                ; 83 c4 04
    ...
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 c2 9e
    add sp, strict byte 00006h                ; 83 c4 06
    jmp near 07b6ch                           ; e9 b2 00
    cmp AL, strict byte 008h                  ; 3c 08
    jc short 07adbh                           ; 72 1d
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07ad6h                          ; 75 12
    mov ax, 009cfh                            ; b8 cf 09
    push ax                                   ; 50
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 a7 9e
    add sp, strict byte 00004h                ; 83 c4 04
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    jmp short 07aa3h                          ; eb cb
    jmp near 07b71h                           ; e9 96 00
    cmp AL, strict byte 004h                  ; 3c 04
    jnc short 07af9h                          ; 73 1a
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    jne short 07af9h                          ; 75 14
    ...
    jmp short 07b12h                          ; eb 19
    cmp bl, 004h                              ; 80 fb 04
    jc short 07b12h                           ; 72 14
    test ch, ch                               ; 84 ed
    jne short 07b12h                          ; 75 10
    ...
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 53 9e
    add sp, strict byte 00006h                ; 83 c4 06
    cmp bl, 004h                              ; 80 fb 04
    jc short 07b2eh                           ; 72 03
    ...
    sar ax, 1                                 ; d1 f8
    test ax, ax                               ; 85 c0
    je short 07b40h                           ; 74 05
    mov ax, 00a14h                            ; b8 14 0a
    jmp short 07b43h                          ; eb 03
    mov ax, 00a1fh                            ; b8 1f 0a
    push ax                                   ; 50
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 2b 9e
    add sp, strict byte 00004h                ; 83 c4 04
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00002h                ; bb 02 00
    ...
    idiv bx                                   ; f7 fb
    test dx, dx                               ; 85 d2
    je short 07b61h                           ; 74 05
    mov ax, 00a28h                            ; b8 28 0a
    jmp short 07b64h                          ; eb 03
    mov ax, 00a2eh                            ; b8 2e 0a
    push ax                                   ; 50
    push bx                                   ; 53
    call 01976h                               ; e8 0d 9e
    add sp, strict byte 00004h                ; 83 c4 04
    db  0feh, 0c1h
    ; inc cl                                    ; fe c1
    jmp near 07a75h                           ; e9 04 ff
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    jne short 07b8fh                          ; 75 18
    test ch, ch                               ; 84 ed
    jne short 07b8fh                          ; 75 14
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07b8fh                          ; 75 0e
    mov ax, 00a35h                            ; b8 35 0a
    push ax                                   ; 50
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 ea 9d
    add sp, strict byte 00004h                ; 83 c4 04
    mov ax, 00a49h                            ; b8 49 0a
    push ax                                   ; 50
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 dc 9d
    add sp, strict byte 00004h                ; 83 c4 04
    lea sp, [bp-008h]                         ; 8d 66 f8
    pop si                                    ; 5e
    pop dx                                    ; 5a
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
get_boot_drive_:                             ; 0xf7ba6 LB 0x28
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push dx                                   ; 52
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 b8 9a
    mov dx, 00304h                            ; ba 04 03
    call 01652h                               ; e8 96 9a
    sub bl, 002h                              ; 80 eb 02
    cmp bl, al                                ; 38 c3
    jc short 07bc5h                           ; 72 02
...
show_logo_:                                  ; 0xf7bce LB 0x24f
    ...
    mov al, cl                                ; 88 c8
    xor ah, ah                                ; 30 e4
    call 07a38h                               ; e8 3b fe
    cmp ax, 066bbh                            ; 3d bb 66
    jne short 07c14h                          ; 75 12
    push SS                                   ; 16
    pop ES                                    ; 07
    ...
    je short 07c17h                           ; 74 03
    jmp near 07cech                           ; e9 d5 00
    mov al, cl                                ; 88 c8
    add AL, strict byte 004h                  ; 04 04
    xor ah, ah                                ; 30 e4
    call 07a22h                               ; e8 02 fe
    mov bl, al                                ; 88 c3
    mov byte [bp-014h], al                    ; 88 46 ec
    mov al, cl                                ; 88 c8
    add AL, strict byte 005h                  ; 04 05
    xor ah, ah                                ; 30 e4
    call 07a22h                               ; e8 f4 fd
    mov bh, al                                ; 88 c7
    mov byte [bp-012h], al                    ; 88 46 ee
    mov al, cl                                ; 88 c8
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 07a38h                               ; e8 fc fd
    mov dx, ax                                ; 89 c2
    mov word [bp-016h], ax                    ; 89 46 ea
    mov al, cl                                ; 88 c8
    add AL, strict byte 006h                  ; 04 06
    xor ah, ah                                ; 30 e4
    call 07a22h                               ; e8 d8 fd
    mov byte [bp-010h], al                    ; 88 46 f0
    test bl, bl                               ; 84 db
    jne short 07c59h                          ; 75 08
    test bh, bh                               ; 84 ff
    jne short 07c59h                          ; 75 04
    test dx, dx                               ; 85 d2
    je short 07c14h                           ; 74 bb
    mov bx, 00142h                            ; bb 42 01
    mov ax, 04f02h                            ; b8 02 4f
    int 010h                                  ; cd 10
    cmp byte [bp-014h], 000h                  ; 80 7e ec 00
    je short 07c8ch                           ; 74 25
    xor cx, cx                                ; 31 c9
    jmp short 07c71h                          ; eb 06
    inc cx                                    ; 41
    cmp cx, strict byte 00010h                ; 83 f9 10
    jnbe short 07c93h                         ; 77 22
    mov ax, cx                                ; 89 c8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 07970h                               ; e8 ee fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07c6bh                          ; 75 e5
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    jmp short 07c93h                          ; eb 07
    mov ax, 00210h                            ; b8 10 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07caeh                          ; 75 15
    mov CL, strict byte 004h                  ; b1 04
    mov ax, word [bp-016h]                    ; 8b 46 ea
    shr ax, CL                                ; d3 e8
    mov dx, strict word 00001h                ; ba 01 00
    call 07970h                               ; e8 ca fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07caeh                          ; 75 04
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    cmp byte [bp-012h], 000h                  ; 80 7e ee 00
    je short 07cdfh                           ; 74 2b
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07cdfh                          ; 75 25
    mov cx, strict word 00010h                ; b9 10 00
    jmp short 07cc4h                          ; eb 05
    dec cx                                    ; 49
    test cx, cx                               ; 85 c9
    jbe short 07cech                          ; 76 28
    mov ax, cx                                ; 89 c8
    or ah, 002h                               ; 80 cc 02
    mov dx, 003b8h                            ; ba b8 03
    out DX, ax                                ; ef
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00001h                ; b8 01 00
    call 07970h                               ; e8 9b fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07cbfh                          ; 75 e6
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    jmp short 07cech                          ; eb 0d
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07cech                          ; 75 07
    ...
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 01660h                               ; e8 6a 99
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    cmp byte [bp-010h], 000h                  ; 80 7e f0 00
    je short 07d16h                           ; 74 14
    cmp byte [bp-014h], 000h                  ; 80 7e ec 00
    jne short 07d44h                          ; 75 3c
    cmp byte [bp-012h], 000h                  ; 80 7e ee 00
    jne short 07d44h                          ; 75 36
    cmp word [bp-016h], strict byte 00000h    ; 83 7e ea 00
    je short 07d19h                           ; 74 05
    jmp short 07d44h                          ; eb 2e
    jmp near 07e00h                           ; e9 e7 00
    cmp byte [bp-010h], 002h                  ; 80 7e f0 02
    jne short 07d2dh                          ; 75 0e
    mov ax, 00a4bh                            ; b8 4b 0a
    push ax                                   ; 50
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 4c 9c
    add sp, strict byte 00004h                ; 83 c4 04
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    jne short 07d44h                          ; 75 11
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, 000c0h                            ; b8 c0 00
    call 07970h                               ; e8 34 fc
    cmp AL, strict byte 086h                  ; 3c 86
    jne short 07d44h                          ; 75 04
    mov byte [bp-00ch], 001h                  ; c6 46 f4 01
    cmp byte [bp-00ch], 000h                  ; 80 7e f4 00
    je short 07d16h                           ; 74 cc
    mov byte [bp-00eh], 000h                  ; c6 46 f2 00
    mov ax, 00100h                            ; b8 00 01
    ...
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 00 9c
    add sp, strict byte 00004h                ; 83 c4 04
    call 07a4ch                               ; e8 d0 fc
    mov ax, 00ab1h                            ; b8 b1 0a
    push ax                                   ; 50
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 ef 9b
    add sp, strict byte 00004h                ; 83 c4 04
    mov dx, strict word 00001h                ; ba 01 00
    mov ax, strict word 00040h                ; b8 40 00
    call 07970h                               ; e8 dd fb
    mov cl, al                                ; 88 c1
    test al, al                               ; 84 c0
    je short 07d8ah                           ; 74 f1
    cmp AL, strict byte 030h                  ; 3c 30
    je short 07dedh                           ; 74 50
    cmp cl, 002h                              ; 80 f9 02
    jc short 07dc6h                           ; 72 24
    cmp cl, 009h                              ; 80 f9 09
    jnbe short 07dc6h                         ; 77 1f
    mov al, cl                                ; 88 c8
    xor ah, ah                                ; 30 e4
    call 07ba6h                               ; e8 f8 fd
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 07db4h                          ; 75 02
    jmp short 07d8ah                          ; eb d6
    mov bl, al                                ; 88 c3
    xor bh, bh                                ; 30 ff
    mov dx, 0037ch                            ; ba 7c 03
    mov ax, si                                ; 89 f0
    call 01660h                               ; e8 a0 98
    mov byte [bp-00eh], 002h                  ; c6 46 f2 02
    jmp short 07dedh                          ; eb 27
    cmp cl, 02eh                              ; 80 f9 2e
    je short 07ddbh                           ; 74 10
    cmp cl, 026h                              ; 80 f9 26
    je short 07de1h                           ; 74 11
    cmp cl, 021h                              ; 80 f9 21
    jne short 07de7h                          ; 75 12
    mov byte [bp-00eh], 001h                  ; c6 46 f2 01
    jmp short 07dedh                          ; eb 12
    mov byte [bp-00eh], 003h                  ; c6 46 f2 03
    jmp short 07dedh                          ; eb 0c
    mov byte [bp-00eh], 004h                  ; c6 46 f2 04
    jmp short 07dedh                          ; eb 06
    cmp byte [bp-00eh], 000h                  ; 80 7e f2 00
    je short 07d8ah                           ; 74 9d
    mov bl, byte [bp-00eh]                    ; 8a 5e f2
    xor bh, bh                                ; 30 ff
    mov dx, 0037dh                            ; ba 7d 03
    mov ax, si                                ; 89 f0
    call 01660h                               ; e8 66 98
    mov AL, strict byte 003h                  ; b0 03
    mov AH, strict byte 000h                  ; b4 00
    int 010h                                  ; cd 10
    mov AL, strict byte 034h                  ; b0 34
...
delay_boot_:                                 ; 0xf7e1d LB 0x72
    ...
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 33 9b
    add sp, strict byte 00006h                ; 83 c4 06
    test bx, bx                               ; 85 db
    jbe short 07e64h                          ; 76 1a
    push bx                                   ; 53
    mov ax, 00b19h                            ; b8 19 0b
    push ax                                   ; 50
    mov ax, strict word 00002h                ; b8 02 00
    push ax                                   ; 50
    call 01976h                               ; e8 20 9b
    add sp, strict byte 00006h                ; 83 c4 06
    xor dx, dx                                ; 31 d2
    mov ax, strict word 00040h                ; b8 40 00
    call 07970h                               ; e8 0f fb
    dec bx                                    ; 4b
    jmp short 07e46h                          ; eb e2
    mov bx, 00a49h                            ; bb 49 0a
    push bx                                   ; 53
    mov bx, strict word 00002h                ; bb 02 00
    push bx                                   ; 53
    call 01976h                               ; e8 07 9b
    add sp, strict byte 00004h                ; 83 c4 04
    mov AL, strict byte 034h                  ; b0 34
    out strict byte 043h, AL                  ; e6 43
    db  033h, 0c0h
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
scsi_cmd_data_in_:                           ; 0xf7e8f LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07ea5h                          ; 75 f7
    mov al, byte [bp+004h]                    ; 8a 46 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne short 07eb9h                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 07ebbh                          ; eb 02
    xor ah, ah                                ; 30 e4
    mov di, ax                                ; 89 c7
    mov ax, bx                                ; 89 d8
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07ef5h                          ; eb e9
    mov dx, si                                ; 89 f2
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07f0ch                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 07f27h                           ; 74 0e
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
scsi_cmd_data_out_:                          ; 0xf7f64 LB 0xd5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 07f7ah                          ; 75 f7
    mov al, byte [bp+004h]                    ; 8a 46 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne short 07f8eh                          ; 75 04
    xor ax, ax                                ; 31 c0
    jmp short 07f90h                          ; eb 02
    xor ah, ah                                ; 30 e4
    mov si, ax                                ; 89 c6
    mov ax, bx                                ; 89 d8
    mov dx, word [bp+00ch]                    ; 8b 56 0c
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 07fcah                          ; eb e9
    lea dx, [di+001h]                         ; 8d 55 01
    cmp word [bp+00ch], strict byte 00000h    ; 83 7e 0c 00
    jne short 07ff0h                          ; 75 06
    cmp bx, 08000h                            ; 81 fb 00 80
    jbe short 0800bh                          ; 76 1b
    mov cx, 08000h                            ; b9 00 80
    ...
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 08013h                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 0802eh                           ; 74 0e
    ...
    pop bp                                    ; 5d
    retn 0000ah                               ; c2 0a 00
@scsi_read_sectors:                          ; 0xf8039 LB 0xe9
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 07e8fh                               ; e8 95 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 08115h                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
@scsi_write_sectors:                         ; 0xf8122 LB 0xe9
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov cx, ss                                ; 8c d1
    lea bx, [bp-01ah]                         ; 8d 5e e6
    call 07f64h                               ; e8 81 fd
    mov ah, al                                ; 88 c4
    test al, al                               ; 84 c0
    jne short 081feh                          ; 75 15
    mov es, [bp+006h]                         ; 8e 46 06
    mov word [es:si+018h], di                 ; 26 89 7c 18
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    mov word [es:si+01ah], dx                 ; 26 89 54 1a
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
scsi_cmd_packet_:                            ; 0xf820b LB 0x170
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 29 97
    add sp, strict byte 00006h                ; 83 c4 06
    mov dx, strict word 00001h                ; ba 01 00
    jmp near 08370h                           ; e9 1a 01
    ...
    out DX, AL                                ; ee
    inc cx                                    ; 41
    jmp short 082d1h                          ; eb e6
    mov dx, bx                                ; 89 da
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    test AL, strict byte 001h                 ; a8 01
    jne short 082ebh                          ; 75 f7
    test AL, strict byte 002h                 ; a8 02
    je short 08306h                           ; 74 0e
    lea dx, [bx+003h]                         ; 8d 57 03
    xor al, al                                ; 30 c0
    out DX, AL                                ; ee
    in AL, DX                                 ; ec
    ...
    ; sub ah, ah                                ; 2a e4
    mov dx, strict word 00003h                ; ba 03 00
    jmp short 08370h                          ; eb 6a
    mov ax, word [bp+004h]                    ; 8b 46 04
    test ax, ax                               ; 85 c0
    je short 08315h                           ; 74 08
    lea dx, [bx+001h]                         ; 8d 57 01
    mov cx, ax                                ; 89 c1
    in AL, DX                                 ; ec
    loop 08312h                               ; e2 fd
    ...
    cmp word [bp+008h], strict byte 00000h    ; 83 7e 08 00
    jne short 08336h                          ; 75 07
    cmp word [bp+006h], 08000h                ; 81 7e 06 00 80
    jbe short 08353h                          ; 76 1d
    mov dx, ax                                ; 89 c2
    mov cx, 08000h                            ; b9 00 80
    les di, [bp+00ch]                         ; c4 7e 0c
    rep insb                                  ; f3 6c
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
scsi_enumerate_attached_devices_:            ; 0xf837b LB 0x4cb
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 dd 92
    mov di, 00122h                            ; bf 22 01
    mov word [bp-016h], ax                    ; 89 46 ea
    mov word [bp-014h], strict word 00000h    ; c7 46 ec 00 00
    jmp near 087b9h                           ; e9 1a 04
    cmp AL, strict byte 004h                  ; 3c 04
    jc short 083a6h                           ; 72 03
    jmp near 0883ch                           ; e9 96 04
    mov cx, strict word 00010h                ; b9 10 00
    xor bx, bx                                ; 31 db
    mov dx, ss                                ; 8c d2
    lea ax, [bp-048h]                         ; 8d 46 b8
    call 0a1a0h                               ; e8 ed 1d
    ...
    call 07e8fh                               ; e8 ae fa
    test al, al                               ; 84 c0
    je short 083f7h                           ; 74 12
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 f5 94
    add sp, strict byte 0000ah                ; 83 c4 0a
    jmp near 087adh                           ; e9 26 03
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 0849ah                           ; 72 0c
    jbe short 084a2h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 084aah                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 084a6h                           ; 74 0e
    jmp short 084f1h                          ; eb 57
    test al, al                               ; 84 c0
    jne short 084f1h                          ; 75 53
    mov BL, strict byte 090h                  ; b3 90
    jmp short 084ach                          ; eb 0a
    mov BL, strict byte 098h                  ; b3 98
    jmp short 084ach                          ; eb 06
    mov BL, strict byte 0a0h                  ; b3 a0
    jmp short 084ach                          ; eb 02
    mov BL, strict byte 0a8h                  ; b3 a8
    mov cl, bl                                ; 88 d9
    add cl, 007h                              ; 80 c1 07
    xor ch, ch                                ; 30 ed
    mov ax, cx                                ; 89 c8
    call 016aeh                               ; e8 f6 91
    test al, al                               ; 84 c0
    je short 084f1h                           ; 74 35
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 016aeh                               ; e8 e9 91
    mov dh, al                                ; 88 c6
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 016aeh                               ; e8 e0 91
    mov ah, dh                                ; 88 f4
    cwd                                       ; 99
    mov si, ax                                ; 89 c6
    mov word [bp-026h], dx                    ; 89 56 da
    ...
    add AL, strict byte 002h                  ; 04 02
    xor ah, ah                                ; 30 e4
    call 016aeh                               ; e8 cf 91
    xor ah, ah                                ; 30 e4
    mov word [bp-028h], ax                    ; 89 46 d8
    mov ax, cx                                ; 89 c8
    call 016aeh                               ; e8 c5 91
    xor ah, ah                                ; 30 e4
    mov word [bp-01ah], ax                    ; 89 46 e6
    jmp near 085deh                           ; e9 ed 00
    mov ax, word [bp-020h]                    ; 8b 46 e0
    mov bx, word [bp-022h]                    ; 8b 5e de
    mov cx, word [bp-012h]                    ; 8b 4e ee
    mov dx, word [bp-024h]                    ; 8b 56 dc
    mov si, strict word 0000ch                ; be 0c 00
    call 0a180h                               ; e8 7d 1c
    ...
    mov si, strict word 00010h                ; be 10 00
    call 0a180h                               ; e8 f1 1b
    mov si, word [bp-032h]                    ; 8b 76 ce
    add si, dx                                ; 01 d6
    adc cx, word [bp-030h]                    ; 13 4e d0
    mov ax, word [bp-02eh]                    ; 8b 46 d2
    adc ax, bx                                ; 11 d8
    jmp short 085dbh                          ; eb 3d
    test ax, ax                               ; 85 c0
    jnbe short 085b4h                         ; 77 12
    jne short 085c0h                          ; 75 1c
    cmp word [bp-022h], strict byte 00000h    ; 83 7e de 00
    jnbe short 085b4h                         ; 77 0a
    jne short 085c0h                          ; 75 14
    cmp word [bp-012h], strict byte 00020h    ; 83 7e ee 20
    jnbe short 085b4h                         ; 77 02
    jne short 085c0h                          ; 75 0c
    mov word [bp-028h], 00080h                ; c7 46 d8 80 00
    mov word [bp-01ah], strict word 00020h    ; c7 46 e6 20 00
    jmp short 085d9h                          ; eb 19
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 5b 8f
    inc byte [bp-00ch]                        ; fe 46 f4
    jmp near 087a2h                           ; e9 97 00
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 1d 92
    push word [bp-014h]                       ; ff 76 ec
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    push ax                                   ; 50
    ...
    mov ax, strict word 00004h                ; b8 04 00
    push ax                                   ; 50
    call 01976h                               ; e8 4c 92
    add sp, strict byte 00008h                ; 83 c4 08
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    add AL, strict byte 008h                  ; 04 08
    mov byte [bp-00eh], al                    ; 88 46 f2
    test byte [bp-00247h], 080h               ; f6 86 b9 fd 80
    je short 08741h                           ; 74 05
    mov cx, strict word 00001h                ; b9 01 00
    jmp short 08743h                          ; eb 02
    xor cx, cx                                ; 31 c9
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    xor ah, ah                                ; 30 e4
    sal ax, 1                                 ; d1 e0
    ...
    jl short 087b9h                           ; 7c 03
    jmp near 0883ch                           ; e9 83 00
    ...
    lea bx, [bp-048h]                         ; 8d 5e b8
    mov ax, word [bp-0024ah]                  ; 8b 86 b6 fd
    call 07e8fh                               ; e8 9e f6
    test al, al                               ; 84 c0
    je short 08807h                           ; 74 12
    mov ax, 00b92h                            ; b8 92 0b
    push ax                                   ; 50
    ...
    mov ax, strict word 00007h                ; b8 07 00
    push ax                                   ; 50
    call 01976h                               ; e8 72 91
    add sp, strict byte 00006h                ; 83 c4 06
    mov es, [bp-016h]                         ; 8e 46 ea
    mov al, byte [es:di+0022ch]               ; 26 8a 85 2c 02
    mov byte [bp-00ch], al                    ; 88 46 f4
    test byte [bp-00248h], 0e0h               ; f6 86 b8 fd e0
    jne short 08823h                          ; 75 0a
    test byte [bp-00248h], 01fh               ; f6 86 b8 fd 1f
    jne short 08823h                          ; 75 03
    jmp near 0839fh                           ; e9 7c fb
    test byte [bp-00248h], 0e0h               ; f6 86 b8 fd e0
    je short 0882dh                           ; 74 03
    jmp near 087a2h                           ; e9 75 ff
    mov al, byte [bp-00248h]                  ; 8a 86 b8 fd
    and AL, strict byte 01fh                  ; 24 1f
    cmp AL, strict byte 005h                  ; 3c 05
    jne short 0883ah                          ; 75 03
    jmp near 0870bh                           ; e9 d1 fe
    jmp short 0882ah                          ; eb ee
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop dx                                    ; 5a
...
ahci_port_init_:                             ; 0xf8e6a LB 0x250
    ...
    mov ax, si                                ; 89 f0
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a1a0h                               ; e8 9c 12
    lea ax, [si+00080h]                       ; 8d 84 80 00
    mov cx, strict word 00040h                ; b9 40 00
    xor bx, bx                                ; 31 db
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a1a0h                               ; e8 8d 12
    lea di, [si+00200h]                       ; 8d bc 00 02
    mov cx, strict word 00060h                ; b9 60 00
    xor bx, bx                                ; 31 db
    mov ax, di                                ; 89 f8
    mov dx, word [bp-00ah]                    ; 8b 56 f6
    call 0a1a0h                               ; e8 7c 12
    mov bl, byte [bp-008h]                    ; 8a 5e f8
    xor bh, bh                                ; 30 ff
    mov CL, strict byte 007h                  ; b1 07
    sal bx, CL                                ; d3 e3
...
ahci_cmd_packet_:                            ; 0xf91ec LB 0x18c
    ...
    pop bp                                    ; 5d
    retn 0000ch                               ; c2 0c 00
wait_ticks_device_init_:                     ; 0xf9378 LB 0x5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_port_detect_device_:                    ; 0xf937d LB 0x4f6
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push si                                   ; 56
    ...
    mov ax, si                                ; 89 f0
    call 08e6ah                               ; e8 c4 fa
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, strict word 00040h                ; b8 40 00
    call 0166eh                               ; e8 bf 82
    ...
    jc short 0945ah                           ; 72 11
    mov ax, word [es:di+002h]                 ; 26 8b 45 02
    cmp ax, word [bp-028h]                    ; 3b 46 d8
    jne short 094a8h                          ; 75 56
    mov ax, word [es:di]                      ; 26 8b 05
    cmp ax, word [bp-01ch]                    ; 3b 46 e4
    jnc short 094a8h                          ; 73 4e
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    mov CL, strict byte 007h                  ; b1 07
    sal ax, CL                                ; d3 e0
    ...
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    call 088f2h                               ; e8 51 f4
    cmp ax, strict word 00003h                ; 3d 03 00
    jne short 0943dh                          ; 75 97
    jmp short 094b1h                          ; eb 09
    cmp word [bp-01eh], strict byte 00000h    ; 83 7e e2 00
    jne short 094b1h                          ; 75 03
    jmp near 0986bh                           ; e9 ba 03
    xor ax, ax                                ; 31 c0
    push ax                                   ; 50
    mov bx, strict word 0000fh                ; bb 0f 00
    xor cx, cx                                ; 31 c9
    ...
    call 088f2h                               ; e8 30 f4
    cmp ax, strict word 00003h                ; 3d 03 00
    jne short 094aeh                          ; 75 e7
    mov al, byte [bp-008h]                    ; 8a 46 f8
    xor ah, ah                                ; 30 e4
    mov CL, strict byte 007h                  ; b1 07
    mov di, ax                                ; 89 c7
    ...
    test dx, dx                               ; 85 d2
    jne short 095d9h                          ; 75 54
    cmp ax, 00101h                            ; 3d 01 01
    jne short 095d9h                          ; 75 4f
    les bx, [bp-026h]                         ; c4 5e da
    mov word [es:bx+006h], strict word 00000h ; 26 c7 47 06 00 00
    ...
    mov ax, word [bp-026h]                    ; 8b 46 da
    mov dx, es                                ; 8c c2
    call 08a85h                               ; e8 be f4
    mov al, byte [bp-00eh]                    ; 8a 46 f2
    mov byte [bp-00ah], al                    ; 88 46 f6
    test byte [bp-00232h], 080h               ; f6 86 ce fd 80
    je short 095dch                           ; 74 08
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 095deh                          ; eb 05
    jmp near 097aah                           ; e9 ce 01
    xor ax, ax                                ; 31 c0
    mov cl, al                                ; 88 c1
    ...
    jne short 09626h                          ; 75 1b
    cmp di, strict byte 0ffffh                ; 83 ff ff
    jne short 09626h                          ; 75 16
    ...
    mov al, byte [bp-00ch]                    ; 8a 46 f4
    cmp AL, strict byte 001h                  ; 3c 01
    jc short 096a0h                           ; 72 0c
    jbe short 096a8h                          ; 76 12
    cmp AL, strict byte 003h                  ; 3c 03
    je short 096b0h                           ; 74 16
    cmp AL, strict byte 002h                  ; 3c 02
    je short 096ach                           ; 74 0e
    jmp short 096fah                          ; eb 5a
    test al, al                               ; 84 c0
    jne short 096fah                          ; 75 56
    mov BL, strict byte 040h                  ; b3 40
    jmp short 096b2h                          ; eb 0a
    mov BL, strict byte 048h                  ; b3 48
    jmp short 096b2h                          ; eb 06
    mov BL, strict byte 050h                  ; b3 50
    jmp short 096b2h                          ; eb 02
    mov BL, strict byte 058h                  ; b3 58
    mov dl, bl                                ; 88 da
    add dl, 007h                              ; 80 c2 07
    xor dh, dh                                ; 30 f6
    mov ax, dx                                ; 89 d0
    call 016aeh                               ; e8 f0 7f
    test al, al                               ; 84 c0
    je short 096fah                           ; 74 38
    mov al, bl                                ; 88 d8
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    xor ah, ah                                ; 30 e4
    call 016aeh                               ; e8 e3 7f
    mov byte [bp-029h], al                    ; 88 46 d7
    mov byte [bp-02ah], dh                    ; 88 76 d6
    mov al, bl                                ; 88 d8
    xor ah, ah                                ; 30 e4
    call 016aeh                               ; e8 d6 7f
    xor ah, ah                                ; 30 e4
    ...
    mov al, bl                                ; 88 d8
    add AL, strict byte 002h                  ; 04 02
    call 016aeh                               ; e8 c5 7f
    xor ah, ah                                ; 30 e4
    mov word [bp-032h], ax                    ; 89 46 ce
    mov ax, dx                                ; 89 d0
    call 016aeh                               ; e8 bb 7f
    xor ah, ah                                ; 30 e4
    mov word [bp-02eh], ax                    ; 89 46 d2
    jmp short 0970ah                          ; eb 10
    push word [bp-010h]                       ; ff 76 f0
    push word [bp-012h]                       ; ff 76 ee
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00075h                ; ba 75 00
    mov ax, strict word 00040h                ; b8 40 00
    call 01660h                               ; e8 b9 7e
    jmp near 0985dh                           ; e9 b3 00
    cmp dx, 0eb14h                            ; 81 fa 14 eb
    jne short 09804h                          ; 75 54
    cmp ax, 00101h                            ; 3d 01 01
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_mem_alloc_:                             ; 0xf9873 LB 0x43
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    xor ax, ax                                ; 31 c0
    call 0166eh                               ; e8 eb 7d
    test ax, ax                               ; 85 c0
    je short 098ach                           ; 74 25
    dec ax                                    ; 48
    mov bx, ax                                ; 89 c3
    xor dx, dx                                ; 31 d2
    mov cx, strict word 0000ah                ; b9 0a 00
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
ahci_hba_init_:                              ; 0xf98b6 LB 0x16e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    shr eax, 010h                             ; 66 c1 e8 10
    xchg dx, ax                               ; 92
    call 09873h                               ; e8 83 ff
    mov word [bp-010h], ax                    ; 89 46 f0
    test ax, ax                               ; 85 c0
    jne short 098fah                          ; 75 03
    jmp near 09a03h                           ; e9 09 01
    mov ax, word [bp-010h]                    ; 8b 46 f0
    mov es, di                                ; 8e c7
    ...
    xor cx, cx                                ; 31 c9
    call 088f2h                               ; e8 57 ef
    db  0feh, 0c0h
    ; inc al                                    ; fe c0
    mov byte [bp-00eh], al                    ; 88 46 f2
    mov byte [bp-00ch], 000h                  ; c6 46 f4 00
    jmp short 099c7h                          ; eb 21
    xor al, al                                ; 30 c0
    test al, al                               ; 84 c0
    je short 099beh                           ; 74 12
    mov bl, byte [bp-00ch]                    ; 8a 5e f4
    xor bh, bh                                ; 30 ff
    xor ax, ax                                ; 31 c0
    mov dx, word [bp-010h]                    ; 8b 56 f0
    call 0937dh                               ; e8 c4 f9
    dec byte [bp-00eh]                        ; fe 4e f2
    je short 09a01h                           ; 74 43
    inc byte [bp-00ch]                        ; fe 46 f4
    cmp byte [bp-00ch], 020h                  ; 80 7e f4 20
    jnc short 09a01h                          ; 73 3a
    ...
    xchg dx, ax                               ; 92
    test dx, di                               ; 85 fa
    jne short 099fdh                          ; 75 04
    test ax, bx                               ; 85 d8
    je short 099a6h                           ; 74 a9
    mov AL, strict byte 001h                  ; b0 01
    jmp short 099a8h                          ; eb a7
    xor ax, ax                                ; 31 c0
    lea sp, [bp-00ah]                         ; 8d 66 f6
    pop di                                    ; 5f
    pop si                                    ; 5e
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
    db  00bh, 005h, 004h, 003h, 002h, 001h, 000h, 00ah, 09bh, 0e8h, 09ah, 0eeh, 09ah, 0f4h, 09ah, 0fah
    db  09ah, 000h, 09bh, 006h, 09bh, 00ah, 09bh
_ahci_init:                                  ; 0xf9a24 LB 0x139
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    mov dx, strict word 00001h                ; ba 01 00
    call 09f7ch                               ; e8 47 05
    mov dx, ax                                ; 89 c2
    cmp ax, strict word 0ffffh                ; 3d ff ff
    je short 09a85h                           ; 74 49
    mov al, ah                                ; 88 e0
    ...
    xor ah, ah                                ; 30 e4
    mov bx, strict word 00034h                ; bb 34 00
    call 09fa7h                               ; e8 59 05
    mov cl, al                                ; 88 c1
    test cl, cl                               ; 84 c9
    je short 09a88h                           ; 74 34
    mov bl, cl                                ; 88 cb
    xor bh, bh                                ; 30 ff
    mov al, byte [bp-00ah]                    ; 8a 46 f6
    mov byte [bp-00ch], al                    ; 88 46 f4
    ...
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    mov ax, word [bp-012h]                    ; 8b 46 ee
    call 09fa7h                               ; e8 34 05
    cmp AL, strict byte 012h                  ; 3c 12
    je short 09a88h                           ; 74 11
    mov bl, cl                                ; 88 cb
    db  0feh, 0c3h
    ; inc bl                                    ; fe c3
    xor bh, bh                                ; 30 ff
    mov dx, word [bp-00ch]                    ; 8b 56 f4
    mov ax, word [bp-012h]                    ; 8b 46 ee
    jmp short 09a4bh                          ; eb c6
    jmp near 09b56h                           ; e9 ce 00
    test cl, cl                               ; 84 c9
    je short 09a85h                           ; 74 f9
    ...
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    mov ax, word [bp-014h]                    ; 8b 46 ec
    call 09fa7h                               ; e8 f9 04
    cmp AL, strict byte 010h                  ; 3c 10
    jne short 09a85h                          ; 75 d3
    mov byte [bp-006h], 000h                  ; c6 46 fa 00
    mov bl, cl                                ; 88 cb
    ...
    mov dx, word [bp-00eh]                    ; 8b 56 f2
    mov ax, word [bp-014h]                    ; 8b 46 ec
    call 09fceh                               ; e8 08 05
    mov dx, ax                                ; 89 c2
    and ax, strict word 0000fh                ; 25 0f 00
    sub ax, strict word 00004h                ; 2d 04 00
    cmp ax, strict word 0000bh                ; 3d 0b 00
    jnbe short 09b0ah                         ; 77 37
    push CS                                   ; 0e
    pop ES                                    ; 07
    mov cx, strict word 00008h                ; b9 08 00
    mov di, 09a0dh                            ; bf 0d 9a
    repne scasb                               ; f2 ae
    sal cx, 1                                 ; d1 e1
    mov di, cx                                ; 89 cf
    mov ax, word [cs:di-065ech]               ; 2e 8b 85 14 9a
    jmp ax                                    ; ff e0
    mov byte [bp-006h], 010h                  ; c6 46 fa 10
    jmp short 09b0ah                          ; eb 1c
    mov byte [bp-006h], 014h                  ; c6 46 fa 14
    jmp short 09b0ah                          ; eb 16
    mov byte [bp-006h], 018h                  ; c6 46 fa 18
    jmp short 09b0ah                          ; eb 10
    mov byte [bp-006h], 01ch                  ; c6 46 fa 1c
    jmp short 09b0ah                          ; eb 0a
    mov byte [bp-006h], 020h                  ; c6 46 fa 20
    jmp short 09b0ah                          ; eb 04
    ...
    mov dx, word [bp-010h]                    ; 8b 56 f0
    mov ax, word [bp-016h]                    ; 8b 46 ea
    call 09ff3h                               ; e8 b9 04
    test AL, strict byte 001h                 ; a8 01
    je short 09b56h                           ; 74 18
    and AL, strict byte 0f0h                  ; 24 f0
    add si, ax                                ; 01 c6
    mov cx, strict word 00007h                ; b9 07 00
    mov bx, strict word 00004h                ; bb 04 00
    mov dx, word [bp-010h]                    ; 8b 56 f0
    mov ax, word [bp-016h]                    ; 8b 46 ea
    call 0a032h                               ; e8 e1 04
    mov ax, si                                ; 89 f0
    call 098b6h                               ; e8 60 fd
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
apm_out_str_:                                ; 0xf9b5d LB 0x39
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    mov bx, ax                                ; 89 c3
    cmp byte [bx], 000h                       ; 80 3f 00
    je short 09b72h                           ; 74 0a
    mov al, byte [bx]                         ; 8a 07
    out DX, AL                                ; ee
    inc bx                                    ; 43
    mov al, byte [bx]                         ; 8a 07
    db  00ah, 0c0h
    ; or al, al                                 ; 0a c0
    jne short 09b6ah                          ; 75 f8
    lea sp, [bp-002h]                         ; 8d 66 fe
    pop bx                                    ; 5b
    pop bp                                    ; 5d
    retn                                      ; c3
    mov BH, strict byte 09bh                  ; b7 9b
    inc dx                                    ; 42
    pushfw                                    ; 9c
    leave                                     ; c9
    wait                                      ; 9b
    in AL, strict byte 09bh                   ; e4 9b
    inc dx                                    ; 42
    pushfw                                    ; 9c
    db  00fh, 09ch, 042h, 09ch
    ; setl byte [bp+si-064h]                    ; 0f 9c 42 9c
    dec ax                                    ; 48
    pushfw                                    ; 9c
    adc AL, strict byte 09ch                  ; 14 9c
    adc AL, strict byte 09ch                  ; 14 9c
    adc AL, strict byte 09ch                  ; 14 9c
    xchg word [si-063ech], bx                 ; 87 9c 14 9c
    adc AL, strict byte 09ch                  ; 14 9c
    db  080h
    pushfw                                    ; 9c
_apm_function:                               ; 0xf9b96 LB 0xf6
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    and byte [bp+018h], 0feh                  ; 80 66 18 fe
    ...
    jnbe short 09c14h                         ; 77 6c
    mov bx, ax                                ; 89 c3
    sal bx, 1                                 ; d1 e3
    mov dx, word [bp+018h]                    ; 8b 56 18
    or dl, 001h                               ; 80 ca 01
    jmp word [cs:bx-06488h]                   ; 2e ff a7 78 9b
    ...
    jmp near 09c42h                           ; e9 33 00
    sti                                       ; fb
    hlt                                       ; f4
    jmp near 09c42h                           ; e9 2e 00
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 14 7d
    push word [bp+00ch]                       ; ff 76 0c
    push word [bp+012h]                       ; ff 76 12
    ...
    je short 09c6dh                           ; 74 1f
    cmp word [bp+010h], strict byte 00002h    ; 83 7e 10 02
    je short 09c65h                           ; 74 11
    cmp word [bp+010h], strict byte 00001h    ; 83 7e 10 01
    jne short 09c75h                          ; 75 1b
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d10h                            ; b8 10 0d
    call 09b5dh                               ; e8 fa fe
    jmp short 09c42h                          ; eb dd
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d18h                            ; b8 18 0d
    jmp short 09c60h                          ; eb f3
    mov dx, 0040fh                            ; ba 0f 04
    mov ax, 00d20h                            ; b8 20 0d
    jmp short 09c60h                          ; eb eb
    or ah, 00ah                               ; 80 cc 0a
    mov word [bp+012h], ax                    ; 89 46 12
    mov word [bp+018h], dx                    ; 89 56 18
    jmp short 09c42h                          ; eb c2
    mov word [bp+012h], 00102h                ; c7 46 12 02 01
    jmp short 09c42h                          ; eb bb
    or ah, 080h                               ; 80 cc 80
    jmp short 09c78h                          ; eb ec
pci16_select_reg_:                           ; 0xf9c8c LB 0x24
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci16_find_device_:                          ; 0xf9cb0 LB 0xf7
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 09cf8h                          ; 75 2d
    mov dx, strict word 0000eh                ; ba 0e 00
    mov ax, bx                                ; 89 d8
    call 09c8ch                               ; e8 b9 ff
    ...
    mov byte [bp-008h], al                    ; 88 46 f8
    cmp AL, strict byte 0ffh                  ; 3c ff
    jne short 09ce6h                          ; 75 06
    add bx, strict byte 00008h                ; 83 c3 08
    jmp near 09d78h                           ; e9 92 00
    test byte [bp-008h], 080h                 ; f6 46 f8 80
    je short 09cf3h                           ; 74 07
    mov word [bp-00eh], strict word 00001h    ; c7 46 f2 01 00
    jmp short 09cf8h                          ; eb 05
    mov word [bp-00eh], strict word 00008h    ; c7 46 f2 08 00
    mov al, byte [bp-008h]                    ; 8a 46 f8
    and AL, strict byte 007h                  ; 24 07
    cmp AL, strict byte 001h                  ; 3c 01
    jne short 09d1fh                          ; 75 1e
    mov al, bh                                ; 88 f8
    xor ah, ah                                ; 30 e4
    test ax, ax                               ; 85 c0
    jne short 09d1fh                          ; 75 16
    mov dx, strict word 0001ah                ; ba 1a 00
    mov ax, bx                                ; 89 d8
    call 09c8ch                               ; e8 7b ff
    mov dx, 00cfeh                            ; ba fe 0c
    in AL, DX                                 ; ec
    db  02ah, 0e4h
    ; sub ah, ah                                ; 2a e4
    cmp al, byte [bp-006h]                    ; 3a 46 fa
    jbe short 09d1fh                          ; 76 03
    mov byte [bp-006h], al                    ; 88 46 fa
    test di, di                               ; 85 ff
    je short 09d28h                           ; 74 05
    mov dx, strict word 00008h                ; ba 08 00
    jmp short 09d2ah                          ; eb 02
    xor dx, dx                                ; 31 d2
    mov ax, bx                                ; 89 d8
    call 09c8ch                               ; e8 5d ff
    ...
    jne short 09d69h                          ; 75 08
    mov ax, word [bp-00ah]                    ; 8b 46 f6
    cmp ax, word [bp-012h]                    ; 3b 46 ee
    je short 09d6fh                           ; 74 06
    cmp word [bp-00ch], strict byte 00000h    ; 83 7e f4 00
    je short 09d75h                           ; 74 06
    dec si                                    ; 4e
    cmp si, strict byte 0ffffh                ; 83 fe ff
    je short 09d88h                           ; 74 13
    ...
    xor dh, dh                                ; 30 f6
    cmp ax, dx                                ; 39 d0
    jnbe short 09d88h                         ; 77 03
    jmp near 09cc6h                           ; e9 3e ff
    cmp si, strict byte 0ffffh                ; 83 fe ff
    jne short 09d91h                          ; 75 04
    mov ax, bx                                ; 89 d8
    jmp short 09d94h                          ; eb 03
    mov ax, strict word 0ffffh                ; b8 ff ff
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    pop si                                    ; 5e
    pop bp                                    ; 5d
    retn                                      ; c3
    mov byte [bp-0615fh], bl                  ; 88 9e a1 9e
    mov BL, strict byte 09eh                  ; b3 9e
    db  0c7h, 09eh, 0d9h, 09eh, 0ech, 09eh
    ; mov word [bp-06127h], 09eech              ; c7 9e d9 9e ec 9e
_pci16_function:                             ; 0xf9da7 LB 0x1d5
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    xor ah, ah                                ; 30 e4
    cmp bx, strict byte 00003h                ; 83 fb 03
    jc short 09dd9h                           ; 72 13
    jbe short 09e2ch                          ; 76 64
    cmp bx, strict byte 0000eh                ; 83 fb 0e
    je short 09e34h                           ; 74 67
    cmp bx, strict byte 00008h                ; 83 fb 08
    jc short 09de3h                           ; 72 11
    cmp bx, strict byte 0000dh                ; 83 fb 0d
    jbe short 09e37h                          ; 76 60
    jmp short 09de3h                          ; eb 0a
    cmp bx, strict byte 00002h                ; 83 fb 02
    je short 09e02h                           ; 74 24
    cmp bx, strict byte 00001h                ; 83 fb 01
    je short 09de6h                           ; 74 03
    jmp near 09f45h                           ; e9 5f 01
    ...
    jmp near 09f75h                           ; e9 73 01
    cmp word [bp+018h], strict byte 0ffffh    ; 83 7e 18 ff
    jne short 09e0eh                          ; 75 06
    or ah, 083h                               ; 80 cc 83
    jmp near 09f6eh                           ; e9 60 01
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov dx, word [bp+01ch]                    ; 8b 56 1c
    mov ax, word [bp+018h]                    ; 8b 46 18
    xor cx, cx                                ; 31 c9
    call 09cb0h                               ; e8 94 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09e2eh                          ; 75 0d
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09f6eh                           ; e9 42 01
    jmp short 09e39h                          ; eb 0b
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09f75h                           ; e9 41 01
    jmp near 09f00h                           ; e9 c9 00
    jmp short 09e5eh                          ; eb 25
    mov bx, word [bp+008h]                    ; 8b 5e 08
    mov ax, word [bp+01ch]                    ; 8b 46 1c
    mov dx, word [bp+01eh]                    ; 8b 56 1e
    mov cx, strict word 00001h                ; b9 01 00
    call 09cb0h                               ; e8 68 fe
    cmp ax, strict word 0ffffh                ; 3d ff ff
    jne short 09e58h                          ; 75 0b
    mov ax, word [bp+020h]                    ; 8b 46 20
    xor ah, ah                                ; 30 e4
    or ah, 086h                               ; 80 cc 86
    jmp near 09f6eh                           ; e9 16 01
    mov word [bp+014h], ax                    ; 89 46 14
    jmp near 09f75h                           ; e9 17 01
    cmp word [bp+004h], 00100h                ; 81 7e 04 00 01
    jc short 09e6bh                           ; 72 06
    or ah, 087h                               ; 80 cc 87
    jmp near 09f6eh                           ; e9 03 01
    mov dx, word [bp+004h]                    ; 8b 56 04
    mov ax, word [bp+014h]                    ; 8b 46 14
    call 09c8ch                               ; e8 18 fe
    mov bx, word [bp+020h]                    ; 8b 5e 20
    xor bh, bh                                ; 30 ff
    sub bx, strict byte 00008h                ; 83 eb 08
    cmp bx, strict byte 00005h                ; 83 fb 05
    jnbe short 09ee9h                         ; 77 68
    sal bx, 1                                 ; d1 e3
    jmp word [cs:bx-06265h]                   ; 2e ff a7 9b 9d
    ...
    les bx, [bp-008h]                         ; c4 5e f8
    mov word [es:bx], ax                      ; 26 89 07
    jmp short 09f75h                          ; eb 30
    mov bx, 00da4h                            ; bb a4 0d
    mov cx, ds                                ; 8c d9
    mov ax, strict word 00004h                ; b8 04 00
    call 01933h                               ; e8 e3 79
    mov ax, word [bp+014h]                    ; 8b 46 14
    push ax                                   ; 50
    mov ax, word [bp+020h]                    ; 8b 46 20
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_classcode_:                         ; 0xf9f7c LB 0x8
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    mov ax, strict word 0ffffh                ; b8 ff ff
    pop bp                                    ; 5d
    retn                                      ; c3
pci_find_device_:                            ; 0xf9f84 LB 0x23
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push cx                                   ; 51
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_byte_:                       ; 0xf9fa7 LB 0x27
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_word_:                       ; 0xf9fce LB 0x25
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_read_config_dword_:                      ; 0xf9ff3 LB 0x3f
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push cx                                   ; 51
    push di                                   ; 57
    ...
    int 01ah                                  ; cd 1a
    test cx, cx                               ; 85 c9
    je short 0a028h                           ; 74 05
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 0a02ah                          ; eb 02
    xor ax, ax                                ; 31 c0
    cwd                                       ; 99
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
pci_write_config_word_:                      ; 0xfa032 LB 0x1e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push di                                   ; 57
    push ax                                   ; 50
    ...
    pop bp                                    ; 5d
    retn                                      ; c3
vds_is_present_:                             ; 0xfa050 LB 0x1d
    push bx                                   ; 53
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_real_to_lin_:                            ; 0xfa06d LB 0x1e
    push bx                                   ; 53
    push cx                                   ; 51
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    ...
    pop bx                                    ; 5b
    retn                                      ; c3
vds_build_sg_list_:                          ; 0xfa08b LB 0x77
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    call 0a050h                               ; e8 93 ff
    test ax, ax                               ; 85 c0
    je short 0a0d2h                           ; 74 11
    mov es, si                                ; 8e c6
    mov ax, 08105h                            ; b8 05 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc short 0a0cfh                           ; 72 02
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    jmp short 0a0f9h                          ; eb 27
    mov es, si                                ; 8e c6
    ...
    pop bp                                    ; 5d
    retn 00004h                               ; c2 04 00
vds_free_sg_list_:                           ; 0xfa102 LB 0x2e
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push bx                                   ; 53
    push di                                   ; 57
    mov bx, ax                                ; 89 c3
    call 0a050h                               ; e8 44 ff
    test ax, ax                               ; 85 c0
    je short 0a121h                           ; 74 11
    mov di, bx                                ; 89 df
    mov es, dx                                ; 8e c2
    mov ax, 08106h                            ; b8 06 81
    mov dx, strict word 00000h                ; ba 00 00
    int 04bh                                  ; cd 4b
    jc short 0a120h                           ; 72 02
    db  032h, 0c0h
    ; xor al, al                                ; 32 c0
    cbw                                       ; 98
    mov es, dx                                ; 8e c2
...
__U4D:                                       ; 0xfa150 LB 0x30
    ...
    retn                                      ; c3
    times 0xe db 0
__U8RS:                                      ; 0xfa180 LB 0x10
    test si, si                               ; 85 f6
    je short 0a18fh                           ; 74 0b
    shr ax, 1                                 ; d1 e8
    rcr bx, 1                                 ; d1 db
    rcr cx, 1                                 ; d1 d9
    rcr dx, 1                                 ; d1 da
    dec si                                    ; 4e
    jne short 0a184h                          ; 75 f5
    retn                                      ; c3
__U8LS:                                      ; 0xfa190 LB 0x10
    test si, si                               ; 85 f6
...
_fmemcpy_:                                   ; 0xfa1b0 LB 0x3a
    ...
    add byte [bx+si], al                      ; 00 00
    add byte [bx+si], al                      ; 00 00
    add byte [bp+si-05dfeh], ah               ; 00 a2 02 a2
    push ES                                   ; 06
    mov byte [0a206h], AL                     ; a2 06 a2
    push ES                                   ; 06
    mov byte [0a208h], AL                     ; a2 08 a2
    or byte [bp+si-05df6h], ah                ; 08 a2 0a a2
    push CS                                   ; 0e
    mov byte [0a20eh], AL                     ; a2 0e a2
    adc byte [bp+si-05debh], ah               ; 10 a2 15 a2
    pop SS                                    ; 17
    db  0a2h
apm_worker:                                  ; 0xfa1ea LB 0x3a
    sti                                       ; fb
    push ax                                   ; 50
    db  032h, 0e4h
    ; xor ah, ah                                ; 32 e4
    ...
    jnc short 0a220h                          ; 73 25
    jmp word [cs:bp-05e30h]                   ; 2e ff a6 d0 a1
    jmp short 0a21eh                          ; eb 1c
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 0a21eh                          ; eb 18
    jmp short 0a21eh                          ; eb 16
    jmp short 0a220h                          ; eb 16
    mov AH, strict byte 080h                  ; b4 80
    jmp short 0a222h                          ; eb 14
    jmp short 0a220h                          ; eb 10
    mov ax, 00102h                            ; b8 02 01
    jmp short 0a21eh                          ; eb 09
    jmp short 0a21eh                          ; eb 07
    mov BL, strict byte 000h                  ; b3 00
    mov cx, strict word 00000h                ; b9 00 00
    jmp short 0a21eh                          ; eb 00
    clc                                       ; f8
    retn                                      ; c3
    mov AH, strict byte 009h                  ; b4 09
    stc                                       ; f9
    retn                                      ; c3
apm_pm16_entry:                              ; 0xfa224 LB 0x11
    ...
    mov ds, bp                                ; 8e dd
    call 0a1eah                               ; e8 b8 ff
    pop bp                                    ; 5d
    pop DS                                    ; 1f
    retf                                      ; cb
_DoUInt32Div:                                ; 0xfa235 LB 0x26b
    push bp                                   ; 55
    mov bp, sp                                ; 89 e5
    push si                                   ; 56
    push di                                   ; 57
    ...
    jne short 0a285h                          ; 75 22
    mov ax, word [bx]                         ; 8b 07
    test ax, ax                               ; 85 c0
    je short 0a282h                           ; 74 19
    cmp ax, strict word 00001h                ; 3d 01 00
    jne short 0a285h                          ; 75 17
    xor ax, ax                                ; 31 c0
    mov word [bp+00ah], ax                    ; 89 46 0a
    mov word [bp+008h], ax                    ; 89 46 08
    mov ax, word [bp-01ch]                    ; 8b 46 e4
    ...
    mov ax, word [bp-01ah]                    ; 8b 46 e6
    mov word [bp+006h], ax                    ; 89 46 06
    jmp near 0a48dh                           ; e9 08 02
    lds bx, [bp-00ch]                         ; c5 5e f4
    mov ax, word [bx+002h]                    ; 8b 47 02
    mov ds, [bp-006h]                         ; 8e 5e fa
    cmp ax, word [si+002h]                    ; 3b 44 02
    je short 0a2abh                           ; 74 18
    mov ds, [bp-00ah]                         ; 8e 5e f6
    mov ax, word [bx+002h]                    ; 8b 47 02
    mov ds, [bp-006h]                         ; 8e 5e fa
    cmp ax, word [si+002h]                    ; 3b 44 02
    jbe short 0a2a6h                          ; 76 05
    mov ax, strict word 00001h                ; b8 01 00
    jmp short 0a2cch                          ; eb 26
    mov ax, strict word 0ffffh                ; b8 ff ff
    jmp short 0a2cch                          ; eb 21
    mov ds, [bp-00ah]                         ; 8e 5e f6
    mov ax, word [bx]                         ; 8b 07
    mov ds, [bp-006h]                         ; 8e 5e fa
    cmp ax, word [si]                         ; 3b 04
    je short 0a2cah                           ; 74 13
    mov ds, [bp-00ah]                         ; 8e 5e f6
    mov ax, word [bx]                         ; 8b 07
    mov ds, [bp-006h]                         ; 8e 5e fa
    cmp ax, word [si]                         ; 3b 04
    jbe short 0a2c5h                          ; 76 02
    jmp short 0a2a1h                          ; eb dc
    mov ax, strict word 0ffffh                ; b8 ff ff
    jmp short 0a2cch                          ; eb 02
    xor ax, ax                                ; 31 c0
    test ax, ax                               ; 85 c0
    jnl short 0a2eeh                          ; 7d 1e
    lds bx, [bp-00ch]                         ; c5 5e f4
    mov ax, word [bx]                         ; 8b 07
    ...
    jmp short 0a282h                          ; eb 94
    jne short 0a305h                          ; 75 15
    mov ds, [bp-008h]                         ; 8e 5e f8
    ...
    jmp near 0a48dh                           ; e9 88 01
    lds bx, [bp-00ch]                         ; c5 5e f4
    mov ax, word [bx+002h]                    ; 8b 47 02
    test ax, ax                               ; 85 c0
    je short 0a320h                           ; 74 11
    push ax                                   ; 50
    mov ax, 0f000h                            ; b8 00 f0
    mov ds, ax                                ; 8e d8
    call 0a4a0h                               ; e8 88 01
    add sp, strict byte 00002h                ; 83 c4 02
    add ax, strict word 00010h                ; 05 10 00
    jmp short 0a32dh                          ; eb 0d
    push word [bx]                            ; ff 37
    mov ax, 0f000h                            ; b8 00 f0
    mov ds, ax                                ; 8e d8
    call 0a4a0h                               ; e8 76 01
    add sp, strict byte 00002h                ; 83 c4 02
    mov word [bp-014h], ax                    ; 89 46 ec
    mov ds, [bp-006h]                         ; 8e 5e fa
    mov ax, word [si+002h]                    ; 8b 44 02
    test ax, ax                               ; 85 c0
    je short 0a34bh                           ; 74 11
    push ax                                   ; 50
    mov ax, 0f000h                            ; b8 00 f0
    mov ds, ax                                ; 8e d8
    call 0a4a0h                               ; e8 5d 01
    add sp, strict byte 00002h                ; 83 c4 02
    add ax, strict word 00010h                ; 05 10 00
    jmp short 0a358h                          ; eb 0d
    push word [si]                            ; ff 34
    mov ax, 0f000h                            ; b8 00 f0
    mov ds, ax                                ; 8e d8
    call 0a4a0h                               ; e8 4b 01
    add sp, strict byte 00002h                ; 83 c4 02
    ...
    mov ds, [bp-006h]                         ; 8e 5e fa
    cmp ax, word [si+002h]                    ; 3b 44 02
    jnbe short 0a3ffh                         ; 77 06
    jne short 0a403h                          ; 75 08
    cmp dx, word [si]                         ; 3b 14
    jc short 0a403h                           ; 72 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 0a405h                          ; eb 02
    xor al, al                                ; 30 c0
    test al, al                               ; 84 c0
    je short 0a46ah                           ; 74 61
    mov ds, [bp-008h]                         ; 8e 5e f8
    mov ax, word [di+002h]                    ; 8b 45 02
    cmp ax, word [bp-016h]                    ; 3b 46 ea
    jnbe short 0a420h                         ; 77 0c
    cmp ax, word [bp-016h]                    ; 3b 46 ea
    jne short 0a424h                          ; 75 0b
    mov ax, word [di]                         ; 8b 05
    cmp ax, word [bp-018h]                    ; 3b 46 e8
    jc short 0a424h                           ; 72 04
    mov AL, strict byte 001h                  ; b0 01
    jmp short 0a426h                          ; eb 02
    xor al, al                                ; 30 c0
    test al, al                               ; 84 c0
    je short 0a450h                           ; 74 26
    mov ax, word [bp-018h]                    ; 8b 46 e8
    mov ds, [bp-008h]                         ; 8e 5e f8
    ...
    mov ds, [bp-006h]                         ; 8e 5e fa
    cmp ax, word [si+002h]                    ; 3b 44 02
    jc short 0a466h                           ; 72 06
    jne short 0a46ch                          ; 75 0a
    cmp dx, word [si]                         ; 3b 14
    jnc short 0a46ch                          ; 73 06
    mov AL, strict byte 001h                  ; b0 01
    jmp short 0a46eh                          ; eb 04
    jmp short 0a48dh                          ; eb 21
    xor al, al                                ; 30 c0
    test al, al                               ; 84 c0
    je short 0a481h                           ; 74 0f
    jmp short 0a48dh                          ; eb 19
    mov cx, strict word 0001fh                ; b9 1f 00
    sal word [bp-018h], 1                     ; d1 66 e8
    rcl word [bp-016h], 1                     ; d1 56 ea
    loop 0a477h                               ; e2 f8
    jmp short 0a487h                          ; eb 06
    shr word [bp-016h], 1                     ; d1 6e ea
    rcr word [bp-018h], 1                     ; d1 5e e8
    dec word [bp-012h]                        ; ff 4e ee
    jmp near 0a409h                           ; e9 7c ff
    mov ax, word [bp-01ch]                    ; 8b 46 e4
    mov dx, word [bp-01ah]                    ; 8b 56 e6
    lea sp, [bp-004h]                         ; 8d 66 fc
    pop di                                    ; 5f
    ...
    retn                                      ; c3
    times 0x6 db 0
_ASMBitLastSetU16:                           ; 0xfa4a0 LB 0x18
    push bp                                   ; 55
    db  08bh, 0ech
    ; mov bp, sp                                ; 8b ec
    mov cx, word [bp+004h]                    ; 8b 4e 04
    test cx, cx                               ; 85 c9
    je short 0a4b4h                           ; 74 0a
    mov ax, strict word 00010h                ; b8 10 00
    sal cx, 1                                 ; d1 e1
    jc short 0a4b6h                           ; 72 05
    dec ax                                    ; 48
    jmp short 0a4adh                          ; eb f9
    db  033h, 0c0h
    ; xor ax, ax                                ; 33 c0
    pop bp                                    ; 5d
    retn                                      ; c3

  ; Padding 0x3548 bytes at 0xfa4b8
  times 13640 db 0
...
int75_handler:                               ; 0xfe2ca LB 0x8
    ...
    int 002h                                  ; cd 02
    iret                                      ; cf
hard_drive_post:                             ; 0xfe2d2 LB 0xbf
    db  033h, 0c0h
    ; xor ax, ax                                ; 33 c0
    mov ds, ax                                ; 8e d8
    ...
    sti                                       ; fb
    call 09a24h                               ; e8 e1 b6
    cli                                       ; fa
    call 08871h                               ; e8 2a a5
    call 0ed4ch                               ; e8 02 0a
    call 0e2d2h                               ; e8 85 ff
    push CS                                   ; 0e
    pop DS                                    ; 1f
    cld                                       ; fc
    mov ax, 0c800h                            ; b8 00 c8
    mov dx, 0f000h                            ; ba 00 f0
    call 01600h                               ; e8 a7 32
    call 01799h                               ; e8 3d 34
    call 03c35h                               ; e8 d6 58
    sti                                       ; fb
    int 019h                                  ; cd 19
    sti                                       ; fb
    hlt                                       ; f4
    jmp short 0e363h                          ; eb fd
    cli                                       ; fa
    hlt                                       ; f4
    mov ax, strict word 00040h                ; b8 40 00
    mov ds, ax                                ; 8e d8
...
biosorg_check_before_or_at_0E3FCh:           ; 0xfe391 LB 0x6d
    times 0x6b db 0
    db  'XM'
...
jmp_call_ret_int13_out:                      ; 0xfec7a LB 0x4a
    ...
    push cx                                   ; 51
    push dx                                   ; 52
    call 03c4dh                               ; e8 c9 4f
    cmp AL, strict byte 000h                  ; 3c 00
    je short 0ecbfh                           ; 74 37
    call 03c63h                               ; e8 d8 4f
    pop dx                                    ; 5a
    push dx                                   ; 52
    db  03ah, 0c2h
    ; cmp al, dl                                ; 3a c2
...
int13_disk:                                  ; 0xfecf2 LB 0xd
    ...
    call 05c6ah                               ; e8 70 6f
    jmp short 0ecffh                          ; eb 03
    call 060b4h                               ; e8 b5 73
...
cpu_reset:                                   ; 0xffff0 LB 0x10
    jmp far 0f000h:0e05bh                     ; ea 5b e0 00 f0
    db  030h, 036h, 02fh, 032h, 033h, 02fh, 039h, 039h, 000h, 0fbh, 0bah
