/* $Id: tstDeviceStructSizeRC.cpp 111533 2016-10-25 15:21:45Z knut.osmundsen@oracle.com $ */
/** @file
...
int main()
{
    ...
    GEN_CHECK_OFF(PCIGLOBALS, auPciApicIrqLevels);
    GEN_CHECK_OFF(PCIGLOBALS, auPciApicIrqLevels[1]);
    GEN_CHECK_OFF(PCIGLOBALS, Piix3.auPciLegacyIrqLevels);
    GEN_CHECK_OFF(PCIGLOBALS, Piix3.auPciLegacyIrqLevels[1]);
    GEN_CHECK_OFF(PCIGLOBALS, Piix3.iAcpiIrqLevel);
    GEN_CHECK_OFF(PCIGLOBALS, Piix3.iAcpiIrq);
    GEN_CHECK_OFF(PCIGLOBALS, Piix3.PIIX3State);
    ...
    GEN_CHECK_OFF(ICH9PCIGLOBALS, auPciApicIrqLevels);
    GEN_CHECK_OFF(ICH9PCIGLOBALS, auPciApicIrqLevels[1]);
    GEN_CHECK_OFF(ICH9PCIGLOBALS, uPciBiosBus);
