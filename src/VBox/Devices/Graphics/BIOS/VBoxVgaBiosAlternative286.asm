; $Id: VBoxVgaBiosAlternative286.asm 155176 2023-01-11 14:30:30Z samuel.burchill@oracle.com $ 
;; @file
...
init_bios_area:                              ; 0xc0a27 LB 0x3e
    ...
    mov word [es:bx+000a8h], 05550h           ; 26 c7 87 a8 00 50 55        ; 0xc0a56 vgabios.c:242
...
vga_read_char_attr:                          ; 0xc0dd6 LB 0x130
    ...
    mov bl, byte [bx+047b0h]                  ; 8a 9f b0 47                 ; 0xc0e7f vgabios.c:562
...
vga_get_font_info:                           ; 0xc0f16 LB 0x83
    ...
    mov dx, 05d6ch                            ; ba 6c 5d                    ; 0xc0f77 vgabios.c:601
    mov ax, ds                                ; 8c d8                       ; 0xc0f7a
    jmp short 00f3bh                          ; eb bd                       ; 0xc0f7c vgabios.c:602
    mov dx, 0556ch                            ; ba 6c 55                    ; 0xc0f7e vgabios.c:604
    jmp short 00f7ah                          ; eb f7                       ; 0xc0f81
    mov dx, 0596ch                            ; ba 6c 59                    ; 0xc0f83 vgabios.c:607
    jmp short 00f7ah                          ; eb f2                       ; 0xc0f86
    mov dx, 07b6ch                            ; ba 6c 7b                    ; 0xc0f88 vgabios.c:610
    jmp short 00f7ah                          ; eb ed                       ; 0xc0f8b
    mov dx, 06b6ch                            ; ba 6c 6b                    ; 0xc0f8d vgabios.c:613
    jmp short 00f7ah                          ; eb e8                       ; 0xc0f90
    mov dx, 07c99h                            ; ba 99 7c                    ; 0xc0f92 vgabios.c:616
...
vga_read_pixel:                              ; 0xc0f99 LB 0x166
    ...
    mov ch, byte [bx+047b0h]                  ; 8a af b0 47                 ; 0xc0fd2 vgabios.c:649
    ...
    mov cl, byte [bx+047b1h]                  ; 8a 8f b1 47                 ; 0xc1060 vgabios.c:664
...
biosfn_set_active_page:                      ; 0xc1322 LB 0xd8
    ...
    mov bl, byte [bx+0482eh]                  ; 8a 9f 2e 48                 ; 0xc13a8 vgabios.c:862
...
find_vpti:                                   ; 0xc13fa LB 0x45
    ...
    mov al, byte [bx+07df5h]                  ; 8a 87 f5 7d                 ; 0xc141e vgabios.c:924
    jmp short 01432h                          ; eb 0e                       ; 0xc1422 vgabios.c:925
    test AL, strict byte 080h                 ; a8 80                       ; 0xc1424
    je short 0142eh                           ; 74 06                       ; 0xc1426
    mov al, byte [bx+07de5h]                  ; 8a 87 e5 7d                 ; 0xc1428 vgabios.c:926
    jmp short 01432h                          ; eb 04                       ; 0xc142c vgabios.c:927
    mov al, byte [bx+07dedh]                  ; 8a 87 ed 7d                 ; 0xc142e vgabios.c:928
    cbw                                       ; 98                          ; 0xc1432
    jmp short 0143bh                          ; eb 06                       ; 0xc1433 vgabios.c:929
    mov al, byte [bx+0482eh]                  ; 8a 87 2e 48                 ; 0xc1435 vgabios.c:930
...
biosfn_set_video_mode:                       ; 0xc143f LB 0x4d5
    ...
    mov bx, 05d6ch                            ; bb 6c 5d                    ; 0xc1830
    ...
    mov dx, 07b6ch                            ; ba 6c 7b                    ; 0xc1846
    ...
    mov bx, 06b6ch                            ; bb 6c 6b                    ; 0xc1860
    ...
    mov dx, 07c99h                            ; ba 99 7c                    ; 0xc1870
    ...
    mov bx, 0596ch                            ; bb 6c 59                    ; 0xc18d5 vgabios.c:1199
    ...
    mov bx, 0556ch                            ; bb 6c 55                    ; 0xc18f3 vgabios.c:1203
    ...
    mov bx, 05d6ch                            ; bb 6c 5d                    ; 0xc1900 vgabios.c:1206
    jmp short 018f6h                          ; eb f1                       ; 0xc1903
    mov bx, 06b6ch                            ; bb 6c 6b                    ; 0xc1905 vgabios.c:1209
...
biosfn_scroll:                               ; 0xc1c55 LB 0x688
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc1d15
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc1d57
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc1dc2
    ...
    mov bx, word [bx+047b2h]                  ; 8b 9f b2 47                 ; 0xc1df3
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc1e6f
    ...
    mov bx, word [bx+047b2h]                  ; 8b 9f b2 47                 ; 0xc1ea6
    ...
    mov al, byte [si+0482eh]                  ; 8a 84 2e 48                 ; 0xc1edb
    xor ah, ah                                ; 30 e4                       ; 0xc1edf
    mov si, ax                                ; 89 c6                       ; 0xc1ee1
    sal si, 006h                              ; c1 e6 06                    ; 0xc1ee3
    mov al, byte [si+04844h]                  ; 8a 84 44 48                 ; 0xc1ee6
    mov byte [bp-00eh], al                    ; 88 46 f2                    ; 0xc1eea
    mov al, byte [bx+047b0h]                  ; 8a 87 b0 47                 ; 0xc1eed vgabios.c:1380
    ...
    mov bx, word [bx+047b2h]                  ; 8b 9f b2 47                 ; 0xc1f5d
    ...
    mov al, byte [bx+047b1h]                  ; 8a 87 b1 47                 ; 0xc2066 vgabios.c:1414
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc20a5
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc21e0
...
write_gfx_char_cga:                          ; 0xc23ee LB 0x112
    ...
    mov di, 0556ch                            ; bf 6c 55                    ; 0xc23fa vgabios.c:1541
...
write_gfx_char_lin:                          ; 0xc2500 LB 0x9b
    ...
    mov di, 0556ch                            ; bf 6c 55                    ; 0xc250c vgabios.c:1605
...
biosfn_write_char_attr:                      ; 0xc259b LB 0x187
    ...
    cmp byte [di+047afh], 000h                ; 80 bd af 47 00              ; 0xc2613
    ...
    mov es, [di+047b2h]                       ; 8e 85 b2 47                 ; 0xc2654
    ...
    mov bl, byte [bx+0482eh]                  ; 8a 9f 2e 48                 ; 0xc2663 vgabios.c:1656
    sal bx, 006h                              ; c1 e3 06                    ; 0xc2667
    mov al, byte [bx+04844h]                  ; 8a 87 44 48                 ; 0xc266a
    mov byte [bp-012h], al                    ; 88 46 ee                    ; 0xc266e
    mov al, byte [di+047b1h]                  ; 8a 85 b1 47                 ; 0xc2671 vgabios.c:1657
    ...
    mov bl, byte [bx+047b0h]                  ; 8a 9f b0 47                 ; 0xc2686
...
biosfn_write_char_only:                      ; 0xc2722 LB 0x181
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc2797
    ...
    mov es, [di+047b2h]                       ; 8e 85 b2 47                 ; 0xc27d2 vgabios.c:50
    ...
    mov al, byte [di+0482eh]                  ; 8a 85 2e 48                 ; 0xc27e2
    mov di, ax                                ; 89 c7                       ; 0xc27e6
    sal di, 006h                              ; c1 e7 06                    ; 0xc27e8
    mov al, byte [di+04844h]                  ; 8a 85 44 48                 ; 0xc27eb
    mov byte [bp-014h], al                    ; 88 46 ec                    ; 0xc27ef
    mov al, byte [bx+047b1h]                  ; 8a 87 b1 47                 ; 0xc27f2 vgabios.c:1717
    ...
    mov bl, byte [bx+047b0h]                  ; 8a 9f b0 47                 ; 0xc2807
...
biosfn_write_pixel:                          ; 0xc28a3 LB 0x173
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc28d2
    je short 028f1h                           ; 74 18                       ; 0xc28d7
    mov al, byte [bx+047b0h]                  ; 8a 87 b0 47                 ; 0xc28d9 vgabios.c:1755
    ...
    cmp byte [bx+047b1h], 002h                ; 80 bf b1 47 02              ; 0xc296f
    ...
    cmp byte [si+047b1h], 002h                ; 80 bc b1 47 02              ; 0xc299f
...
biosfn_write_teletype:                       ; 0xc2a16 LB 0x258
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc2ac9
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc2af9 vgabios.c:50
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc2b06 vgabios.c:50
    ...
    mov al, byte [si+0482eh]                  ; 8a 84 2e 48                 ; 0xc2b14
    mov si, ax                                ; 89 c6                       ; 0xc2b18
    sal si, 006h                              ; c1 e6 06                    ; 0xc2b1a
    mov dl, byte [si+04844h]                  ; 8a 94 44 48                 ; 0xc2b1d
    mov al, byte [bx+047b1h]                  ; 8a 87 b1 47                 ; 0xc2b21 vgabios.c:1877
    mov bl, byte [bx+047b0h]                  ; 8a 9f b0 47                 ; 0xc2b25 vgabios.c:1878
    ...
    cmp byte [bx+047afh], 000h                ; 80 bf af 47 00              ; 0xc2be1
    ...
    mov es, [bx+047b2h]                       ; 8e 87 b2 47                 ; 0xc2c13 vgabios.c:45
...
set_gfx_font:                                ; 0xc2eaf LB 0x4d
    ...
    mov al, byte [bx+07dfdh]                  ; 8a 87 fd 7d                 ; 0xc2ed5
...
biosfn_load_gfx_8_14_chars:                  ; 0xc2f19 LB 0x22
    ...
    mov ax, 05d6ch                            ; b8 6c 5d                    ; 0xc2f2c
...
biosfn_load_gfx_8_8_dd_chars:                ; 0xc2f3b LB 0x22
    ...
    mov ax, 0556ch                            ; b8 6c 55                    ; 0xc2f4e
...
biosfn_load_gfx_8_16_chars:                  ; 0xc2f5d LB 0x22
    ...
    mov ax, 06b6ch                            ; b8 6c 6b                    ; 0xc2f70
...
biosfn_read_state_info:                      ; 0xc305d LB 0x1ef
    ...
    mov word [es:bx], 05502h                  ; 26 c7 07 02 55              ; 0xc3081
...
find_vga_entry:                              ; 0xc3819 LB 0x28
    ...
    cmp dl, byte [bx+047aeh]                  ; 3a 97 ae 47                 ; 0xc3833
...
int10_func:                                  ; 0xc38d9 LB 0x49f
    ...
    mov bx, 05d6ch                            ; bb 6c 5d                    ; 0xc3b04
    ...
    mov bx, 0556ch                            ; bb 6c 55                    ; 0xc3b1f
    ...
    mov bx, 06b6ch                            ; bb 6c 6b                    ; 0xc3b3f
