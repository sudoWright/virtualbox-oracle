; $Id: VBoxVgaBiosAlternative.asm 88827 2013-09-09 13:19:56Z noreply@oracle.com $ 
;; @file
...
_msg_vga_init:                               ; 0xc4800 LB 0x34
    db  'Oracle VM VirtualBox Version 4.3.0_BETA2 VGA BIOS', 00dh, 00ah, 000h
...
_vbebios_product_revision:                   ; 0xc7e6f LB 0x29
    db  'Oracle VM VirtualBox Version 4.3.0_BETA2', 000h
