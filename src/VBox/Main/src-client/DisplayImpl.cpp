/* $Id: DisplayImpl.cpp 85197 2013-04-23 08:45:54Z klaus.espenlaub@oracle.com $ */
/** @file
...
#ifdef VBOX_WITH_CRHGSMI
    pThis->pDisplay->setupCrHgsmiData();
#endif
