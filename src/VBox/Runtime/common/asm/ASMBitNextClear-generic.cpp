/* $Id: ASMBitNextClear-generic.cpp 165393 2024-10-21 12:08:33Z knut.osmundsen@oracle.com $ */
/** @file
...
RT_DECL_ASM(int) ASMBitNextClear(const volatile void RT_FAR *pvBitmap, uint32_t cBits, uint32_t iBitPrev) RT_NOTHROW_DEF
{
