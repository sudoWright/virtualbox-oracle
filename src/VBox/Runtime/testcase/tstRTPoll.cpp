/* $Id: tstRTPoll.cpp 58101 2010-02-26 10:59:04Z andreas.loeffler@oracle.com $ */
/** @file
...
static void tstRTPoll2(void)
{
    ...
    RTTESTI_CHECK(RTPollGetCount(hSetInvl) == UINT32_MAX);
...
static void tstRTPoll1(void)
{
    ...
    RTTESTI_CHECK_RETV(RTPollGetCount(hSet) == 0);
    ...
    RTTESTI_CHECK_RETV(RTPollGetCount(hSet) == 1);
    ...
    RTTESTI_CHECK_RETV(RTPollGetCount(hSet) == 2);
