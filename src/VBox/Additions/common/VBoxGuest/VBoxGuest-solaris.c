/* $Id: VBoxGuest-solaris.c 28591 2008-03-04 05:36:07Z ramshankar.venkataraman@oracle.com $ */
/** @file
...
int _init(void)
{
    ...
    int rc = ddi_soft_state_init(&g_pVBoxGuestSolarisState, sizeof(VBoxAddDevState), 1);
    if (!rc)
    {
